...
id: q-13
content: |-
  ![](<Source/WHW-1/Images/problem-13-acceleration-arrows.png>)
...
- id: a
  content: |-
    ![](<Source/WHW-1/Images/problem-14-angular-velocity-option-a.png>)
  correct: true
- id: b
  content: |-
    ![](<Source/WHW-1/Images/problem-14-angular-velocity-option-b.png>)
- id: c
  content: |-
    ![](<Source/WHW-1/Images/problem-14-angular-velocity-option-c.png>)
- id: d
  content: |-
    ![](<Source/WHW-1/Images/problem-14-angular-velocity-option-d.png>)
```
...
content: |-
  ...
  ![](<Source/WHW-1/Images/problem-15-angular-position.png>)
options:
- id: a
  content: |-
    ![](<Source/WHW-1/Images/problem-15-angular-acceleration-option-a.png>)
  correct: true
- id: b
  content: |-
    ![](<Source/WHW-1/Images/problem-15-angular-acceleration-option-b.png>)
- id: c
  content: |-
    ![](<Source/WHW-1/Images/problem-15-angular-acceleration-option-c.png>)
- id: d
  content: |-
    ![](<Source/WHW-1/Images/problem-15-angular-acceleration-option-d.png>)
- id: e
  content: |-
    ![](<Source/WHW-1/Images/problem-15-angular-acceleration-option-e.png>)
```
