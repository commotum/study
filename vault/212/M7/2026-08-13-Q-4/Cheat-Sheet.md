# Physics 212 — Comprehensive Final Cheat Sheet (Modules 1–6)

This guide organizes the Module 1–6 lecture notes, `PRE`/`LEC` problems, homework, and Q1–Q3 problems by the move needed to solve them. Use each family to identify the setup, follow the equation chain, and check how the same move changes with a different diagram, sign convention, or requested unknown.

Navigation: [Home](<../../Home.md>) | [Vault Table of Contents](<../../0. Table of Contents/TOC.md>) | [Quiz 4 Study Guide](<Study-Guide.md>) | [MCT Study Guide](<MCT-Study-Guide.md>)
...
1. **Cover the equations** and identify the family from the wording or diagram.
2. State the physical framework before calculating: kinematics, forces, torque, energy, angular momentum, wave geometry, or a chain of them.
3. Work the listed algorithm symbolically.
4. Use the variants and traps to test the same move after a change in geometry, sign convention, or requested unknown.
5. Practice by changing one feature at a time: direction, angle convention, pivot, boundary condition, source/observer role, bright/dark order, or requested unknown.
...
## How the Vault and Source Files Fit Together

The [course README](<../../README.md>) defines this hierarchy:

1. `Source/Lecture-Notes.md` contains the broad lecture narrative, derivations, worked examples, and explicit scope statements.
2. `Source/*-PRE.md` and `Source/*-LEC.md` contain normalized pre-lecture and in-class problem blocks.
3. The dated main note is the cleaned practice surface.
4. Homework and practice-quiz notes add variants and longer chains.
5. `Lessons/` teaches the reusable core move behind each problem.
6. Quiz folders curate existing material; they do not replace the source lectures.

To trace a test problem back to the course material, read in this order:

> lecture core move → PRE/LEC variant → homework/practice-quiz extension → actual quiz transformation

M1-0 contains course orientation, so the physics catalog begins with M1-00/M1-1.

Representative source-note map:

| Module | Source lectures reviewed |
|---|---|
| M1 | [M1-00](<../../M1/2026-06-23-M1-00/Source/Lecture-Notes.md>), [M1-1](<../../M1/2026-06-24-M1-1/Source/Lecture-Notes.md>), [M1-2](<../../M1/2026-06-25-M1-2/Source/Lecture-Notes.md>), [M1-3](<../../M1/2026-06-29-M1-3/Source/Lecture-Notes.md>), [M1-4](<../../M1/2026-06-30-M1-4/Source/Lecture-Notes.md>), [M1-5](<../../M1/2026-07-02-M1-5/Source/Lecture-Notes.md>) |
| M2 | [M2-1](<../../M2/2026-07-07-M2-1/Source/Lecture-Notes.md>), [M2-2](<../../M2/2026-07-08-M2-2/Source/Lecture-Notes.md>), [M2-3](<../../M2/2026-07-09-M2-3/Source/Lecture-Notes.md>), [M2-4](<../../M2/2026-07-13-M2-4/Source/Lecture-Notes.md>), [M2-5](<../../M2/2026-07-14-M2-5/Source/Lecture-Notes.md>) |
| M3 | [M3-1](<../../M3/2026-07-15-M3-1/Source/Lecture-Notes.md>), [M3-2](<../../M3/2026-07-16-M3-2/Source/Lecture-Notes.md>) |
| M4 | [M4-1](<../../M4/2026-07-21-M4-1/Source/Lecture-Notes.md>), [M4-2](<../../M4/2026-07-22-M4-2/Source/Lecture-Notes.md>) |
| M5 | [M5-1](<../../M5/2026-07-23-M5-1/Source/Lecture-Notes.md>), [M5-2](<../../M5/2026-07-27-M5-2/Source/Lecture-Notes.md>), [M5-3](<../../M5/2026-07-28-M5-3/Source/Lecture-Notes.md>), [M5-4](<../../M5/2026-07-29-M5-4/Source/Lecture-Notes.md>), [M5-5](<../../M5/2026-07-30-M5-5/Source/Lecture-Notes.md>) |
| M6 | [M6-1](<../../M6/2026-08-05-M6-1/Source/Lecture-Notes.md>), [M6-2](<../../M6/2026-08-06-M6-2/Source/Lecture-Notes.md>) |

<a id="past-test-comparison"></a>
## What the Past Three Tests Reveal

Actual tests: [Quiz 1](<../../M1/2026-07-06-Q-1/2026-07-06-Q-1.md>) | [Quiz 2](<../../M3/2026-07-20-Q-2/2026-07-20-Q-2.md>) | [Quiz 3](<../../M5/2026-08-03-Q-3/2026-08-03-Q-3.md>)

| Test problem | Reusable move | Relationship to the lecture/HW family | Practice changes |
|---|---|---|---|
| Q1 P1 | Constant-speed circular acceleration points inward | Direct M1-2 direction question | Rotate the picture or ask force direction |
| Q1 P2 | Net-force direction at the bottom of a dip | Top/bottom circular-force family | Flip hill ↔ dip or ask apparent weight |
| Q1 P3 | FBD for a bead on a rotating frictionless loop | Conical-pendulum/angled-normal family | Change tension to normal or change angle convention |
| Q1 P4 | Resolve a vertical-circle problem into signed radial and tangential components | Near-repeat of M1-5 | Ask total acceleration, speed, angular speed, or release motion |
| Q1 P5 | Integrate linear speed, then use $s=r\theta$ | Synthesis of calculus and rotational geometry | Time-dependent rope/spool/belt problem |
| Q2 P1 | Rank weights and unequal tensions for a massive pulley | Direct M2-4 pulley dynamics | Solve acceleration or compare pulley inertias |
| Q2 P2 | Rolling speed cancels mass and radius for equal shapes | Direct M2-5/HW family | Rank shapes using $I=\beta MR^2$ |
| Q2 P3 | Sum gravitational potential energy over all unique pairs | Direct M3 many-body energy family | New geometry or an omitted pair trap |
| Q2 P4 | Composite COM, then $v=\omega r$ about that COM | Synthesis of M2 COM and tangential speed | Ask a different component's radius/speed |
| Q2 P5 | Binary COM, orbital period, and total energy | Synthesis of M3 binary and circular-orbit energy | Unequal masses or solve separation from period |
| Q3 P1 | Spring stiffness scaling changes period | Direct M4 ratio family | Change mass and spring constant together |
| Q3 P2 | Pendulum phase gives position and speeding/slowing | M4 graph/phase variant | Ask first event time, velocity sign, or acceleration |
| Q3 P3 | Particle direction on a right-moving wave | Almost direct M5-1 repeat | Reverse propagation direction or local slope |
| Q3 P4 | Free fall supplies observer speed for Doppler shift | Two-step M5 synthesis | Circular/energy speed feeding Doppler |
| Q3 P5 | Statics/torque → tension → wave speed → frequency/amplitude | Geometry changed from practice quiz; chain preserved | New support geometry with the same chain |

### How Q1–Q3 changed earlier problems

Across Q1–Q3, the questions changed earlier course problems in five ways:

1. Reuse a PRE/LEC core move nearly verbatim.
2. Change the picture, angle definition, or physical object while keeping the equations.
3. Ask for a comparison or sign instead of a number.
4. Add one prerequisite step before the familiar move.
5. Chain two familiar families into one written problem.

The M6-1 source lecture states the final structure: three multiple-choice questions and one short written response, one longer written problem, and then several more multiple-choice questions.

The same lecture estimates that **one-third to one-half** of the exam will cover material taught after Quiz 3 and **one-half to two-thirds** will cover earlier material. The current Quiz 4 guide stops at Module 6, so this sheet treats M6 wave optics as the new-material portion and Modules 1–5 as the cumulative portion.

<a id="universal-workflow"></a>
## Problem-Solving Workflow

1. **Sketch the physical situation.** Add a second diagram when the problem has separate moments in time or separate subsystems.
2. **Name the unknown and givens with units.** Convert cm, mm, $\mu$m, nm, rpm, and degrees before substitution.
3. **Choose axes or a pivot deliberately.** For circular motion, make inward radial positive. For torque, choose a pivot that eliminates unknown forces.
...
5. **Solve algebraically before numbers.** If the result still contains a variable not given, another framework is required.
6. **Check sign, units, limits, and scale.** Ask what happens when friction, angle, slit width, mass, radius, or distance approaches a simple limit.
