...
![Angular position graph for Problem 15](../Source/WHW-1/Images/problem-15-angular-position.png)
...
content: |-
  ...
  ![Angular position graph](../Source/WHW-1/Images/problem-15-angular-position.png)
options:
- id: a
  content: |-
    ![Option A](../Source/WHW-1/Images/problem-15-angular-acceleration-option-a.png)
  correct: true
- id: b
  content: |-
    ![Option B](../Source/WHW-1/Images/problem-15-angular-acceleration-option-b.png)
- id: c
  content: |-
    ![Option C](../Source/WHW-1/Images/problem-15-angular-acceleration-option-c.png)
- id: d
  content: |-
    ![Option D](../Source/WHW-1/Images/problem-15-angular-acceleration-option-d.png)
- id: e
  content: |-
    ![Option E](../Source/WHW-1/Images/problem-15-angular-acceleration-option-e.png)
```
