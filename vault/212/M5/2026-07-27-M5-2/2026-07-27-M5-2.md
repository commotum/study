...
content: |-
  **Question 1**
  ...
  Enter the wave speed in meters per second as a number only: ==9.6==
feedback: |-
  The string's linear mass density is

  $$
  \mu=\frac{0.096\ \mathrm{kg}}{3.5\ \mathrm{m}}=0.02743\ldots\ \mathrm{kg/m}.
  $$
  ...
  The measured givens have two significant figures, so $v=9.6\ \mathrm{m/s}$.
```
