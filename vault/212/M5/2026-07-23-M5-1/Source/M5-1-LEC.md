...
content: |-
  **Question 1**
  ...
  ![](<Images/identical-springs-different-masses.png>)
options:
- id: a
...
content: |-
  **Question 3**
  ...
  ![](<Images/transverse-wave-string-particles.png>)
options:
- id: a
  content: Gravity
...
content: |-
  **Question 4**
  ...
  ![](<Images/right-moving-wave-marked-particle.png>)
options:
- id: a
  content: Up
- id: b
...
content: |-
  **Question 5**
  ...
  ![](<Images/right-moving-wave-labeled-points.png>)
options:
- id: a
  content: A
- id: b
