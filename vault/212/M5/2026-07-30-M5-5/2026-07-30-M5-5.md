...
- id: q
  content: Q
  correct: true
  feedback: Q lies at a crest–crest intersection, so the two waves arrive in phase and interfere constructively.
- id: r
  content: R
  feedback: R is not at a crest–crest intersection and therefore is not a point of complete constructive interference.
```
