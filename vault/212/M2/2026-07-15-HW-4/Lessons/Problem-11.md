...
- Use the parallel-axis theorem, $I_{\text{off}}=I_{\text{CM}}+Md^2$.
...
$$
I_{\text{off}}=I_{\text{CM}}+M_{\text{tot}}d^2.
$$

Here, $M_{\text{tot}}$ is the mass of the entire stuck-together object and $d$ is the perpendicular distance between the two parallel axes.

Because the known rod-center axis is the offset axis, solve this relation as

$$
I_{\text{CM}}=I_{\text{rod center}}-M_{\text{tot}}d^2.
$$
...
**Example:** A composite object has moment of inertia $11\ \mathrm{kg\,m^2}$ about an axis that is $0.50\ \mathrm m$ from its center of mass. If its total mass is $4.0\ \mathrm{kg}$, find its inertia about the parallel center-of-mass axis.
...
content: |-
  A $3\ \mathrm{kg}$ object has $I_{\text{off}}=8\ \mathrm{kg\,m^2}$ about an axis $1\ \mathrm m$ from its center of mass. What is $I_{\text{CM}}$ for the parallel center-of-mass axis?
options:
- id: a
  content: |-
    $5\ \mathrm{kg\,m^2}$
...
from the rod's center. Find $d^2$ and then calculate $M_{\text{tot}}d^2$.
...
$$
M_{\text{tot}}=m+\frac m2=\frac{3m}{2}.
$$
...
id: p11-shift-term
content: |-
  If a composite system has total mass $2M$ and its center of mass is a distance $d=\sqrt{a^2/16+b^2/4}$ from a parallel reference axis, what is the shift term $M_{\text{tot}}d^2$?
options:
- id: a
  content: |-
...
$$
I_{\text{rod center}}=\frac{5}{24}mL^2+\frac{7}{10}mr^2.
$$
...
I_{\text{rod center}}=\frac{5}{24}mL^2+\frac{7}{10}mr^2,
\qquad
M_{\text{tot}}d^2=\frac{1}{24}mL^2+\frac{1}{6}mr^2.
$$
...
\begin{aligned}
I_{\text{CM}}
&=I_{\text{rod center}}-M_{\text{tot}}d^2\\
...
1. Write $I_{\text{CM}}=I_{\text{off}}-M_{\text{tot}}d^2$.
