...
content: |-
  **Question 1**
  ...
  ![](<Images/door-force-torque-comparison-full.png>)
options:
- id: a
  content: $F_1$
- id: b
...
content: |-
  **Question 2**
  ...
  ![](<Images/wrench-force-torque.png>)
...
content: |-
  **Question 4**
  ...
  ![](<Images/cord-pulled-solid-cylinder-spool.png>)
...
content: |-
  **Question 5**
  ...
  ![](<Images/coaxial-solid-cylinders.png>)
