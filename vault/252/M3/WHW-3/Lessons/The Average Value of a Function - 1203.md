...
id: q-1
content: |-
  Find the value of $c$ that satisfies the mean value theorem for integrals for $f(x) = 1 - x^{2}$ on the interval $[0, 3]$.
options:
- id: a
  content: |-
    $\sqrt{2}$
...
id: q-3
content: |-
  Find all values of $c$ that satisfy the mean value theorem for integrals for $f(x) = 3x^{2}$ on the interval $[- 2, 2]$.
options:
- id: a
  content: |-
    $-\frac{2}{\sqrt{3}}$
...
&= \frac{1}{4-(-2)}\int_{-2}^{4}(x-2)\,dx \\
&= \frac{1}{6}(\frac{x^{2}}{2} - 2x) \mid _{-2}^{4} \\
&= \frac{1}{6}\left[\left(\frac{4^2}{2}-2(4)\right)-\left(\frac{(-2)^2}{2}-2(-2)\right)\right] \\
&= \frac{1}{6}[(8 - 8) - (2 + 4)] \\
&= \frac{1}{6}(0 - 6) \\
&=-1
\end{aligned}
...
id: q-6
content: |-
  Find $c$ such that the average value of $h(x) = 5x - 8$ on the interval $[0, c]$ is equal to $-3$.
options:
- id: a
  content: |-
    $\frac{5}{2}$
...
id: q-7
content: |-
  Find the number $c > 0$ such that the average value of $f(x) = 9 + 8x - 3x^{2}$ on the interval $[0, c]$ is equal to $-3$.
options:
- id: a
  content: |-
    $5$
