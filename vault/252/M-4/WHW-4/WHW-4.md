...
Section 1.4, Problem 207:

Use basic integration formulas to compute the antiderivative.
...
Section 1.4, Problem 223:

A particle moves with velocity

$$
v(t)=4-2t, \qquad 0\le t\le 2,
$$

in meters per second. Find the displacement at time $t$ and the total distance traveled up to $t=2$.

---
## Problem 4

Section 1.4, Problem 226:

A particle moves with acceleration

$$
a(t)=t-3, \qquad 0\le t\le 6,
$$

in meters per second. Find the velocity and displacement at time $t$ and the total distance traveled up to $t=6$, given $v(0)=3$ and $d(0)=0$.

---
## Problem 5

Section 1.5, Problem 280:

Use a suitable change of variables to determine the indefinite integral.

$$
\int t^2\cos^2\left(t^3\right)\sin\left(t^3\right)\,dt
$$

---
## Problem 6

Section 1.5, Problem 283:
...
Use the substitution $x=\cos t$ to express the area of a semicircle as the integral of a trigonometric function. You do not need to compute the integral.

---
## Problem 8

Section 1.6, Problem 355:
