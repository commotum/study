...
id: q-1
content: |-
  Calculate $∫_{π/8}^{π/8}\sin^{3} (\tan 2x)dx$.
options:
- id: a
  content: |-
    $1$
...
id: q-2
content: |-
  Calculate $∫_{π/4}^{π/4}\tan (\sqrt{x})dx$.
options:
- id: a
  content: |-
    $2$
...
id: q-3
content: |-
  Given that $∫_{9}^{4}f(x)dx = 6$, calculate
...
id: q-4
content: |-
  Given that $∫_{5}^{2}f(x)dx =-4$, calculate
...
id: q-5
content: |-
  Given that $∫_{-5}^{1}f(x)dx =-6$ and $∫_{1}^{3}f(x)dx = 4$ then what is $∫_{-5}^{3}(2 - 3f(x))dx$?
options:
- id: a
  content: |-
    $10$
...
id: q-6
content: |-
  Given that $∫_{2}^{3}f(x)dx =-4$ and $∫_{3}^{8}f(x)dx = 7$ then what is $∫_{2}^{8}(5f(x) + 4)dx$?
options:
- id: a
  content: |-
    $55$
...
id: q-7
content: |-
  Suppose that $f(x)$ is a function such that $∫_{6}^{3}\frac{1}{5}f(x)dx =-1$ and $∫_{0}^{3}f(x)dx = 3$. What is the value of $∫_{0}^{6}f(x)dx$?
options:
- id: a
  content: |-
    $8$
...
id: q-8
content: |-
  Suppose that $f(x)$ is a function such that $∫_{3}^{11}f(x)dx = 13$ and $∫_{15}^{11}7f(x)dx = 21$. What is the value of $∫_{3}^{15}f(x)dx$?
options:
- id: a
  content: |-
    $4$
