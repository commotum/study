...
- [Introduction to Geometric Sequences](<7.3.1. Introduction to Geometric Sequences.md>)
...
**Question 1:** What is the recursive formula for the following geometric sequence?
$2, 6, 18, …$

- [ ] A. $a_{n + 1} = 2a_{n}, a_{1} = 1, n \ge 1$
- [ ] B. $a_{n + 1} = \frac{a_{n}}{3}, a_{1} = 2, n \ge 1$
- [ ] C. $a_{n + 1} = a_{n} + 2, a_{1} = 1, n \ge 1$
- [ ] D. $a_{n + 1} = a_{n} + 3, a_{1} = 2, n \ge 1$
- [ ] E. $a_{n + 1} = 3a_{n}, a_{1} = 2, n \ge 1$
...
- [ ] A. $a_{n + 1} = \frac{4}{5}a_n,\ a_1 = 100,\ n \ge 1$
- [ ] B. $a_{n + 1} = \frac{5}{4}a_n,\ a_1 = 100,\ n \ge 1$
- [ ] C. $a_{n + 1} = \frac{4}{5}a_n,\ a_1 = 80,\ n \ge 1$
- [ ] D. $a_{n + 1} = 20a_n,\ a_1 = 100,\ n \ge 1$
- [ ] E. $a_{n + 1} = a_n - 20,\ a_1 = 100,\ n \ge 1$
...
- [ ] A. $a_{n + 1} = -\frac{2}{3}a_n,\ a_1 = 243,\ n \ge 1$
- [ ] B. $a_{n + 1} = \frac{2}{3}a_n,\ a_1 = 243,\ n \ge 1$
- [ ] C. $a_{n + 1} = -\frac{3}{2}a_n,\ a_1 = 243,\ n \ge 1$
- [ ] D. $a_{n + 1} = -81a_n,\ a_1 = 243,\ n \ge 1$
- [ ] E. $a_{n + 1} = -\frac{2}{3}a_n,\ a_1 = -162,\ n \ge 1$
...
**Question 6:** What is the $4$th term of the geometric sequence given below?
...
**Question 7:** What is the $3$rd term of the geometric sequence given below?
