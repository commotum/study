...
An angle of $\frac{π}{8}$ radians is equal to
...
Rounded to the nearest degree, an angle of $\frac{6π}{13}$ radians is equal to
...
Rounded to one decimal place, $99^{∘}$ is equal to
