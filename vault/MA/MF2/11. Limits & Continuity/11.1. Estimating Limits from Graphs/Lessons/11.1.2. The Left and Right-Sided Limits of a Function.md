...
![](<../Source/11.1.2. The Left and Right-Sided Limits of a Function/Images/0534081fc0f62990bfa81fdb4df01629.png>)
...
![](<../Source/11.1.2. The Left and Right-Sided Limits of a Function/Images/7881705e8f8e124182a5d25f6266bbeb.png>)
...
![](<../Source/11.1.2. The Left and Right-Sided Limits of a Function/Images/q-16340.png>)
...
![](<../Source/11.1.2. The Left and Right-Sided Limits of a Function/Images/q-300664.png>)

If the figure above shows the graph of $f(x)$, then which statement is true?

- [ ] A. $lim_(x → 1^{-})f(x) = 2$ and $lim_(x → 1^{+})f(x) = 2$
- [ ] B. $lim_(x → 1^{-})f(x) = 1$ and $lim_(x → 1^{+})f(x) = 2$
- [ ] C. $lim_(x → 1^{-})f(x) = 2$ and $lim_(x → 1^{+})f(x) = 3$
- [ ] D. $lim_(x → 1^{-})f(x) = DNE$ and $lim_(x → 1^{+})f(x) = 2$
- [ ] E. $lim_(x → 1^{-})f(x) = 2$ and $lim_(x → 1^{+})f(x) = DNE$

---

**Question 3**

![](<../Source/11.1.2. The Left and Right-Sided Limits of a Function/Images/q-16545.png>)
...
![](<../Source/11.1.2. The Left and Right-Sided Limits of a Function/Images/642bd4dd0c367ada1c65ec90cdb9a0a0.png>)
...
![](<../Source/11.1.2. The Left and Right-Sided Limits of a Function/Images/q-16384.png>)
...
![](<../Source/11.1.2. The Left and Right-Sided Limits of a Function/Images/q-16602.png>)
...
![](<../Source/11.1.2. The Left and Right-Sided Limits of a Function/Images/159bff05b4056d41855a5746156d573a.png>)
...
![](<../Source/11.1.2. The Left and Right-Sided Limits of a Function/Images/q-47600.png>)
...
![](<../Source/11.1.2. The Left and Right-Sided Limits of a Function/Images/q-54183.png>)
