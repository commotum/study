...
- [Intersections of Intervals](<1.3.5. Intersections of Intervals.md>)
...
The solution to this inequality is shown on the number line below.![](<../Source/1.3.7. Compound AND Inequalities/Images/30920650a46bfc93ee5e011c8efd5984.png>)
...
![](<../Source/1.3.7. Compound AND Inequalities/Images/cbd11e3c7e4794d3e255b7956ac308f7.png>)

To find the values of $x$ that satisfy both inequalities, we find where the two solutions overlap:

![](<../Source/1.3.7. Compound AND Inequalities/Images/52f64062ce2e596fecab5cf9954b9b59.png>)
...
![](<../Source/1.3.7. Compound AND Inequalities/Images/9d46a4a3b9bc085c610c11ea73fcd8e6.png>)

- Then, we solve $7x +11 < -3$:
$\begin{bmatrix}7x + 11 & < - 3 \\ 7x + 11 - 11 & < - 3 - 11 \\ 7x & < - 14 \\ \frac{7x}{7} & < \frac{-14}{7} \\ x & < - 2\end{bmatrix}$

![](<../Source/1.3.7. Compound AND Inequalities/Images/3a8e22a4e538383d4309676749f57d55.png>)

To find the values of $x$ that satisfy both inequalities, we find where the two solutions overlap:

![](<../Source/1.3.7. Compound AND Inequalities/Images/69726bd8e2fa576d7855c0b173151044.png>)
...
Find the values of $x$ that satisfy $9x - 17 \ge 10$ and $6x + 21 < 45$. $\underline{\hspace{1.5cm}}$ $\underline{\hspace{1.5cm}}$
$x <$
...
- [ ] A. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-25588-a-5.png>)
- [ ] B. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-25588-a-3.png>)
- [ ] C. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-25588-a-2.png>)
- [ ] D. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-25588-a-1.png>)
- [ ] E. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-25588-a-4.png>)

---

**Question 3:** Find the set of values of $x$ that satisfy $3x + 1 \le 4$ and $2x - 3 \ge 3$.
...
![](<../Source/1.3.7. Compound AND Inequalities/Images/baf667424ead9a250fc3a182978bde2a.png>)

- Then, we solve $7x > 21$:
$\begin{bmatrix}7x & > 21 \\ \frac{7x}{7} & > \frac{21}{7} \\ x & > 3\end{bmatrix}$

![](<../Source/1.3.7. Compound AND Inequalities/Images/33cbebe89d32697d4d1c185e22455510.png>)

To find the values of $x$ that satisfy both inequalities, we find where the two solutions overlap:

![](<../Source/1.3.7. Compound AND Inequalities/Images/d407eb9eeb513a2974b00914e8d15bda.png>)
...
${x + 5 \le 6; 5x - 4 < 6$The solution is
$x$
...
- [ ] A. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-51736-a-1.png>)
- [ ] B. No solutions
- [ ] C. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-51736-a-4.png>)
- [ ] D. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-51736-a-2.png>)
- [ ] E. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-51736-a-3.png>)
...
- [ ] B. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-25455-a-3.png>)
- [ ] C. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-25455-a-5.png>)
- [ ] D. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-25455-a-2.png>)
- [ ] E. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-25455-a-4.png>)
...
![](<../Source/1.3.7. Compound AND Inequalities/Images/0884f6ef95b762b67df4d43f303b59b4.png>)

- Then, we solve $10x-3 \geq 7$:
$\begin{bmatrix}10x - 3 & \ge 7 \\ 10x - 3 + 3 & \ge 7 + 3 \\ 10x & \ge 10 \\ \frac{10x}{10} & \ge \frac{10}{10} \\ x & \ge 1\end{bmatrix}$

![](<../Source/1.3.7. Compound AND Inequalities/Images/7574b2bbe2aca4fbdc54f2fa8247bc74.png>)

To find the values of $x$ that satisfy both inequalities, we find where the two solutions overlap:

![](<../Source/1.3.7. Compound AND Inequalities/Images/8df3636faeff77e8b0c0747ab3aa7474.png>)
...
What is the solution to the following system of inequalities?
${3y - 5 \le 4; 1 - 6y \le - 5$The solution is
$\underline{\hspace{1.5cm}}$ $\underline{\hspace{1.5cm}}$
$y \le$
$\underline{\hspace{1.5cm}}$.
...
- [ ] A. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-102305-a-1.png>)
- [ ] B. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-102305-a-4.png>)
- [ ] C. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-102305-a-2.png>)
- [ ] D. There is no solution
- [ ] E. ![](<../Source/1.3.7. Compound AND Inequalities/Images/q-102305-a-3.png>)

---

**Question 9:** Find the set of values of $x$ that satisfy $6 - x > 7$ and $5x + 3 > 8$.
...
![](<../Source/1.3.7. Compound AND Inequalities/Images/2884cabcbd2d62824f13bee340ceb456.png>)
...
![](<../Source/1.3.7. Compound AND Inequalities/Images/0a46b546c4a69d5765e1474ff4b8c430.png>)

To find the values of $x$ that satisfy both inequalities, we find where the two solutions overlap:

![](<../Source/1.3.7. Compound AND Inequalities/Images/3e6987cb88b0209e3010a263dcaff3f1.png>)

Thus, the final solution is $x \in [2,3]$.

---

**Question 10:** Find the set of values of $x$ that satisfy $3 < 1 + 2x \le 9$ and $2x - 1 > 3$.
...
Find the set of values of $x$ that satisfy $-1 \le 2 - x \le 3$ and $2x + 1 \ge 5$. $\underline{\hspace{1.5cm}}$
$\le x$
$\underline{\hspace{1.5cm}}$ $\underline{\hspace{1.5cm}}$
