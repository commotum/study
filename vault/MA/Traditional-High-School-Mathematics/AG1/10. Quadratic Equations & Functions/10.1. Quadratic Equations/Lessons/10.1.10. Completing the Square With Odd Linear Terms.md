...
Rewrite the following expression as the difference of a perfect square and a constant.$(y^{2} + 13y + \frac{169}{4}) - 7 = (y +$
...
Complete the square on the quadratic expression $x^{2} + 3x + 9$.$x^{2} + 3x + 9 = (x +$
$\underline{\hspace{1.5cm}}$ $)^{2} +$
$\underline{\hspace{1.5cm}}$
...
Complete the square on the quadratic expression $y^{2} - 15y$.$y^{2} - 15y = (y -$
$\underline{\hspace{1.5cm}}$ $)^{2} -$
$\underline{\hspace{1.5cm}}$
