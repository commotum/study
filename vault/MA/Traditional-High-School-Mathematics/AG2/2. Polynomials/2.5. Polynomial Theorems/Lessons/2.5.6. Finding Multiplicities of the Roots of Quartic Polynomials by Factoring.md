...
- [Multiplicities of the Roots of Polynomials](<2.5.5. Multiplicities of the Roots of Polynomials.md>)
- [Factoring Quartic Polynomials Using the Factor Theorem](<2.5.4. Factoring Quartic Polynomials Using the Factor Theorem.md>)
- [Factoring Biquadratic Expressions](<../../2.2. Factoring Polynomials/Lessons/2.2.5. Factoring Biquadratic Expressions.md>)
