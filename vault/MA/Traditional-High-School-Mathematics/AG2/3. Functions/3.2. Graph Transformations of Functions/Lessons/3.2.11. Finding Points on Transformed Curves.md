...
- [Local Extrema of Functions](<../../3.1. Functions/Lessons/3.1.1. Local Extrema of Functions.md>)
- [Combining Reflections With Other Graph Transformations](<3.2.10. Combining Reflections With Other Graph Transformations.md>)
...
**Question 1:** The point $(a, b)$ lies on the curve $y = x^{2}$. Which of the following points **must** lie on $y = (x - 1)^{2} + 2$?
...
**Question 2:** The point $(1, 4)$ lies on the curve $y = f(x)$. Which of the following points **must** lie on $y = f(x - 1) + 1$?
...
**Question 3:** The point $(-1, 1)$ lies on the curve $y = f(x) + 1$. Which of the following points **must** lie on $y =-f(x) - 1$?
...
**Question 4:** The point $(-2, 4)$ lies on the curve $y = 2f(x)$. Which of the following points **must** lie on $y =-f(x) + 2$?
...
![](<../Source/3.2.11. Finding Points on Transformed Curves/Images/b53c8586926d67b540d201fd62ca8985.png>)
...
![](<../Source/3.2.11. Finding Points on Transformed Curves/Images/bce935fca56867d04a01bc4bd9064284.png>)
...
![](<../Source/3.2.11. Finding Points on Transformed Curves/Images/818f2f99d6cd5ba26f6092f0af8b81a2.png>)
...
![](<../Source/3.2.11. Finding Points on Transformed Curves/Images/f409140a46a8034453948c18db9672e9.png>)
...
![](<../Source/3.2.11. Finding Points on Transformed Curves/Images/q-121221.png>)
...
![](<../Source/3.2.11. Finding Points on Transformed Curves/Images/q-186866.png>)
