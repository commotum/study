...
![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/ada7f7603853d35bcf0e03ac54d53157.png>)

- Then, stretch it parallel to the $y$-axis by a stretch factor of $2$ to give $y=2\cos{x}$.

![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/1b0c78d79016771cccd6aa50fb60bf02.png>)

- Next, shift to the **left** by $2$ units to give $y=2\cos(x + 2)$.

![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/504ee16c673208beb2774641c5e66863.png>)

- Finally, shift it **down** by $1$ unit to give $y=2\cos\left(x + 2\right) - 1$.

![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/02789c684c86be83fdb2c38704233384.png>)
...
![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/18432f4bbf6c1b1d25ed7b28e8a18a15.png>)

**Explanation**

The constant $C$ is the phase shift of the function.

![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/83b66425886a41270f3088d72b5cc1e8.png>)
...
![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/q-65530.png>)
...
![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/q-65635.png>)
...
![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/5e0c2c562d9337497b4b8c194e38cd14.png>)
...
![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/q-65673.png>)
...
![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/q-65651.png>)
...
![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/8f5530a7155089ee92031b433f06893f.png>)
...
![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/q-65414.png>)
...
![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/q-65653.png>)
...
![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/17361430717e9011126b9fcc1df3819b.png>)

**Explanation**

![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/03649ffb7c21d1e5fb877f7f68681b68.png>)
...
![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/q-12540.png>)
...
![](<../Source/9.3.5. Combining Graph Transformations of Sine and Cosine/Images/q-6620.png>)
