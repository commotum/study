...
- [Scalar Multiplication of Matrices](<6.1.5. Scalar Multiplication of Matrices.md>)
...
- [ ] A. $\begin{bmatrix}-2 & -1 & 8 \\ 9 & 6 & 2 \\ 7 & 0 & 1\end{bmatrix}$
- [ ] B. $\begin{bmatrix}-2 & 1 & -8 \\ 7 & 0 & 1 \\ 9 & 6 & 2\end{bmatrix}$
- [ ] C. $\begin{bmatrix}-8 & 2 & 1 \\ 1 & 6 & 0 \\ -2 & 9 & 7\end{bmatrix}$
- [ ] D. $\begin{bmatrix}-2 & 1 & -8 \\ 9 & 6 & 2 \\ 7 & 0 & 1\end{bmatrix}$
- [ ] E. $\begin{bmatrix}2 & -1 & 8 \\ 9 & 6 & 2 \\ 7 & 0 & 1\end{bmatrix}$

---

**Question 2:** Find $A^{T}$, given that
$A = \begin{bmatrix}5 & 4 \\ 3 & 2\end{bmatrix}$.

- [ ] A. $\begin{bmatrix}5 & 3 \\ 4 & 2\end{bmatrix}$
- [ ] B. $\begin{bmatrix}-5 & -3 \\ -4 & -2\end{bmatrix}$
- [ ] C. $\begin{bmatrix}0 & 4 \\ 3 & 0\end{bmatrix}$
- [ ] D. $\begin{bmatrix}2 & 4 \\ 3 & 5\end{bmatrix}$
- [ ] E. $\begin{bmatrix}5 & 3 & 4 & 2\end{bmatrix}$
...
- [ ] A. $\begin{bmatrix}-4 & 15 \\ -1 & 8\end{bmatrix}$
- [ ] B. $\begin{bmatrix}8 & -1 & 15 & -4\end{bmatrix}$
- [ ] C. $\begin{bmatrix}8 \\ -1 \\ 15 \\ -4\end{bmatrix}$
- [ ] D. $\begin{bmatrix}-4 & 15 & -1 & 8\end{bmatrix}$
- [ ] E. $\begin{bmatrix}4 & -15 & 1 & -8\end{bmatrix}$

---

**Question 4:** Find $Z^{T}$ given that
$Z = \begin{bmatrix}-4 & 4 & 5 & 1\end{bmatrix}$.

- [ ] A. $\begin{bmatrix}4 \\ -4 \\ -5 \\ -1\end{bmatrix}$
- [ ] B. $\begin{bmatrix}-4 \\ 4 \\ 5 \\ 1\end{bmatrix}$
- [ ] C. $\begin{bmatrix}-1 & -5 & 4 & -4\end{bmatrix}$
- [ ] D. $\begin{bmatrix}1 \\ 5 \\ 4 \\ -4\end{bmatrix}$
- [ ] E. $\begin{bmatrix}1 & 5 & 4 & -4\end{bmatrix}$
...
**Question 5:** Consider the matrix
