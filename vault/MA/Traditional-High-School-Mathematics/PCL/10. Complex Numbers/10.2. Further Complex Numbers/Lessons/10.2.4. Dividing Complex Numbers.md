...
**Question 1:** What is $\frac{6 - 2\textrm{i}}{1 - 4\textrm{i}}$?

- [ ] A. $\frac{14}{17} + \frac{22}{17}\textrm{i}$
- [ ] B. $\frac{2}{17} + \frac{22}{17}\textrm{i}$
- [ ] C. $\frac{12}{17} + \frac{22}{17}\textrm{i}$
- [ ] D. $\frac{-2}{17} + \frac{22}{17}\textrm{i}$
- [ ] E. $\frac{-2}{17} + \frac{26}{17}\textrm{i}$

---

**Question 2:** If $z_{1} = 2 - 5\textrm{i}$ and $z_{2} = 6 + 3\textrm{i}$, then $z_{1}$ divided by $z_{2}$ equals

- [ ] A. $-\frac{1}{15} + \frac{8}{15}\textrm{i}$
- [ ] B. $-\frac{1}{15} + \frac{4}{5}\textrm{i}$
- [ ] C. $\frac{3}{5} - \frac{4}{5}\textrm{i}$
- [ ] D. $-\frac{3}{5} - \frac{8}{15}\textrm{i}$
- [ ] E. $-\frac{1}{15} - \frac{4}{5}\textrm{i}$
...
**Question 3:** What is $\frac{4\textrm{i}}{2 - 3\textrm{i}}$?

- [ ] A. $\frac{12}{13} + \frac{8}{13}\textrm{i}$
- [ ] B. $-12 + 8\textrm{i}$
- [ ] C. $\frac{12}{13} - \frac{8}{13}\textrm{i}$
- [ ] D. $-\frac{12}{13} + \frac{8}{13}\textrm{i}$
- [ ] E. $12 - 8\textrm{i}$

---

**Question 4:** What is $\frac{3\textrm{i}}{1 + \textrm{i}}$?

- [ ] A. $\frac{3}{2} - \frac{3}{2}\textrm{i}$
- [ ] B. $3 - 3\textrm{i}$
- [ ] C. $\frac{3}{2} + \frac{3}{2}\textrm{i}$
...
**Question 5:** What is $\frac{-3}{-2 + 6\textrm{i}}$?

- [ ] A. $-\frac{3}{20} - \frac{9}{20}\textrm{i}$
- [ ] B. $\frac{3}{20} + \frac{9}{20}\textrm{i}$
- [ ] C. $-3 + 9\textrm{i}$
- [ ] D. $3 + 9\textrm{i}$
- [ ] E. $\frac{3}{20} - \frac{9}{20}\textrm{i}$

---

**Question 6:** What is $\frac{3}{3 + 2\textrm{i}}$?

- [ ] A. $\frac{9}{13} + \frac{2}{13}\textrm{i}$
- [ ] B. $\frac{3}{13} - \frac{2}{13}\textrm{i}$
- [ ] C. $\frac{3}{2} - \textrm{i}$
- [ ] D. $\frac{9}{13} - \frac{2}{13}\textrm{i}$
- [ ] E. $\frac{9}{13} - \frac{6}{13}\textrm{i}$
...
**Question 7:** If $z_{1} = 2 + 3\textrm{i}$ and $z_{2} = 4\textrm{i}$, then $z_{1}$ divided by $z_{2}$ equals

- [ ] A. $-\frac{3}{4} - \frac{1}{2}\textrm{i}$
- [ ] B. $-2 + 3\textrm{i}$
- [ ] C. $\frac{3}{4} - \frac{1}{2}\textrm{i}$
- [ ] D. $2 + 3\textrm{i}$
- [ ] E. $-\frac{3}{4} + \frac{1}{2}\textrm{i}$

---

**Question 8:** What is $\frac{2 - 3\textrm{i}}{4\textrm{i}}$?

- [ ] A. $-\frac{3}{4} - \frac{1}{2}\textrm{i}$
- [ ] B. $\frac{3}{4} + \frac{1}{2}\textrm{i}$
- [ ] C. $\frac{4}{3} - 2\textrm{i}$
- [ ] D. $-\frac{1}{2} - \frac{3}{4}\textrm{i}$
- [ ] E. $\frac{1}{2} + \frac{3}{4}\textrm{i}$
