...
- [Expanding a Binomial Using Binomial Coefficients](<1.3.2. Expanding a Binomial Using Binomial Coefficients.md>)
...
$(1 + \frac{t}{5})^{10} =$$1 +$
$\underline{\hspace{1.5cm}}$ $t +$
$\underline{\hspace{1.5cm}}$ $t^{2} + ⋯$
...
Find, in ascending powers of $t$, the **first three terms** in the binomial expansion of $(1 - 8t)^{6}$.$(1 - 8t)^{6} =$
...
- [ ] A. $1 - \frac{5a}{2} + \frac{5a^{2}}{2} + ⋯$
- [ ] B. $1 + \frac{5a}{2} + \frac{5a^{2}}{2} + ⋯$
- [ ] C. $1 - \frac{5a}{2} + \frac{5a^{2}}{4} + ⋯$
- [ ] D. $1 - \frac{5a}{2} + \frac{a^{2}}{2} + ⋯$
- [ ] E. $1 + \frac{5a}{2} + \frac{a^{2}}{2} + ⋯$
...
The coefficient of $k^{4}$ in the expansion of $(1 - 4k)^{6}$ is $\underline{\hspace{1.5cm}}$.
