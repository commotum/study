...
**Question 2:** Suppose $X_{1}, X_{2}, X_{3}, X_{4}, X_{5}$ is an I.I.D random sample with $X_{i}∼Bernoulli(θ)$ and unknown probability of success $θ$. Find the likelihood function of the sample $1, 0, 0, 1, 0$.
...
**Question 4:** Suppose $X_{1}, X_{2}, X_{3}, X_{4}$ is an I.I.D random sample with $X_{i}∼B(6, θ)$ and unknown probability of success $θ$. Find the likelihood function of the sample $3, 0, 2, 5$ up to a constant $C$.
...
- [ ] A. $6θ^{2}e^{-18θ}$
- [ ] B. $\frac{1}{6}θ^{2}e^{-16θ}$
- [ ] C. $\frac{1}{6}θ^{18}e^{-16θ}$
- [ ] D. $12θ^{16}e^{-18θ}$
- [ ] E. $6θ^{18}e^{-2θ}$
...
- [ ] A. $\frac{1}{36}θ^{12}e^{-5θ}$
- [ ] B. $\frac{1}{36}θ^{5}e^{-12θ}$
- [ ] C. $\frac{1}{864}θ^{5}e^{-12θ}$
- [ ] D. $\frac{1}{864}θ^{5}e^{-24θ}$
- [ ] E. $\frac{1}{864}θ^{12}e^{-5θ}$
