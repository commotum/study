...
**Question 1:** Consider the function $f$, defined as
...
- [ ] A. a matrix of shape $2 \cdot 2$
- [ ] B. a scalar
- [ ] C. a matrix of shape $1 \cdot 1$
- [ ] D. a row vector of shape $1 \cdot 2$
- [ ] E. a column vector of shape $2 \cdot 1$

---

**Question 2:** Consider the function $f$, defined as
$f(x) = \begin{bmatrix}x^{2} \\ x\end{bmatrix}$.
What is the shape of the total derivative of $f$ with respect to $x$?

- [ ] A. a scalar
- [ ] B. a matrix of shape $1 \cdot 1$
- [ ] C. a matrix of shape $2 \cdot 2$
- [ ] D. a row vector of shape $1 \cdot 2$
- [ ] E. a column vector of shape $2 \cdot 1$
...
- [ ] C. $2x + 1$
- [ ] D. $\begin{bmatrix}2x & 1\end{bmatrix}$
- [ ] E. $\begin{bmatrix}2x \\ 1\end{bmatrix}$

---

**Question 4:** Consider the function $f: R^{3} → R$ defined by $f(x) = x^{T}x$. What is the total derivative of $f$ with respect to $x$?
