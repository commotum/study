...
id: ma-265752
content: |-
  Compute the gradient of the function $f: R^{3} → R$ defined by $f(x) = \begin{bmatrix}1 & 2 & 0\end{bmatrix} \cdot x$ with respect to $x$ at $x = \begin{bmatrix}-2 \\ 0 \\ 1\end{bmatrix}$.
options:
- id: a
  content: |-
    $-2$
