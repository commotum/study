...
id: ma-343712
content: |-
  $U = [\mid \mid \mid; u_{1} \mid ⋯ \mid u_{n}; \mid \mid \mid], V = [\mid \mid \mid; v_{1} \mid ⋯ \mid v_{m}; \mid \mid \mid]$
...
id: ma-343711
content: |-
  $U = \begin{bmatrix}\frac{1}{\sqrt{2}} & -\frac{1}{\sqrt{2}} \\ \frac{1}{\sqrt{2}} & \frac{1}{\sqrt{2}}\end{bmatrix}, V = \begin{bmatrix}-\frac{1}{3\sqrt{2}} & -\frac{1}{\sqrt{2}} & \frac{2}{3} \\ \frac{4}{3\sqrt{2}} & 0 & \frac{1}{3} \\ -\frac{1}{3\sqrt{2}} & \frac{1}{\sqrt{2}} & \frac{2}{3}\end{bmatrix}$
