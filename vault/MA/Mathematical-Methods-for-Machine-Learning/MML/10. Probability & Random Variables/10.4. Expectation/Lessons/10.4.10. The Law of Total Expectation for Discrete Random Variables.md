...
id: ma-275332
content: |-
  Let $X$ and $Y$ be discrete random variables, and suppose $E[X∣Y] = 2Y + 1$. If $E[Y] = 3$, what is $E[X]$?
options:
- id: a
  content: |-
    $3$
...
id: ma-275341
content: |-
  Let $X$ and $Y$ be discrete random variables, and suppose $E[X∣Y] = 5Y - 4$. If $E[X] = 11$, what is $E[Y]$?
options:
- id: a
  content: |-
    $2.5$
...
id: ma-275334
content: |-
  A game randomly selects an integer $n$ from $1$ to $301$, with each value equally likely. Then, a player is asked to guess an integer uniformly and randomly from $1$ to $n$. What is the expected value of the player’s guess?
options:
- id: a
  content: |-
    $78$
