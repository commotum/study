...
- [Extending the Law of Total Probability](<../../10.1. Probability/Lessons/10.1.1. Extending the Law of Total Probability.md>)
- [Conditional Expectation for Discrete Random Variables](<../../../11. Combining Random Variables/11.3. Expectation for Joint Distributions/Lessons/11.3.4. Conditional Expectation for Discrete Random Variables.md>)
- [Mean and Variance of the Discrete Uniform Distribution](<../../10.5. Discrete Probability Distributions/Lessons/10.5.7. Mean and Variance of the Discrete Uniform Distribution.md>)
