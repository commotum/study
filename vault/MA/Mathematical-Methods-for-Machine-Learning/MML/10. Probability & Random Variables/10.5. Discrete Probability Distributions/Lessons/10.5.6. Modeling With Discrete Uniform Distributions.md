...
**Question 3:** In a game show, a contestant can choose a prize from any box. The boxes are labeled with numbers $5$ through $15$. If the contestant chooses a box at random, what is the probability that the box number they pick is less than $10$?
...
**Question 4:** In a videogame, the number of obstacles that show up during a game can vary between $100$ and $155$, inclusive. Assuming that each number of obstacles has the same probability to occur, what is the probability of having less than $130$ obstacles?
