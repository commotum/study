...
content: |-
  If $(2x - 1)$ is a factor of $p(x) = ax^{2} - x - 1$, then $a =$
options:
- id: a
  content: |-
    $1$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  If $(x + 4)$ is a factor of $p(x) = 2x^{2} + 13x + a$, then $a =$
options:
- id: a
  content: |-
    $20$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Given that $(x - 2)$ and $(x + 1)$ are factors of $f(x) = x^{3} + ax^{2} + bx + 10$, then $a + b =$
options:
- id: a
  content: |-
    $-2$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Given that $(x - 2)$ and $(x + 2)$ are factors of $f(x) = ax^{3} - x^{2} - 16x + b$, then $a + b =$
options:
- id: a
  content: |-
    $14$
