...
**Question 1:** Given that $F(x, y, z) = xyi + yzj + xzk$, what is $curlF$?
...
**Question 2:** Consider the vector field $F = x\cos yzi + y\ln xzk$. Evaluate $∇ \cdot F$ at the point $(1, \frac{π}{2}, 1)$.
...
**Question 3:** Given that $F(x, y) = xyi + yj$, what is the scalar curl of $F$?
...
**Question 4:** Consider the vector field $F(x, y) = x\sin yi + \cos (xy)j$. Evaluate the scalar curl of $F$ at the point $(π, 0)$.
