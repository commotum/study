...
**Question 1:** Given that $y < 150$ and $t \ge 0$, which of the following is an inhibited growth equation?

- [ ] A. $\frac{dy}{dt} = 150(y + 0.5)$
- [ ] B. $\frac{dy}{dt} = 150(y - 0.5)$
- [ ] C. $\frac{dy}{dt} = 0.5(150 - y)$
- [ ] D. $\frac{dy}{dt} = 0.5(y - 150)$
- [ ] E. $\frac{dy}{dt} =-0.5(y + 150)$

---

**Question 2:** Given that $y < 80$ and $t \ge 0$, which of the following is an inhibited growth equation?

- [ ] A. $\frac{dy}{dt} = 5 - 400y$
- [ ] B. $\frac{dy}{dt} = 400 - 5y$
- [ ] C. $\frac{dy}{dt} = 5y - 400$
- [ ] D. $\frac{dy}{dt} = 400 - 5y^{2}$
- [ ] E. $\frac{dy}{dt} = 5y^{2} - 400$

---

**Question 3:** Which of the following initial value problems is an inhibited growth problem?

- [ ] A. $\frac{dy}{dt} = 3(250 - y), y(0) = 150$
- [ ] B. $\frac{dy}{dt} = 3(250 - y), y(0) = 400$
- [ ] C. $\frac{dy}{dt} = 3(y - 250), y(0) = 200$
- [ ] D. $\frac{dy}{dt} =-3(y + 250), y(0) = 100$
- [ ] E. $\frac{dy}{dt} = 3y(y - 250), y(0) = 50$
