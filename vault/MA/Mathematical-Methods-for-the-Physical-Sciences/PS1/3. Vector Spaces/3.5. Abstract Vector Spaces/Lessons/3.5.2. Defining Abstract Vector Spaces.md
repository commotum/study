...
- [Introduction to Abstract Vector Spaces](<MA/Mathematical-Methods-for-the-Physical-Sciences/PS1/3. Vector Spaces/3.5. Abstract Vector Spaces/Lessons/3.5.1. Introduction to Abstract Vector Spaces.md>)
...
- [ ] A. addition of polynomials is not associative
- [ ] B. $W$ does not contain the zero element
- [ ] C. $W$ does not contain the polynomial $-p(x)$ for every $p(x) ∈ W$
- [ ] D. addition of polynomials is not commutative
- [ ] E. addition and scalar multiplication of polynomials do not satisfy the distributive laws
...
- [ ] A. multiplication of $f ∈ C$ by a scalar is not closed
- [ ] B. $1 \cdot f \ne f$ for some $f ∈ C$
- [ ] C. addition of $f, g ∈ C$ is not commutative
- [ ] D. $C$ does not contain the zero element
- [ ] E. addition of $f, g ∈ C$ is not associative
