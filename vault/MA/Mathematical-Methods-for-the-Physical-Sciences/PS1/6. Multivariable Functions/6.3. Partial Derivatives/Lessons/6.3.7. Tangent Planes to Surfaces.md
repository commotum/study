...
content: |-
  Find the equation of the tangent plane to the surface $z = \sqrt{x^{2} + 2y^{3}} - y$ at the point $(3, 2, 3)$.
options:
- id: a
  content: |-
    $5x + 2y - 5z + 8 = 0$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Find the equation of the tangent plane to the surface $z = y^{2}e^{2x} - 1$ at the point $(0, 2, 3)$.
options:
- id: a
  content: |-
    $4x + 4y - z - 5 = 0$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Find the equation of the tangent hyperplane to the hypersurface $w = e^{x} + e^{y} - e^{z}$ at the point $(1, 1, 1, e)$.
options:
- id: a
  content: |-
    $ex - ey - ez - w = 0$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Find the equation of the tangent hyperplane to the hypersurface $w = x^{2} - y^{2} + xyz$ at the point $(1, 1, 1, 1)$.
options:
- id: a
  content: |-
    $x + y - 3z - w - 1 = 0$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  At which points on the surface $z = 3xy - \ln y$ is the tangent plane perpendicular to the vector $v = ⟨3, 5,-1⟩$?
options:
- id: a
  content: |-
    $(0, 1, 0)$ only
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  At which points on the surface $z = \ln (1 + x^{2} + y^{2})$ is the tangent plane horizontal?
options:
- id: a
  content: |-
    $(1, 0, \ln 2)$ and $(0, 1, \ln 2)$
- id: b
  content: |-
    $(0, 0, 0)$ only
- id: c
