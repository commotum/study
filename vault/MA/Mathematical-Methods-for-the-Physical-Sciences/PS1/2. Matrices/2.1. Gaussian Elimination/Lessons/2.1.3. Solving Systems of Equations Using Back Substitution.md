...
- id: a
  content: |-
    $\begin{bmatrix}-\frac{11}{2} \\ -\frac{5}{2} \\ -4\end{bmatrix}$
- id: b
  content: |-
    $\begin{bmatrix}-\frac{13}{2} \\ -\frac{1}{2} \\ -4\end{bmatrix}$
- id: c
  content: |-
    $\begin{bmatrix}\frac{11}{2} \\ \frac{5}{2} \\ -4\end{bmatrix}$
- id: d
  content: |-
    $\begin{bmatrix}-\frac{17}{2} \\ -\frac{1}{2} \\ -4\end{bmatrix}$
- id: e
  content: |-
    $\begin{bmatrix}-\frac{15}{2} \\ -\frac{1}{3} \\ -4\end{bmatrix}$
```
