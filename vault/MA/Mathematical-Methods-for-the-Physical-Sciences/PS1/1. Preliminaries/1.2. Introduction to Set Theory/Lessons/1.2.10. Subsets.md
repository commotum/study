...
**Question 1:** Which set is a subset of $B = {1, 2, 4, 6, 8, 10}$?
...
**Question 2:** Which of the following sets is a subset of $A = {n^{2}∣n ∈ {1, 2, 3}}$?
...
**Question 4:** Find all of the subsets of $S = {p, q}$.
...
**Question 5:** Find all of the subsets of $T = {1, 2, 3}$.
