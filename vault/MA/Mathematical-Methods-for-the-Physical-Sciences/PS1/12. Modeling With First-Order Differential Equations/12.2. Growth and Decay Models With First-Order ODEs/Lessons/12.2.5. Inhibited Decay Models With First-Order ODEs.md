...
**Question 1:** Given that $y > 20$ and $t > 0$, which of the following is an inhibited decay equation?

- [ ] A. $\frac{dy}{dt} =-80(y - 20)$
- [ ] B. $\frac{dy}{dt} = 80(y + 20)$
- [ ] C. $\frac{dy}{dt} =-80y(20 - y)$
- [ ] D. $\frac{dy}{dt} = 80y(y + 20)$
- [ ] E. $\frac{dy}{dt} =-80(20 - y)$

---

**Question 2:** Given that $y > 40$ and $t > 0$, which of the following is an inhibited decay equation?

- [ ] A. $\frac{dy}{dt} = 800 + 20y$
- [ ] B. $\frac{dy}{dt} = 20y^{2} - 800$
- [ ] C. $\frac{dy}{dt} = 800 - 20y^{2}$
- [ ] D. $\frac{dy}{dt} = 800y - 20y^{2}$
- [ ] E. $\frac{dy}{dt} = 800 - 20y$

---

**Question 3:** Which of the following initial value problems is an inhibited decay problem?

- [ ] A. $\frac{dy}{dt} =-2(y - 500), y(0) = 600$
- [ ] B. $\frac{dy}{dt} =-2(y - 500), y(0) = 400$
- [ ] C. $\frac{dy}{dt} = 2(y - 500), y(0) = 600$
- [ ] D. $\frac{dy}{dt} = 2y(y - 500), y(0) = 600$
- [ ] E. $\frac{dy}{dt} =-2y(y - 500), y(0) = 400$
...
**Question 6:** The temperature $T(t)$, in degrees Celsius, of a cup of coffee can be modeled by the differential equation
