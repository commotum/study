...
**Question 1:** Given that $D = \frac{d^{2}}{dx^{2}} - 4\frac{d}{dx}$, what is $D(y)$ for $y = e^{4x}$?
...
**Question 2:** Given that $D = \frac{d^{3}}{dx^{3}} - 2\frac{d^{2}}{dx^{2}} + 2\frac{d}{dx}$, what is $D(y)$ for $y = e^{x} + x$?
...
**Question 3:** Given that $D = x\frac{d^{2}}{dx^{2}} + 2\frac{d}{dx}$, what is $D(y)$ for $y = \ln x$?
...
**Question 4:** Given that $D = x^{2}\frac{d^{3}}{dx^{3}} - x\frac{d^{2}}{dx^{2}} + \frac{d}{dx}$, what is $D(y)$ for $y = x^{3}$?
...
**Question 5:** If $D(y) = y\frac{d^{2}y}{dx^{2}} - xy\frac{dy}{dx} + 2y^{2}$, then $D(e^{2x}) =$
...
**Question 6:** If $D(y) = xy\frac{d^{3}y}{dx^{3}} + y\frac{dy}{dx} + 2y$, then $D(x^{3}) =$
...
**Question 7:** If $D(y) = y\frac{d^{3}y}{dx^{3}} - xy\frac{dy}{dx} + 2y$, then $D(\sin x) =$
