...
**Question 1:** Find the Laplace transform of $f(t) = e^{-2t} - e^{4t}$ for $s > 4$.
...
**Question 2:** Find the Laplace transform of $f(t) = 2 + 3e^{5t}$ for $s > 5$.
