...
- [Solving Second-Order ODEs Using Laplace Transforms](<9.2.3. Solving Second-Order ODEs Using Laplace Transforms.md>)
...
- [ ] A. $Y(s) = \frac{e^{-s}}{s^{2} - 6}$
- [ ] B. $Y(s) = (e^{-s})/(s(s - 3)^{2})$
- [ ] C. $Y(s) = \frac{2s + e^{-s}}{s^{2} - 3}$
- [ ] D. $Y(s) = (s + 3e^{-s})/(s(s^{2} - 6))$
- [ ] E. $Y(s) = (-s + e^{-s})/(s(s^{2} - 3))$

---

**Question 2:** Find the Laplace transform of $y(t)$, if
$y^{″} + y^{′} - 2y = u_{2}(t), y(0) = 0, y^{′}(0) = 1$,
where $u_{2}(t) = u(t - 2)$ is the unit step function.

- [ ] A. $Y(s) = (e^{-2s} + s)/((s + 2)^{2}(s - 1))$
- [ ] B. $Y(s) = (e^{-2s} + s)/(s(s + 2))$
- [ ] C. $Y(s) = (e^{-2s} + s)/(s(s + 2)(s - 1))$
- [ ] D. $Y(s) = (e^{-2s})/(s(s - 1)^{2})$
- [ ] E. $Y(s) = (e^{-2s})/((s + 2)(s - 1))$
...
**Question 3:** Find the Laplace transform $Y(s) = L{y(t)}$ if
$y^{″} + 9y = 5u_{4}(t)e^{3(t - 4)}, y(0) = 0, y^{′}(0) = 0$,
where $u_{4}(t) = u(t - 4)$ is the unit step function.

- [ ] A. $Y(s) = (5e^{-4s})/(s^{2}(s - 3))$
- [ ] B. $Y(s) = (5e^{-4s})/((s + 3)(s^{2} + 9))$
- [ ] C. $Y(s) = (e^{-4s})/((s - 3)(s^{2} + 9))$
- [ ] D. $Y(s) = (5e^{-4s})/((s - 3)(s^{2} + 9))$
- [ ] E. $Y(s) = \frac{5e^{-4s}}{s^{2} + 9}$

---

**Question 4:** Find the Laplace transform $Y(s) = L{y(t)}$ if
$y^{″} + 4y = 2u_{2}(t) \cdot (t - 2)^{3}, y(0) = 0, y^{′}(0) = 0$,
where $u_{2}(t) = u(t - 2)$ is the unit step function.

- [ ] A. $Y(s) = (6e^{-2s})/(s^{2}(s^{2} + 4))$
- [ ] B. $Y(s) = \frac{12e^{-2s}}{s^{2} + 4}$
- [ ] C. $Y(s) = (12e^{-2s})/(s(s^{2} + 4))$
- [ ] D. $Y(s) = (12e^{-2s})/(s^{4}(s^{2} + 4))$
- [ ] E. $Y(s) = (6e^{-2s})/(s^{2}(s^{4} + 4))$
