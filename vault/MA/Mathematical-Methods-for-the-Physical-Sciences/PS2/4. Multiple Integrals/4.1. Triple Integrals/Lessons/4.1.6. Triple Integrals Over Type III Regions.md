...
![](<../Source/4.1.6. Triple Integrals Over Type III Regions/Images/4ca6d9201c908c99395dc89d3e07c42b.png>)
...
![](<../Source/4.1.6. Triple Integrals Over Type III Regions/Images/9847e021198f35d3cc5029f4b01f5c12.png>)
...
![](<../Source/4.1.6. Triple Integrals Over Type III Regions/Images/9f54350de21e7008572d570755ea0a0b.png>)
...
![](<../Source/4.1.6. Triple Integrals Over Type III Regions/Images/6b616094dd63c84d3421f6a60ebfd54a.png>)
...
**Question 1:** Consider the type III region $R$, given by
$S = {(x, y, z): (x, z) ∈ D, 2x \le y \le x + z}$,
where $D$ is some finite region in the $xz$-plane. Then,
$∭_(S)f(x, y, z)dV =$

- [ ] A. $∫_{x + z}^{2x}[∬_(D)f(x, y, z)dA]dy$
- [ ] B. $∬_(D)[∫_{2x}^{x + z}f(x, y, z)dz]dA$
- [ ] C. $∫_{2x}^{x + z}[∬_(D)f(x, y, z)dA]dy$
- [ ] D. $∬_(D)[∫_{x + z}^{2x}f(x, y, z)dA]dy$
- [ ] E. $∬_(D)[∫_{2x}^{x + z}f(x, y, z)dy]dA$

---

**Question 2:** $∭_(S)f(x, y, z)dV = ∫_{∗}^{∗}∫_{a}^{b}∫_{∗}^{∗}f(x, y, z)dydzdx$
...
![](<../Source/4.1.6. Triple Integrals Over Type III Regions/Images/0049c315f956b65694eb3d93cfd89aeb.png>)
...
**Question 4:** $∬_(D)[∫_{x^{2}}^{4}6xdy]dA$,
...
![](<../Source/4.1.6. Triple Integrals Over Type III Regions/Images/aeb7a9800589495e7e5dac34dce55823.png>)
...
![](<../Source/4.1.6. Triple Integrals Over Type III Regions/Images/52cbbd44402aa96efd677c6849e17960.png>)

*Hint: All surfaces, except for the right one, are parallel to the corresponding coordinate planes.*

**Explanation**

![](<../Source/4.1.6. Triple Integrals Over Type III Regions/Images/75dd44f587bfca01c1e43dd033fc216d.png>)
...
![](<../Source/4.1.6. Triple Integrals Over Type III Regions/Images/8c33c91fefc6d1ab75b1cfc77aa64fa2.png>)
...
![](<../Source/4.1.6. Triple Integrals Over Type III Regions/Images/q-161480.png>)
...
![](<../Source/4.1.6. Triple Integrals Over Type III Regions/Images/q-40445.png>)

Given that $R$ is the type III region shown above,
$∭_(R)2zdV =$

- [ ] A. $∫_{0}^{2}∫_{0}^{4}4zdzdx$
- [ ] B. $∫_{0}^{2}∫_{0}^{2}4zdzdx$
- [ ] C. $∫_{0}^{2}∫_{0}^{\sqrt{4 - x^{2}}}4zdzdx$
- [ ] D. $∫_{0}^{\sqrt{4 - x^{2}}}∫_{0}^{2}z^{2}dzdx$
- [ ] E. $∫_{0}^{2}∫_{0}^{\sqrt{4 - x^{2}}}z^{2}dzdx$
