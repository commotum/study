...
- id: a
  content: |-
    $∬_(D)[∫_{xy^{2}}^{1 + 2x + y}f(x, y, z)dA]dx$
- id: b
  content: |-
    $∬_(D)[∫_{xy^{2}}^{1 + 2x + y}f(x, y, z)dy]dA$
- id: c
  content: |-
    $∬_(D)[∫_{xy^{2}}^{1 + 2x + y}f(x, y, z)dx]dA$
- id: d
  content: |-
    $∬_(D)[∫_{xy^{2}}^{1 + 2x + y}f(x, y, z)dz]dA$
- id: e
  content: |-
    $∫_{xy^{2}}^{1 + 2x + y}[∬_(D)f(x, y, z)dA]dz$
```
