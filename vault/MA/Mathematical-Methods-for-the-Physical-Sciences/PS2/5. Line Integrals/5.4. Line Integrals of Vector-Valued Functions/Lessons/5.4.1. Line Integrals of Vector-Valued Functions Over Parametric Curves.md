...
**Question 1:** Which of the following is equivalent to $∫_{C}F \cdot dr$ given that $F(x, y) = y^{2}i - x^{2}j$ and $C$ is the path $r(t) = ti + t^{2}j$ for $t ∈ [0, 1]$?

- [ ] A. $∫_{0}^{1}t^{4} - 2t^{3}dt$
- [ ] B. $∫_{0}^{1}4t^{3} - 3t^{2}dt$
- [ ] C. $∫_{0}^{1}t^{4} - 4t^{3}dt$
- [ ] D. $∫_{0}^{1}t^{2} - tdt$
- [ ] E. $∫_{0}^{1}1 - t^{2}dt$
...
**Question 2:** Which of the following is equivalent to $∫_{C}F \cdot dr$ given that $F(x, y) = yi - xj$ and $C$ is the path $r(t) = \cos ti + \sin tj$ for $t ∈ [0, π]$?
...
**Question 3:** Evaluate $∫_{C}F \cdot dr$ given that $F(x, y) = x^{2}yi + (x + 1)j$ and $C$ is the path $r(t) = 3ti + (2 + t)j$ for $t ∈ [0, 1]$.
...
**Question 4:** Evaluate $∫_{C}F \cdot dr$ given that $F(x, y) = e^{x}i + 2yj$ and $C$ is the path $r(t) = \ln ti + tj$ for $t ∈ [1, 2]$.
...
**Question 5:** Evaluate $∫_{C}F \cdot dr$ given that $F(x, y, z) = yzi + xzj + xyk$ and $C$ is the path $r(t) = ti + t^{2}j + t^{3}k$ for $t ∈ [0, 1]$.
...
**Question 6:** Evaluate $∫_{C}F \cdot dr$ given that $F(x, y, z) = xi + yj + zk$ and $C$ is the path $r(t) = \cos ti + \sin tj + 2\sqrt{t}k$ for $t ∈ [0, π]$.
