...
content: |-
  Let $f(x, y) = x^{3} + y$. Given that $C$ is the path along the curve $r(t) = ⟨3t, t^{3}⟩$ for $t ∈ [0, 1]$, evaluate $∫_{C}∇f \cdot dr$.
options:
- id: a
  content: |-
    $21$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Let $f(x, y, z) = x\sin y + y\cos z$. Given that $C$ is the path along the curve $r(t) = ⟨\sin t, t, 2t⟩$ for $t ∈ [0, \frac{π}{2}]$, evaluate $∫_{C}∇f \cdot dr$.
options:
- id: a
  content: |-
    $π + 1$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Let $f(x, y) = x^{2}y$. Given that $C$ is the path along the curve $y = \cos x + x^{3} - 2$ for $x ∈ [0, π]$, evaluate $∫_{C}∇f \cdot dr$.
options:
- id: a
  content: |-
    $π^{2}(π^{2} - 3)$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Let $f(x, y) = y^{2} - x^{2}$. Given that $C$ is the path along the curve $y^{2} = 4x$ for $y ∈ [0, 2\sqrt{2}]$, evaluate $∫_{C}∇f \cdot dr$.
options:
- id: a
  content: |-
    $8$
