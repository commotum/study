...
- [The Multivariable Chain Rule in Vector Form](<../../../../MVC/2. Multivariable Functions/2.5. The Multivariable Chain Rule/Lessons/2.5.3. The Multivariable Chain Rule in Vector Form.md>)
- [Lagrange Multipliers With One Constraint](<7.2.4. Lagrange Multipliers With One Constraint.md>)
- [Intersections of Lines and Planes With Surfaces](<../../../../MVC/2. Multivariable Functions/2.2. Quadric Surfaces and Cylinders/Lessons/2.2.6. Intersections of Lines and Planes With Surfaces.md>)
...
![](<../Source/7.2.5. Lagrange Multipliers With Multiple Constraints/Images/d2865657041d52ba80ab5056d09a7cfa.png>)
...
- [ ] A. $-2y$, $-4z$, and $3z^{2}$
- [ ] B. $-2yz$, $2x$, and $3z^{3}$
- [ ] C. $2xyz$, $-2z^{2}$, and $3z^{2}$
- [ ] D. $y^{2}z$, $-z^{2}$, and $3z^{2}$
- [ ] E. $2xyz$, $-4z$, and $9z^{2}$
...
**Question 3:** Use the method of Lagrange multipliers to find the minimum value of the function $f(x, y, z) = 2x - 2y + z$ on the intersection of the plane $x - y + z = 1$ and the cylinder $x^{2} + y^{2} = 2$.
...
**Question 4:** Use the method of Lagrange multipliers to find the maximum value of the function $f(x, y, z) = x + 2y - 6z$ on the intersection of the plane $2x - 3y + 2z = 0$ and the cylinder $x^{2} + y^{2} = 2$.
...
![](<../Source/7.2.5. Lagrange Multipliers With Multiple Constraints/Images/31ff5053e94fed552e5347d2b9948602.png>)
...
![](<../Source/7.2.5. Lagrange Multipliers With Multiple Constraints/Images/b7760c04c3a8e0c32042233da0996f73.png>)
...
![](<../Source/7.2.5. Lagrange Multipliers With Multiple Constraints/Images/e017039352f0d7c52d06be4b7e935d56.png>)
