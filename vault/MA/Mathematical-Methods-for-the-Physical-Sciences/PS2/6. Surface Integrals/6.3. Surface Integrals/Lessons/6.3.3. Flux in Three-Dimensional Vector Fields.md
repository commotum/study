...
- [Surface Integrals Over Cartesian Surfaces](<6.3.2. Surface Integrals Over Cartesian Surfaces.md>)
- [Flux in Two-Dimensional Vector Fields](<../../../5. Line Integrals/5.5. Circulation and Flux/Lessons/5.5.3. Flux in Two-Dimensional Vector Fields.md>)
...
![](<../Source/6.3.3. Flux in Three-Dimensional Vector Fields/Images/d0ac58663b7e555d37d7229aefad1b61.png>)
...
![](<../Source/6.3.3. Flux in Three-Dimensional Vector Fields/Images/58056eccdaad2e8c6dae70eeec2ecbf5.png>)
...
![](<../Source/6.3.3. Flux in Three-Dimensional Vector Fields/Images/863a0f4f50aff75d548f442023613b08.png>)
...
![](<../Source/6.3.3. Flux in Three-Dimensional Vector Fields/Images/5c21bead69939e5258200d46e5d45041.png>)
...
![](<../Source/6.3.3. Flux in Three-Dimensional Vector Fields/Images/cc9510a809bc946615d31fe3f4e2ba0b.png>)
...
![](<../Source/6.3.3. Flux in Three-Dimensional Vector Fields/Images/d059a376a3f6a12aea460953bbf34358.png>)
...
**Question 3:** Consider the vector field $F(x, y, z) = ⟨z, y, x⟩$ and the surface $S$ defined in Cartesian coordinates as $z = 1$ for $0 \le x \le 1$ and $0 \le y \le 1$. Calculate the flux of $F$ through $S$ with respect to the upward-pointing unit normal vector $n$.
...
**Question 4:** Consider the vector field $F(x, y, z) = ⟨x, y, z + 3⟩$ and a finite region $S$ of the plane $z = x + y$ such that $Area(S) = \sqrt{3}$. Calculate the flux of $F$ through $S$ with respect to the upward-pointing unit normal vector $n$.
