...
id: ma-108921
content: |-
  Let $A$ be a $m \cdot n$ matrix. What is the image of $R^{n}$ under the action of $A$?
options:
- id: a
  content: |-
    $R^{n}$
...
id: ma-108917
content: |-
  Let $A$ be a $m \cdot n$ matrix. What is the image of $Col(A)$ under the action of $A^{T}$?
options:
- id: a
  content: |-
    $Col(A^{T})$
...
id: ma-108790
content: |-
  Consider a $3 \cdot 4$ matrix $A$. If $dim(Null(A^{T})) = 2$, then $dim(Col(A)) =$
options:
- id: a
  content: |-
    $0$
...
id: ma-109847
content: |-
  Consider a $7 \cdot 5$ matrix $A$. If $dim(Col(A)) = 4$, then $dim(Null(A^{T})) =$
options:
- id: a
  content: |-
    $5$
