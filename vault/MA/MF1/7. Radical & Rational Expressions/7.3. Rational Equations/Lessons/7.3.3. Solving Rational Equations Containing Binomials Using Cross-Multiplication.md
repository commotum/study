...
**Question 3:** Solve for $y$ where $-\frac{3}{2y + 3} = \frac{2}{y}$.
...
**Question 5:** Solve for $x$ where $\frac{1}{x - 2} = \frac{2}{x + 4}$.
...
**Question 6:** Solve for $x$ where $-\frac{1}{2x + 6} = \frac{5}{x + 14}$.
