...
require_exact: true
content: |-
  A weight is measured as $20$ oz to the nearest $1$ oz.

  ==19.5== oz $\le w <$ ==20.5== oz.
```
...
require_exact: true
content: |-
  A volume is measured as $10.25$ mL to the nearest hundredth of a milliliter.

  ==10.245== mL $\le v <$ ==10.255== mL.
```
...
require_exact: true
content: |-
  A rectangular floor is measured as $12$ m by $3$ m, with each dimension measured to the nearest meter.

  To the nearest square meter, the smallest possible area is ==29== $\mathrm{m^2}$.
```
