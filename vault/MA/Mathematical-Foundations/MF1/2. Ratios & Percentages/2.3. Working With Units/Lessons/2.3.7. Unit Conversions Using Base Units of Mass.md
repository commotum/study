...
content: |-
  What is $8kg$ expressed in $g$? Write your answer as a whole number.
options:
- id: a
  content: |-
    $8000g$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  What is $1.25g$ expressed in $mg$? Write your answer as a whole number.
options:
- id: a
  content: |-
    $1250mg$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  What is $750g$ expressed in $kg$? Write your answer as a decimal in its simplest form.
options:
- id: a
  content: |-
    $0.75kg$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  What is $3600mg$ expressed in $g$? Write your answer as a decimal in its simplest form.
options:
- id: a
  content: |-
    $3.6g$
