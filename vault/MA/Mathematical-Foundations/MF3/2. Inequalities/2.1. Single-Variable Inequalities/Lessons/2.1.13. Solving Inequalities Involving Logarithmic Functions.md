...
content: |-
  Solve the inequality $2\ln (3x) + 4 \ge 0$.
options:
- id: a
  content: |-
    $x \ge \frac{1}{3e^{2}}$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Solve the inequality $10\log_{2} (x - 6) - 3 < 2$.
options:
- id: a
  content: |-
    $x > 6$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Solve the inequality $\ln (x + 2) - 5 \ge \ln (3x)$.
options:
- id: a
  content: |-
    $0 < x \le \frac{2}{3e^{5} - 1}$
- id: b
  content: |-
    $x \le \frac{2}{3e^{5} - 1}$
- id: c
...
- id: d
  content: |-
    $-\frac{2}{3e^{5} - 1} \le x \le 0$
- id: e
  content: |-
    $-\frac{2}{3e^{5} - 1} \le x \le \frac{2}{3e^{5} - 1}$
```
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Solve the inequality $\log_{3} (x + 4) + 2 < \log_{3} (5x)$.
options:
- id: a
  content: |-
    $-4 < x < 0$
