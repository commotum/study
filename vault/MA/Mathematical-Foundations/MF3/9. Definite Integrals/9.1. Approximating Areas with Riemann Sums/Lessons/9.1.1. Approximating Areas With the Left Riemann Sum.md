...
- If the function $f(x)$ is increasing, then the rectangles fall *below* the function, which means the left Riemann sum gives an *underestimate* of the actual area under the curve $y=f(x)$.
  ...
  ![](<../Source/9.1.1. Approximating Areas With the Left Riemann Sum/Images/05800258a79f954305aaa47c9479df31.png>)
...
- id: a
  content: |-
    ![](<../Source/9.1.1. Approximating Areas With the Left Riemann Sum/Images/q-49105-a-4.png>)
- id: b
  content: |-
    ![](<../Source/9.1.1. Approximating Areas With the Left Riemann Sum/Images/q-49105-a-1.png>)
  correct: true
- id: c
  content: |-
    ![](<../Source/9.1.1. Approximating Areas With the Left Riemann Sum/Images/q-49105-a-3.png>)
- id: d
  content: |-
    ![](<../Source/9.1.1. Approximating Areas With the Left Riemann Sum/Images/q-49105-a-2.png>)
- id: e
  content: |-
    ![](<../Source/9.1.1. Approximating Areas With the Left Riemann Sum/Images/q-49105-a-5.png>)
```
...
- id: a
  content: |-
    ![](<../Source/9.1.1. Approximating Areas With the Left Riemann Sum/Images/q-49109-a-5.png>)
- id: b
  content: |-
    ![](<../Source/9.1.1. Approximating Areas With the Left Riemann Sum/Images/q-49109-a-2.png>)
- id: c
  content: |-
    ![](<../Source/9.1.1. Approximating Areas With the Left Riemann Sum/Images/q-49109-a-4.png>)
- id: d
  content: |-
    ![](<../Source/9.1.1. Approximating Areas With the Left Riemann Sum/Images/q-49109-a-3.png>)
- id: e
  content: |-
    ![](<../Source/9.1.1. Approximating Areas With the Left Riemann Sum/Images/q-49109-a-1.png>)
  correct: true
```
