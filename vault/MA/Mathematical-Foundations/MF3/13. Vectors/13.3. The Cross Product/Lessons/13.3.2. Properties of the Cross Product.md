...
id: ma-19763
content: |-
  Find $(3a - 2b) \cdot c$, if $a \cdot c = 2i - 3j$ and $b \cdot c = 5i - 3j$.
options:
- id: a
  content: |-
    $-4i + 2j$
...
id: ma-19769
content: |-
  Find $(a - 2b) \cdot (4c)$, if $a \cdot c = ⟨3, 2, 0⟩$ and $b \cdot c = ⟨2, 3, 0⟩$.
options:
- id: a
  content: |-
    $⟨28, 32, 12⟩$
...
id: ma-127858
content: |-
  Find $(7a - 2b) \cdot b$, if $b \cdot a = ⟨2,-1, 6⟩$.
options:
- id: a
  content: |-
    $⟨28,-86,-14⟩$
...
id: ma-19775
content: |-
  Find $(5a - 3b) \cdot (6b)$, if $b \cdot a = ⟨1,-2, 3⟩$.
options:
- id: a
  content: |-
    $⟨ - 3, 6, 9⟩$
