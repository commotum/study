...
id: ma-98159
content: |-
  Find the principal $3$rd root of unity.
options:
- id: a
  content: |-
    $e^{π\textrm{i}/3}$
...
id: ma-97998
content: |-
  Find the principal $12$th root of unity.
options:
- id: a
  content: |-
    $e^{π\textrm{i}/12}$
...
- id: a
  content: |-
    ![](<../Source/6.2.4. The Roots of Unity/Images/q-162254-a-2.png>)
- id: b
  content: |-
    ![](<../Source/6.2.4. The Roots of Unity/Images/q-162254-a-3.png>)
- id: c
  content: |-
    ![](<../Source/6.2.4. The Roots of Unity/Images/q-162254-a-1.png>)
  correct: true
- id: d
  content: |-
    ![](<../Source/6.2.4. The Roots of Unity/Images/q-162254-a-5.png>)
- id: e
  content: |-
    ![](<../Source/6.2.4. The Roots of Unity/Images/q-162254-a-4.png>)
```
...
- id: a
  content: |-
    ![](<../Source/6.2.4. The Roots of Unity/Images/q-155461-a-4.png>)
- id: b
  content: |-
    ![](<../Source/6.2.4. The Roots of Unity/Images/q-155461-a-2.png>)
- id: c
  content: |-
    ![](<../Source/6.2.4. The Roots of Unity/Images/q-155461-a-5.png>)
- id: d
  content: |-
    ![](<../Source/6.2.4. The Roots of Unity/Images/q-155461-a-1.png>)
  correct: true
- id: e
  content: |-
    ![](<../Source/6.2.4. The Roots of Unity/Images/q-155461-a-3.png>)
```
