...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  If $P(x)$ and $Q(x)$ are polynomials of degree $3$ and $2$, respectively, what is the degree of $P \cdot Q$?
options:
- id: a
  content: |-
    $3$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  If $P(x)$ and $Q(x)$ are polynomials of degree $11$ and $4$, respectively, what is the degree of $P \cdot Q$?
options:
- id: a
  content: |-
    $44$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  If $P(x)$ and $Q(x)$ are polynomials of degree $6$ and $3$, respectively, what is the degree of $P + Q$?
options:
- id: a
  content: |-
    $2$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  If $P(x)$ and $Q(x)$ are polynomials of degree $8$, what is the **smallest possible** degree of $P - Q$?
options:
- id: a
  content: |-
    $8$
