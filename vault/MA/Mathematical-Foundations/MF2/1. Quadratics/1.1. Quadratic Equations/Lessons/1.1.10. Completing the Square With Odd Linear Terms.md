...
content: |-
  Rewrite the following expression as the difference of a perfect square and a constant: $(y^{2} + 13y + \frac{169}{4}) - 7$.
options:
- id: a
  content: |-
    $(y + \frac{13}{2})^{2} - 7$
