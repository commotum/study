...
require_exact: true
content: |-
  The monic quadratic with root sum $7$ and root product $12$ is ==x^2 - 7x + 12== $=0$.
```
...
require_exact: true
content: |-
  The quadratic with leading coefficient $3$, root sum $4$, and root product $-5$ is ==3x^2 - 12x - 15== $=0$.
```
