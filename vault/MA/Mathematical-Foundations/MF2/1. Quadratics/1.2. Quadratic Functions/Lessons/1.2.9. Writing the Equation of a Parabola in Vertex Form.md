...
content: |-
  What is the equation of the parabola $y = x^{2} + 4x + 3$ in vertex form?
options:
- id: a
  content: |-
    $y = (x + 2)^{2} - 1$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  What is the equation of the parabola $y = 5x^{2} - 10x + 15$ in vertex form?
options:
- id: a
  content: |-
    $y = 5(x - 1)^{2} + 10$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Write, in standard form, the equation of the parabola whose vertex is at $(3, 4)$ and whose leading coefficient is $1$.
options:
- id: a
  content: |-
    $y = x^{2} - 6x + 13$
