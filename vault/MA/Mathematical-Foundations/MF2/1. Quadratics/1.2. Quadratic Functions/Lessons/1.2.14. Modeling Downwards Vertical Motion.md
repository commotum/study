...
require_exact: true
content: |-
  An object is projected downward at $0.9$ km/min and hits the ground after $4$ s. Use $g=9.8\,\mathrm{m/s^2}$.

  The building is ==138.4== m high.
```
...
require_exact: true
content: |-
  An object is projected downward from $120$ m and hits the ground after $4$ s. Use $g=9.8\,\mathrm{m/s^2}$.

  Its initial speed was ==10.4== m/s.
```
...
require_exact: true
content: |-
  A kettlebell is projected downward from $1.2$ km and hits the ground after $15$ s. Use $g=9.8\,\mathrm{m/s^2}$.

  Its initial speed was ==6.5== m/s.
```
...
require_exact: true
content: |-
  An egg is projected downward from $39.2$ m at $3.43$ m/s. Use $g=9.8\,\mathrm{m/s^2}$.

  It hits the ground after ==2.5== s.
```
