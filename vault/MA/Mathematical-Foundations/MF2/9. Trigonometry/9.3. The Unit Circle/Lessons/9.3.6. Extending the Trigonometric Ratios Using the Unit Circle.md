...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  What is $\sin 175^{∘}$ expressed in terms of a reference angle?
options:
- id: a
  content: |-
    $\sin 355^{∘}$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  What is $\sin 320^{∘}$ expressed in terms of a reference angle?
options:
- id: a
  content: |-
    $\sin 40^{∘}$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  What is $\cos 300^{∘}$ expressed in terms of a reference angle?
options:
- id: a
  content: |-
    $-\cos 60^{∘}$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  What is $\cos 250^{∘}$ expressed in terms of a reference angle?
options:
- id: a
  content: |-
    $\cos 250^{∘}$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  What is $\tan 235^{∘}$ expressed in terms of a reference angle?
options:
- id: a
  content: |-
    $-\tan 125^{∘}$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  What is $\tan 325^{∘}$ expressed in terms of a reference angle?
options:
- id: a
  content: |-
    $-\tan 325^{∘}$
