...
**Question 1:** Find a Jordan canonical form of the matrix
...
- [ ] E. $\begin{bmatrix}-4 & 0 \\ 1 & 1\end{bmatrix}$

---

**Question 2:** Find a Jordan canonical form of the matrix
$A = \begin{bmatrix}5 & -2 \\ 1 & 8\end{bmatrix}$.

- [ ] A. $\begin{bmatrix}7 & 0 \\ 0 & 6\end{bmatrix}$
- [ ] B. $\begin{bmatrix}6 & 7 \\ 0 & 1\end{bmatrix}$
- [ ] C. $\begin{bmatrix}7 & 1 \\ 0 & 7\end{bmatrix}$
- [ ] D. $\begin{bmatrix}6 & 0 \\ 0 & 6\end{bmatrix}$
- [ ] E. $\begin{bmatrix}7 & 1 \\ 0 & 6\end{bmatrix}$
...
**Question 3:** Find the Jordan canonical form of the matrix
...
**Question 4:** Find the Jordan canonical form of the matrix
...
- [ ] E. $\begin{bmatrix}1 & -5 \\ 0 & 1\end{bmatrix}$
...
**Question 5:** Find the Jordan canonical form of the matrix
...
**Question 6:** Find the Jordan canonical form of the matrix
...
- [ ] E. $\begin{bmatrix}-3 & 1 \\ 0 & -3\end{bmatrix}$
