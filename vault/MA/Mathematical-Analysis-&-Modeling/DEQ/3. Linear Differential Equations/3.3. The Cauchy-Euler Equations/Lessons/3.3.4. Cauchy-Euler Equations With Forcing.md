...
- id: a
  content: |-
    $y(x) = c_{1}x + c_{2}x^{2} - 5x$
- id: b
  content: |-
    $y(x) = \frac{c_{1}}{x^{2}} + c_{2}x^{2} - 2x$
- id: c
  content: |-
    $y(x) = \frac{c_{1}}{x^{2}} + c_{2}x^{2} + 4x$
- id: d
  content: |-
    $y(x) = \frac{c_{1}}{x^{2}} + c_{2}x^{2} + 6x$
- id: e
  content: |-
    $y(x) = c_{1}x + c_{2}x^{2} + x$
```
...
- id: a
  content: |-
    $y(x) = \frac{c_{1}}{x} + c_{2}x + x^{3}$
- id: b
  content: |-
    $y(x) = c_{1}x + c_{2}x^{2} + x^{3}$
- id: c
  content: |-
    $y(x) = \frac{c_{1}}{x} + c_{2}x - 2x^{3}$
- id: d
  content: |-
    $y(x) = c_{1}x + c_{2}x^{2} + 4x^{3}$
- id: e
  content: |-
    $y(x) = c_{1}x + c_{2}x^{2} - 3x^{3}$
```
...
- id: b
  content: |-
    $y_{p}(t) = (t - 2 + \frac{2}{t})e^{t}$
- id: c
  content: |-
    $y_{p}(t) = (3t + 1)e^{t}$
- id: d
  content: |-
    $y_{p}(t) = (4t + \frac{1}{t})e^{t}$
- id: e
  content: |-
    $y_{p}(t) = (t^{2} - 1)e^{t}$
```
...
- id: b
  content: |-
    $y_{p}(x) =-\cos (\ln x) - 3\sin (\ln x)$
- id: c
  content: |-
    $y_{p}(x) = 2\cos (\ln x) + \sin (\ln x)$
- id: d
  content: |-
    $y_{p}(x) = 3\sin (\ln x)$
- id: e
