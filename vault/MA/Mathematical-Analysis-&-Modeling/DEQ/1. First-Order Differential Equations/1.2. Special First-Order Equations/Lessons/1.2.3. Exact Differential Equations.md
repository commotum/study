...
- [ ] A. $x^{2} - y^{3} = c$
- [ ] B. $xy - y^{3} = c$
- [ ] C. $2x^{2}y - \frac{y^{3}}{3} = c$
- [ ] D. $x^{2}y - \frac{y^{3}}{3} = c$
- [ ] E. $3x^{2} - y^{3} = c$
...
**Question 7:** Find the general solution of the differential equation
...
**Question 8:** Find the solution of the exact differential equation
$y^{′} = \frac{2 + ye^{xy}}{2y - xe^{xy}}$,
that satisfies the initial condition $y(0) = 1$.
