...
- [ ] C. I only
- [ ] D. II only
- [ ] E. None of the given equations is a Bernoulli differential equation
...
**Question 3:** The substitution $z = y^{m}$ for some integer $m$ transforms the differential equation
...
**Question 4:** The substitution $z = y^{m}$ for some real number $m$ transforms the differential equation
...
**Question 5:** Find the general solution to the differential equation
$\frac{dy}{dx} - y = y^{2}e^{x}$.

- [ ] A. $y = \frac{2xe^{x}}{C - 2e^{2x}}$
- [ ] B. $y = \frac{e^{x}}{C - 2e^{x}}$
- [ ] C. $y = \frac{2e^{x}}{C - e^{2x}}$
- [ ] D. $y = \frac{C - e^{2x}}{2e^{x}}$
- [ ] E. $y = \frac{C - e^{x}}{2e^{x}}$

---

**Question 6:** Find the general solution to the differential equation
$x^{2}\frac{dy}{dx} = y^{4} - xy$.

- [ ] A. $y = \sqrt[3]{\frac{2x^{3}}{C - 2x^{2}}}$
- [ ] B. $y = \frac{C + 3x^{2}}{x^{3}}$
- [ ] C. $y = \frac{C - 2x^{2}}{3x^{3}}$
- [ ] D. $y = (\frac{2 + x^{3}}{C + x^{2}})^{3}$
- [ ] E. $y = \sqrt[3]{\frac{x^{3}}{C - x^{2}}}$
