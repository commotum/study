...
- [Solving Linear Equations With Fractional Coefficients](<5.2.2. Solving Linear Equations With Fractional Coefficients.md>)
- [Applying the Distributive Law With Linear Expressions](<../../../4. Algebraic Expressions/4.2. Simplifying Linear Expressions/Lessons/4.2.3. Applying the Distributive Law With Linear Expressions.md>)
- [Solving Linear Equations With Decimal Coefficients](<5.2.3. Solving Linear Equations With Decimal Coefficients.md>)
