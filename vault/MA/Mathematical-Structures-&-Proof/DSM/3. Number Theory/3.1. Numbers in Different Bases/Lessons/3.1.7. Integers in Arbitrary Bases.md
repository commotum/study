...
**Question 2:** What is $(2101)_{3}$ written in base $10$?
...
**Question 3:** What is $(2 \cdot 3^{3} + 2 \cdot 3^{1} + 1)_{10}$ written in base $3$?
...
**Question 4:** What is $(3 \cdot 5^{4} + 4 \cdot 5^{2})_{10}$ written in base $5$?
...
**Question 6:** What is $(75)_{10}$ written in base $4$?
