...
- [ ] B. $G_{3}≅G_{4}$ only
- [ ] C. $G_{1}≅G_{3}$ only
- [ ] D. None of the trees are isomorphic to each other.
- [ ] E. $G_{1}≅G_{3}$ and $G_{2}≅G_{4}$
...
- [ ] A. $G_{1}≅G_{4}$ and $G_{2}≅G_{3}$
- [ ] B. None of the trees are isomorphic to each other.
- [ ] C. $G_{3}≅G_{4}$ only
...
**Question 4:** How many labeled trees are there on $12$ vertices?
...
**Question 6:** How many labeled rooted trees are there on $12$ vertices?
...
**Question 8:** How many labeled rooted forests are there on $12$ vertices?
