...
- id: a
  content: |-
    $a_{n} = A \cdot 3^{n} + B \cdot (-2)^{n} + 2x$
- id: b
  content: |-
    $a_{n} = A \cdot (-3)^{n} + B \cdot 2^{n} + 2$
- id: c
  content: |-
    $a_{n} = A \cdot (-3)^{n} + B \cdot 2^{n} - 1$
- id: d
  content: |-
    $a_{n} = A + B \cdot (-2)^{n} - 3x + 1$
- id: e
  content: |-
    $a_{n} = A \cdot 3^{n} + B \cdot (-2)^{n} + 2$
```
...
- id: a
  content: |-
    $a_{n} = A \cdot (-3)^{n} + Bn \cdot (-2)^{n} + 1 - 2n$
- id: b
  content: |-
    $a_{n} = A \cdot (-4)^{n} + Bn \cdot (-4)^{n} + n + 2$
- id: c
  content: |-
    $a_{n} = A \cdot (-4)^{n} + Bn \cdot (-4)^{n} + n + 4$
- id: d
  content: |-
    $a_{n} = A \cdot (-4)^{n} + Bn \cdot (-4)^{n} + 1$
- id: e
  content: |-
    $a_{n} = A \cdot (-4)^{n} + B \cdot (-2)^{n} + 2n + 3$
```
...
- id: a
  content: |-
    $a_{n} = 6 \cdot 2^{n} - 3 \cdot 3^{n} - 2$
- id: b
  content: |-
    $a_{n} =-2^{n} + 3 \cdot 3^{n} - 1$
- id: c
  content: |-
    $a_{n} = 3 \cdot 2^{n} - 3^{n} - 2$
- id: d
  content: |-
    $a_{n} = 5 \cdot 2^{n} - 3 \cdot 3^{n} - 1$
- id: e
  content: |-
    $a_{n} =-2 \cdot 2^{n} + 5 \cdot 3^{n} - 2$
```
...
- id: a
  content: |-
    $a_{n} =-3 \cdot (-2)^{n} + 4 \cdot 4^{n} - 2n - 1$
- id: b
  content: |-
    $a_{n} = 2 \cdot (-2)^{n} + 3 \cdot 4^{n} - 2n - 1$
- id: c
  content: |-
    $a_{n} = 2 \cdot (-2)^{n} + 2 \cdot 4^{n} - n - 3$
- id: d
  content: |-
    $a_{n} = 3 \cdot (-2)^{n} + 4^{n} - n - 3$
- id: e
  content: |-
    $a_{n} =-2 \cdot (-2)^{n} + 6 \cdot 4^{n} - n - 3$
```
