...
content: |-
  Consider the recurrence relation $a_{n} = 3a_{n - 1} + 4a_{n - 2}$. If $a_{n} = λ^{n}$ is a nonzero solution, then what are the possible values of $λ$?
options:
- id: a
  content: |-
    $-2$ or $-1$
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Consider the recurrence relation $a_{n} = 15a_{n - 2} - 2a_{n - 1}$. If $a_{n} = λ^{n}$ is a nonzero solution, then what are the possible values of $λ$?
options:
- id: a
  content: |-
    $-2$ or $5$
...
- id: b
  content: |-
    $a_{n} = A \cdot (-3)^{n} + B \cdot (-1)^{n}$
- id: c
  content: |-
    $a_{n} = A \cdot (-2)^{n} + B \cdot 4^{n}$
- id: d
  content: |-
    $a_{n} = A \cdot (-4)^{n} + B \cdot 2^{n}$
- id: e
  content: |-
    $a_{n} = A \cdot (-1)^{n} + B \cdot 3^{n}$
```
...
- id: b
  content: |-
    $a_{n} = A \cdot 8^{n} + B \cdot (-1)^{n}$
- id: c
  content: |-
    $a_{n} = A \cdot (-7)^{n} + B \cdot (-1)^{n}$
- id: d
  content: |-
    $a_{n} = A \cdot 7^{n} + B \cdot (-1)^{n}$
- id: e
