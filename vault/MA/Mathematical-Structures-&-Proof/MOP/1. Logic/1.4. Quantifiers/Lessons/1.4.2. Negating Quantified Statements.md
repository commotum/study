...
- id: b
  content: |-
    There exists $x ∈ R$ such that $x$ is positive.
- id: c
  content: |-
    For all $x ∈ R$, $x$ is not positive.
- id: d
  content: |-
    There exists $x ∈ R$ such that $x$ is not positive.
  correct: true
- id: e
  content: |-
    None of the listed
...
- id: c
  content: |-
    There exists $x ∈ Z$ such that $x \ge 4$.
- id: d
  content: |-
    For all $x ∈ Z$, $x < 4$.
- id: e
