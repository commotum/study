...
**Question 1:** Let $A = {-4,-2}$ and consider the relation "is not equal to" $(\ne)$ on $A$. Which of the following sets describes the relation?
...
**Question 2:** Let $A = {0, 1}$ and consider the relation "is greater than or equal to" $(\ge)$ on $A$. Which of the following sets describes the relation?
...
**Question 3:** Let $A = {1, 2, 3}$ and consider the relation "are congruent modulo $2$" on $A$. Write out $R$ as a set of ordered pairs.

- [ ] A. ${(1, 3), (2, 2), (3, 1)}$
- [ ] B. ${(1, 1), (2, 2), (3, 3)}$
- [ ] C. ${(1, 1), (1, 3), (2, 2), (3, 3)}$
- [ ] D. ${(1, 1), (1, 3), (2, 2), (3, 1), (3, 3)}$
- [ ] E. ${(1, 1), (1, 3), (3, 1), (3, 3)}$
...
- [ ] A. I, II, and III
- [ ] B. None of the ordered pairs are elements of the relation.
- [ ] C. I only
- [ ] D. II only
- [ ] E. I and II only
...
**Question 7:** Let $B = {1, 2, 3}$. Which set is equivalent to the following relation on $B$?
$R = {(x, y) ∈ B^{2}: x + y = 3}$
...
**Question 8:** Let $B = {-1, 0}$. Which set is equivalent to the following relation on $B$?
$R = {(x, y) ∈ B^{2}: xy \ge 0}$
