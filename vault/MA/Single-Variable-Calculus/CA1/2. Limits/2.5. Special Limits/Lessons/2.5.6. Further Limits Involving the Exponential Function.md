...
id: ma-118053
content: |-
  Evaluate $lim_(x → ∞)(1 + \frac{2}{x + 1})^{2x + 2}$.
options:
- id: a
  content: |-
    $\frac{1}{e^{2}}$
...
id: ma-118043
content: |-
  Evaluate $lim_(x → ∞)(\frac{x + 3}{x + 2})^{4x + 8}$.
options:
- id: a
  content: |-
    $e^{8}$
...
id: ma-118616
content: |-
  What is $lim_(y → 0)(1 - \sin y^{2})^{1/\sin y^{2}}$?
options:
- id: a
  content: |-
    $\frac{1}{e}$
