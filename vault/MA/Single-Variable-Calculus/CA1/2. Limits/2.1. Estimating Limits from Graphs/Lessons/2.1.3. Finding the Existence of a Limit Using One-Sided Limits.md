...
- [The Left and Right-Sided Limits of a Function](<2.1.2. The Left and Right-Sided Limits of a Function.md>)
...
![](<../Source/2.1.3. Finding the Existence of a Limit Using One-Sided Limits/Images/5633c1581be3cf554a210e0e5736d611.png>)
...
![](<../Source/2.1.3. Finding the Existence of a Limit Using One-Sided Limits/Images/c8b132237879e9590da52da233c11da9.png>)
...
![](<../Source/2.1.3. Finding the Existence of a Limit Using One-Sided Limits/Images/q-54404.png>)
...
![](<../Source/2.1.3. Finding the Existence of a Limit Using One-Sided Limits/Images/q-16604.png>)
...
![](<../Source/2.1.3. Finding the Existence of a Limit Using One-Sided Limits/Images/6bfb9a65af6c19f313aee04796643568.png>)
...
![](<../Source/2.1.3. Finding the Existence of a Limit Using One-Sided Limits/Images/q-16785.png>)

The function $y = f(x)$ is defined on $[MATH: x ∈ (- ∞,-1]∪[- \frac{1}{2}, \frac{1}{2}]∪[1, ∞).]$ Find $lim_(x → - 1)f(x)$.

- [ ] A. $lim_(x → - 1)f(x) =-1$
- [ ] B. $lim_(x → - 1)f(x) = 1$
- [ ] C. $lim_(x → - 1)f(x) = \frac{1}{4}$
- [ ] D. $lim_(x → - 1)f(x) = \frac{1}{2}$
- [ ] E. $lim_(x → - 1)f(x) = DNE$
...
![](<../Source/2.1.3. Finding the Existence of a Limit Using One-Sided Limits/Images/q-16784.png>)

The function $y = f(x)$ is defined on $[MATH: x ∈ (- ∞, \frac{1}{2}]∪(1, ∞).]$ Find $lim_(x → 1)f(x)$.

- [ ] A. $lim_(x → 1)f(x) = 0$
- [ ] B. $lim_(x → 1)f(x) = DNE$
- [ ] C. $lim_(x → 1)f(x) = \frac{1}{2}$
- [ ] D. $lim_(x → 1)f(x) = 1$
- [ ] E. $lim_(x → 1)f(x) = 2$
...
![](<../Source/2.1.3. Finding the Existence of a Limit Using One-Sided Limits/Images/65239b582d4f27c0e7d954e49afd4996.png>)
...
![](<../Source/2.1.3. Finding the Existence of a Limit Using One-Sided Limits/Images/q-34942.png>)
...
![](<../Source/2.1.3. Finding the Existence of a Limit Using One-Sided Limits/Images/q-47596.png>)
