...
**Question 1:** Calculate $L = lim_(n → ∞)\sqrt[n]{a_{n}}$ for the sequence $a_{n} = \frac{n^{2}}{10^{n}}$. Does $∑_(n = 1)^(∞)a_{n}$ converge or diverge?

- [ ] A. $L = \frac{1}{10}$. The series is convergent.
- [ ] B. $L = 0$. The series is convergent.
- [ ] C. $L = ∞$. The series is divergent.
- [ ] D. $L = \frac{1}{100}$. The series is convergent.
- [ ] E. $L = 10$. The series is divergent.

---

**Question 2:** Calculate $L = lim_(n → ∞)\sqrt[n]{a_{n}}$ for the sequence $a_{n} = (\frac{n}{3n + 1})^{2n}$. Does $∑_(n = 1)^(∞)a_{n}$ converge or diverge?

- [ ] A. $L = ∞$. The series is divergent.
- [ ] B. $L = \frac{1}{9}$. The series is convergent.
- [ ] C. $L = 2$. The series is divergent.
- [ ] D. $L = \frac{1}{6}$. The series is convergent.
- [ ] E. $L = \frac{1}{3}$. The series is convergent.
...
**Question 3:** Calculate $L = lim_(n → ∞)\sqrt[n]{a_{n}}$ for the sequence $a_{n} = \frac{5^{n}}{2^{n + 3}}$. According to the root test, does $∑_(n = 1)^(∞)a_{n}$ converge or diverge?

- [ ] A. $L = \frac{5}{2}$. The series is divergent.
- [ ] B. $L = 5$. The series is divergent.
- [ ] C. $L = 1$. The root test gives no conclusion.
- [ ] D. $L = \frac{2}{5}$. The series is convergent.
- [ ] E. $L = 2$. The series is divergent.

---

**Question 4:** Calculate $L = lim_(n → ∞)\sqrt[n]{a_{n}}$ for the sequence $a_{n} = (2^{n}n^{n})/((1 + 2n)^{n})$. According to the root test, does $∑_(n = 1)^(∞)a_{n}$ converge or diverge?

- [ ] A. $L = 0$. The root test gives no conclusion.
- [ ] B. $L = 1$. The root test gives no conclusion.
- [ ] C. $L = ∞$. The series is divergent.
- [ ] D. $L = 2$. The series is divergent.
