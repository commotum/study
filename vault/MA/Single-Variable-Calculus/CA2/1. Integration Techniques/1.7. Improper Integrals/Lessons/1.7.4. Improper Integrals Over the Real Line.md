...
- [Improper Integrals Involving Exponential Functions](<1.7.2. Improper Integrals Involving Exponential Functions.md>)
- [Improper Integrals Involving Arctangent](<1.7.3. Improper Integrals Involving Arctangent.md>)
...
**Question 3:** Evaluate $∫_{- ∞}^{∞}\frac{1}{4 + x^{2}}dx$.
...
**Question 4:** Evaluate the integral $∫_{- ∞}^{∞}(6x^{5})/((3 + x^{6})^{2})dx$.
...
![](<../Source/1.7.4. Improper Integrals Over the Real Line/Images/12de9a29b2f0e4eaad17166bc9fc3b49.png>)
...
![](<../Source/1.7.4. Improper Integrals Over the Real Line/Images/q-81168.png>)
...
**Question 6:** Find the total area of the region bounded by the graph of the curve $y = \mid x \mid e^{-x^{2}}$ and the $x$-axis.
