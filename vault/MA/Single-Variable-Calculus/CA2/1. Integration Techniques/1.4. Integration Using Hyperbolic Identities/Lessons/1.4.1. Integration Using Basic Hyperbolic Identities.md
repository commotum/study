...
**Question 1:** Find a hyperbolic identity that corresponds to the trigonometric identity $\sin 2x = 2\sin x\cos x$.

- [ ] A. $\sinh 2x =-2\sinh x\cosh x$
- [ ] B. $\sinh 2x = \frac{1}{2}\sinh x\cosh x$
- [ ] C. $\sinh 2x = 2\sinh x\cosh x$
- [ ] D. $\sinh 2x = \sinh^{2} x + \cosh^{2} x$
- [ ] E. $\sinh 2x = \sinh^{2} x - \cosh^{2} x$

---

**Question 2:** Find a hyperbolic identity that corresponds to the trigonometric identity $\cos^{2} x + \sin^{2} x = 1$.

- [ ] A. $\cosh^{2} x - \sinh^{2} x =-1$
- [ ] B. $\cosh^{2} x + \sinh^{2} x =-1$
- [ ] C. $\cosh^{2} x + \sinh^{2} x = e$
...
**Question 3:** What is $∫sech x(\tanh x - 2\cosh x)dx$?
...
**Question 4:** Evaluate $∫_{0}^{\ln 2}\tanh x\cosh xdx$.
...
**Question 5:** What is $∫\frac{\tanh x + 2}{sech x}dx$?
...
**Question 6:** Evaluate $∫_{1/2}^{1}\frac{\coth^{2} x}{2\cosh^{2} x}dx$.
...
**Question 7:** What is $∫\frac{\coth x}{\sinh x}dx$?
...
**Question 8:** Evaluate $∫_{0}^{\ln 3}\frac{\tanh x}{sech^{2} x}dx$.
