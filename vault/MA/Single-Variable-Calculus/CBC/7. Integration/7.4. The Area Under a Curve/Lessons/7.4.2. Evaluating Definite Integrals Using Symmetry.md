...
![](<../Source/7.4.2. Evaluating Definite Integrals Using Symmetry/Images/62876bfb7051e069076a858b87da0f43.png>)
...
![](<../Source/7.4.2. Evaluating Definite Integrals Using Symmetry/Images/b224f670a11fef72c4312785b7530be4.png>)
...
![](<../Source/7.4.2. Evaluating Definite Integrals Using Symmetry/Images/240d86909090a7a6a32b301766952cfa.png>)
...
![](<../Source/7.4.2. Evaluating Definite Integrals Using Symmetry/Images/2ac173366c86de65c4992408fae10f5a.png>)

- $\sin x$ is an odd function:
$\sin(-x) = -\sin x$
This function has rotational symmetry of order $2$ about the origin.

![](<../Source/7.4.2. Evaluating Definite Integrals Using Symmetry/Images/e69604136ce2de58a8509a2de711721c.png>)

- $\tan x$ is an odd function:
$\tan(-x) = -\tan x$
This function has rotational symmetry of order $2$ about the origin.

![](<../Source/7.4.2. Evaluating Definite Integrals Using Symmetry/Images/79b8293e13131ee488c09354194b9d06.png>)
...
**Question 1:** Simplify the integral $∫_{-7}^{7}3x^{6}dx$ using symmetry.
...
**Question 2:** What is $∫_{-3}^{3}x^{2}\cos (5x)dx$?

- [ ] A. $∫_{0}^{3}x^{2}\cos (5x)dx$
- [ ] B. $- ∫_{0}^{3}x^{2}\cos (5x)dx$
- [ ] C. $0$
- [ ] D. $\frac{1}{2}∫_{0}^{3}x^{2}\cos (5x)dx$
- [ ] E. $2∫_{0}^{3}x^{2}\cos (5x)dx$
...
![](<../Source/7.4.2. Evaluating Definite Integrals Using Symmetry/Images/a299dc1f11088a3de4f0f84f009a4fb5.png>)
...
**Question 5:** Simplify the integral $∫_{-6}^{6}x^{5}dx$ using symmetry.
...
**Question 6:** Given that $∫_{-1}^{0}x^{4}\tan xdx = A$, what is the value of $∫_{0}^{1}x^{4}\tan xdx$?
