...
![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/b923340927f80192d4432c9e4a6d659c.png>)

We can *approximate* the area using, for instance, the area of three rectangles, each with a width equal to $1$.

![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/f9d2c3158eb9a2d8d20544aab131091f.png>)
...
![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/01bbea4655115ee6aea7c1844960a765.png>)
...
![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/c7701da672e6421f8810995b994704fd.png>)
...
- If the function $f(x)$ is increasing, then the rectangles fall *below* the function, which means the left Riemann sum gives an *underestimate* of the actual area under the curve $y=f(x)$.
  ...
  ![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/05800258a79f954305aaa47c9479df31.png>)
...
![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/85a6d9e1be51f841426a88bd38173231.png>)
...
![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/459d4d66604c1019364f30a348f52d87.png>)
...
- id: a
  content: |-
    ![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/q-49105-a-4.png>)
- id: b
  content: |-
    ![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/q-49105-a-1.png>)
  correct: true
- id: c
  content: |-
    ![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/q-49105-a-3.png>)
- id: d
  content: |-
    ![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/q-49105-a-2.png>)
- id: e
  content: |-
    ![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/q-49105-a-5.png>)
```
...
- id: a
  content: |-
    ![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/q-49109-a-5.png>)
- id: b
  content: |-
    ![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/q-49109-a-2.png>)
- id: c
  content: |-
    ![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/q-49109-a-4.png>)
- id: d
  content: |-
    ![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/q-49109-a-3.png>)
- id: e
  content: |-
    ![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/q-49109-a-1.png>)
  correct: true
```
...
![](<../Source/7.2.1. Approximating Areas With the Left Riemann Sum/Images/0415c229ccd591643da24a7acbe5823c.png>)
