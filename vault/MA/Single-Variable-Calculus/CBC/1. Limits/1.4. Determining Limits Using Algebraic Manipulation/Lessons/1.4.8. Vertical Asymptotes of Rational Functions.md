...
![](<../Source/1.4.8. Vertical Asymptotes of Rational Functions/Images/8e1e41f93fe7b66e08c20400aa5924c7.png>)
...
$$
\begin{aligned}
\frac{x^{2} + x - 6}{x^{2} - 5x + 6} &= \frac{(x - 2)(x + 3)}{(x - 2)(x - 3)} \\
...
$$
\begin{aligned}
\frac{x^{2} + x}{2x + 2} &= \frac{x(x + 1)}{2(x + 1)} \\
&= \frac{x(x + 1)}{2(x + 1)} \\
&= \frac{x}{2}
\end{aligned}
$$
...
![](<../Source/1.4.8. Vertical Asymptotes of Rational Functions/Images/b88f58b484a9741d1c21581309c5a6c4.png>)
...
id: ma-4631
content: |-
  Find the vertical asymptotes of $f(x) = \frac{(x - 1)(x^{3} + 1)}{x^{2} - 1}$.
options:
- id: a
  content: |-
    No vertical asymptotes
