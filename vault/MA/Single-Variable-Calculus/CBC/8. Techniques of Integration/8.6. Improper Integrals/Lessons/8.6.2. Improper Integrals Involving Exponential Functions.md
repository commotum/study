...
![](<../Source/8.6.2. Improper Integrals Involving Exponential Functions/Images/2a1caaac52eba4edfa1349a021c2021d.png>)
...
![](<../Source/8.6.2. Improper Integrals Involving Exponential Functions/Images/121e8b397fd3d1ba5e806dfe5ca38245.png>)
...
**Question 1:** What is $∫_{- ∞}^{-1}2e^{x}dx$?
...
**Question 2:** What is $∫_{1}^{∞}e^{-2x}dx$?
...
![](<../Source/8.6.2. Improper Integrals Involving Exponential Functions/Images/e9da045e68ed322bd54138b5cd02b995.png>)
...
**Question 4:** What is $∫_{- ∞}^{0}5^{x/2}dx$?
...
![](<../Source/8.6.2. Improper Integrals Involving Exponential Functions/Images/769170756b4db689d820f57e3f8d9791.png>)
...
**Question 5:** Evaluate the integral $∫_{0}^{∞}\frac{e^{-\sqrt{2x}}}{\sqrt{x}}dx$.
...
**Question 6:** What is $∫_{- ∞}^{0}x^{2} \cdot 2^{x^{3}}dx$?
