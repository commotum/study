...
- [Sketching the Derivative of a Function From the Function's Graph](<6.2.1. Sketching the Derivative of a Function From the Function's Graph.md>)
...
![](<../Source/6.2.2. Interpreting the Graph of a Function's Derivative/Images/328c4d6691648c740789a4955e9649f3.png>)
...
![](<../Source/6.2.2. Interpreting the Graph of a Function's Derivative/Images/21a4b398840f1a1c023bb6a4f6be940d.png>)
...
![](<../Source/6.2.2. Interpreting the Graph of a Function's Derivative/Images/563c18d94ba3384f2aa7c230663efb75.png>)
...
content: |-
  ![](<../Source/6.2.2. Interpreting the Graph of a Function's Derivative/Images/q-30681.png>)
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  ![](<../Source/6.2.2. Interpreting the Graph of a Function's Derivative/Images/q-5215.png>)
...
- $f(x)$ has a relative maximum at $x=a$ if $f'(x)$ changes its sign from *positive* to *negative* around $x=a$.![](<../Source/6.2.2. Interpreting the Graph of a Function's Derivative/Images/cd5ea6cac13140964f716a24613346a6.png>)

- $f(x)$ has a relative minimum at $x=a$ if $f'(x)$ changes its sign from *negative* to *positive* around $x=a$.![](<../Source/6.2.2. Interpreting the Graph of a Function's Derivative/Images/41cdbeff0f98192f70a09364ce697ae3.png>)
...
![](<../Source/6.2.2. Interpreting the Graph of a Function's Derivative/Images/58b8a232e3b2fbfe54f6e426371204d7.png>)
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  ![](<../Source/6.2.2. Interpreting the Graph of a Function's Derivative/Images/q-5223.png>)
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  ![](<../Source/6.2.2. Interpreting the Graph of a Function's Derivative/Images/q-30678.png>)
...
![](<../Source/6.2.2. Interpreting the Graph of a Function's Derivative/Images/f7bcd852222b85761d5db669bc2c4b57.png>)
...
![](<../Source/6.2.2. Interpreting the Graph of a Function's Derivative/Images/441459626f4e25fe66cdba20d33d4fcb.png>)
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  ![](<../Source/6.2.2. Interpreting the Graph of a Function's Derivative/Images/q-30675.png>)
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  ![](<../Source/6.2.2. Interpreting the Graph of a Function's Derivative/Images/q-30594.png>)
