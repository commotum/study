...
- id: a
  content: |-
    ![](<../Source/6.2.2. Approximating Areas With the Right Riemann Sum/Images/q-49117-a-3.png>)
- id: b
  content: |-
    ![](<../Source/6.2.2. Approximating Areas With the Right Riemann Sum/Images/q-49117-a-5.png>)
- id: c
  content: |-
    ![](<../Source/6.2.2. Approximating Areas With the Right Riemann Sum/Images/q-49117-a-4.png>)
- id: d
  content: |-
    ![](<../Source/6.2.2. Approximating Areas With the Right Riemann Sum/Images/q-49117-a-1.png>)
  correct: true
- id: e
  content: |-
    ![](<../Source/6.2.2. Approximating Areas With the Right Riemann Sum/Images/q-49117-a-2.png>)
```
...
- id: a
  content: |-
    ![](<../Source/6.2.2. Approximating Areas With the Right Riemann Sum/Images/q-49120-a-2.png>)
- id: b
  content: |-
    ![](<../Source/6.2.2. Approximating Areas With the Right Riemann Sum/Images/q-49120-a-3.png>)
- id: c
  content: |-
    ![](<../Source/6.2.2. Approximating Areas With the Right Riemann Sum/Images/q-49120-a-1.png>)
  correct: true
- id: d
  content: |-
    ![](<../Source/6.2.2. Approximating Areas With the Right Riemann Sum/Images/q-49120-a-4.png>)
- id: e
  content: |-
    ![](<../Source/6.2.2. Approximating Areas With the Right Riemann Sum/Images/q-49120-a-5.png>)
```
