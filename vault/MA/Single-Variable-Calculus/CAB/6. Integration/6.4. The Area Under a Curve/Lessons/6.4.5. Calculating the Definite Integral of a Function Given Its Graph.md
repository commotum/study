...
![](<../Source/6.4.5. Calculating the Definite Integral of a Function Given Its Graph/Images/11e34fd87d7c70132a2719d0983e1f84.png>)
...
![](<../Source/6.4.5. Calculating the Definite Integral of a Function Given Its Graph/Images/4e667270304346790dc6d0a5fe41544c.png>)
...
![](<../Source/6.4.5. Calculating the Definite Integral of a Function Given Its Graph/Images/9945bb9e16c42b2c41ed53b402e96364.png>)
...
content: |-
  ![](<../Source/6.4.5. Calculating the Definite Integral of a Function Given Its Graph/Images/q-14783.png>)
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  ![](<../Source/6.4.5. Calculating the Definite Integral of a Function Given Its Graph/Images/q-75314.png>)
...
![](<../Source/6.4.5. Calculating the Definite Integral of a Function Given Its Graph/Images/534b5191e3f9f6465bd3917abb9ec5f0.png>)
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  ![](<../Source/6.4.5. Calculating the Definite Integral of a Function Given Its Graph/Images/q-17996.png>)
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  ![](<../Source/6.4.5. Calculating the Definite Integral of a Function Given Its Graph/Images/q-51422.png>)
