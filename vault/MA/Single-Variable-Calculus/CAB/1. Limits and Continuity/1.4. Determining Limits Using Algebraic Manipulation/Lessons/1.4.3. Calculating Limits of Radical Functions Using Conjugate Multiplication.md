...
**Question 1:** Evaluate $lim_(x → 0)\frac{\sqrt{x + 4} - 2}{x}$.
...
**Question 2:** Evaluate $lim_(x → 4)\frac{\sqrt{x} - 2}{x - 4}$.
...
**Question 3:** Evaluate $lim_(x → 1^{-})\frac{x - 1}{\sqrt{x + 3} - 2}$.
...
**Question 4:** Evaluate $lim_(x → 1^{+})\frac{1 - x^{2}}{1 - \sqrt{x}}$.
