...
![](<../Source/5.1.12. Piecewise Functions/Images/3ec3909ca0441a873e1289e20fc7d3ea.png>)
...
![](<../Source/5.1.12. Piecewise Functions/Images/b3579687b947e6c3f02b536a294ed366.png>)
...
- id: a
  content: |-
    ![](<../Source/5.1.12. Piecewise Functions/Images/q-46318-a-3.png>)
- id: b
  content: |-
    ![](<../Source/5.1.12. Piecewise Functions/Images/q-46318-a-4.png>)
- id: c
  content: |-
    ![](<../Source/5.1.12. Piecewise Functions/Images/q-46318-a-1.png>)
- id: d
  content: |-
    ![](<../Source/5.1.12. Piecewise Functions/Images/q-46318-a-2.png>)
- id: e
  content: |-
    ![](<../Source/5.1.12. Piecewise Functions/Images/q-46318-a-5.png>)
```
...
- id: a
  content: |-
    ![](<../Source/5.1.12. Piecewise Functions/Images/q-46887-a-2.png>)
- id: b
  content: |-
    ![](<../Source/5.1.12. Piecewise Functions/Images/q-46887-a-5.png>)
- id: c
  content: |-
    ![](<../Source/5.1.12. Piecewise Functions/Images/q-46887-a-3.png>)
- id: d
  content: |-
    ![](<../Source/5.1.12. Piecewise Functions/Images/q-46887-a-4.png>)
- id: e
  content: |-
    ![](<../Source/5.1.12. Piecewise Functions/Images/q-46887-a-1.png>)
```
...
![](<../Source/5.1.12. Piecewise Functions/Images/a8f5c97b849c224eef3cbcf0cb61b55b.png>)
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  ![](<../Source/5.1.12. Piecewise Functions/Images/q-34540.png>)
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  ![](<../Source/5.1.12. Piecewise Functions/Images/q-19304.png>)
...
![](<../Source/5.1.12. Piecewise Functions/Images/ed6823064c5202df8080ced29cdd2f96.png>)
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  ![](<../Source/5.1.12. Piecewise Functions/Images/q-34605.png>)
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  ![](<../Source/5.1.12. Piecewise Functions/Images/q-34612.png>)
