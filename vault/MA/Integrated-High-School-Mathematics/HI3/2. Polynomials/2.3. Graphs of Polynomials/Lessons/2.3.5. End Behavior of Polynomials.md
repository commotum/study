...
- [Graphing Cubic Curves Containing One Distinct Real Root](<2.3.4. Graphing Cubic Curves Containing One Distinct Real Root.md>)
...
![](<../Source/2.3.5. End Behavior of Polynomials/Images/70537aae3960cfea4bf624db072f1b26.png>)
...
| --- | ---: | ---: | ---: | ---: |
| Even | $>0$ | $f(x) \rightarrow +\infty$ | $f(x) \rightarrow +\infty$ | ![](<../Source/2.3.5. End Behavior of Polynomials/Images/be48b005ae369bb6ea318a83b5c3a7a0.png>) |
| $<0$ | $f(x) \rightarrow -\infty$ | $f(x) \rightarrow -\infty$ | ![](<../Source/2.3.5. End Behavior of Polynomials/Images/665d7a021810e5a90a876bcc73db961c.png>) |  |
| Odd | $>0$ | $f(x) \rightarrow -\infty$ | $f(x) \rightarrow +\infty$ | ![](<../Source/2.3.5. End Behavior of Polynomials/Images/aeb01a81b0f38ed49332612a2e637d13.png>) |
| $<0$ | $f(x) \rightarrow +\infty$ | $f(x) \rightarrow -\infty$ | ![](<../Source/2.3.5. End Behavior of Polynomials/Images/8e989e16447613a1647c0b1cdd4d2f9b.png>) |  |
...
![](<../Source/2.3.5. End Behavior of Polynomials/Images/406c751f6da68203b0244bc247f45bf0.png>)
...
![](<../Source/2.3.5. End Behavior of Polynomials/Images/q-38586.png>)
...
![](<../Source/2.3.5. End Behavior of Polynomials/Images/q-38611.png>)
...
![](<../Source/2.3.5. End Behavior of Polynomials/Images/3d8aad2c552ec02fb6ff1d648981e0ad.png>)
...
![](<../Source/2.3.5. End Behavior of Polynomials/Images/q-38624.png>)
...
![](<../Source/2.3.5. End Behavior of Polynomials/Images/q-38577.png>)
...
![](<../Source/2.3.5. End Behavior of Polynomials/Images/99486ce0777e1af063fed9015c9cf382.png>)
...
![](<../Source/2.3.5. End Behavior of Polynomials/Images/q-38617.png>)
...
![](<../Source/2.3.5. End Behavior of Polynomials/Images/q-38585.png>)
