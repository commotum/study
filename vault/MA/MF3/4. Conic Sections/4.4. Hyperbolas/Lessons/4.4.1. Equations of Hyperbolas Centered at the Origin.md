...
content: |-
  Write the equation of the hyperbola $9x^{2} - 4y^{2} = 36$ in standard form.
options:
- id: a
  content: |-
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Write the equation of the hyperbola $4x^{2} - 25y^{2} = 100$ in standard form.
options:
- id: a
  content: |-
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Write the equation of the hyperbola $4y^{2} - x^{2} = 20$ in standard form.
options:
- id: a
  content: |-
    $\frac{y^{2}}{10} - \frac{x^{2}}{20} = 1$
- id: b
  content: |-
...
# MA_ANSWER_MISSING: set exactly one options[].correct=true for radio, or all correct options for checkbox
content: |-
  Write the equation of the hyperbola $y^{2} - 4x^{2} = 12$ in standard form.
options:
- id: a
  content: |-
