...
- [ ] A. $1 + 2t + \frac{9}{5}t^{2} + \cdots$
- [ ] B. $1 + 2t + \frac{9}{25}t^{2} + \cdots$
- [ ] C. $1 + 10t + \frac{9}{5}t^{2} + \cdots$
- [ ] D. $1 + \frac{t}{2} + \frac{9}{5}t^{2} + \cdots$
- [ ] E. $1 + 2t + \frac{5}{9}t^{2} + \cdots$
...
- [ ] A. $1 - 48t + 960t^{2} + \cdots$
- [ ] B. $1 + 48t + 960t^{2} + \cdots$
- [ ] C. $1 - 48t + 384t^{2} + \cdots$
- [ ] D. $1 - 8t + 960t^{2} + \cdots$
- [ ] E. $1 - 48t - 960t^{2} + \cdots$
