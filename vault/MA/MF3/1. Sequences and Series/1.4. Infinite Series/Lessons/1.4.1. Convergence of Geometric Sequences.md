...
![](<../Source/1.4.1. Convergence of Geometric Sequences/Images/67a6cc016cc67914bfcdb28a0d701876.png>)
...
![](<../Source/1.4.1. Convergence of Geometric Sequences/Images/28841e40589df1e4f788d8fc8668d45e.png>)
...
- When $r=1$, the geometric sequence is convergent and converges to the first term. For example, consider the sequence $c_n = 2(1)^n$, shown below:![](<../Source/1.4.1. Convergence of Geometric Sequences/Images/712855d39b893cdd59776feaec8e5f41.png>)
In this case, the sequence is convergent, and the limit of the sequence is $c_1 = 2$.

- When $r=-1$, the geometric sequence is divergent. For example, consider the sequence $d_n = 2(-1)^n$, shown below:![](<../Source/1.4.1. Convergence of Geometric Sequences/Images/93255f2ccd375ec6c7db1c5864e08f42.png>)
