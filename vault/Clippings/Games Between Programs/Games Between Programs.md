...
source: "https://writings.stephenwolfram.com/2026/06/games-between-programs-the-ruliology-of-competition/"
author:
  - "[[Stephen Wolfram]]"
published: 2026-06-04
created: 2026-07-26
description: "Stephen Wolfram applies ruliological methods to competition, considering all possibilities in looking for a winning strategy. Does competition lead to complexity or simplicity?"
tags:
  - "clippings"
---
Contents
...
To be more specific about the setup, let’s assume that at each step, each agent takes one of two possible actions, indicated by and. And for now let’s take the payoffs to be the ones for the classic [“match-or-not” (“matching pennies”)](https://www.wolframscience.com/nks/notes-10-12--game-theory/) game—in which player 1 has the bigger payoff when there’s a match, and player 2 has the bigger payoff when there isn’t a match:

![[Images/sw05292026setupimg1.png]]
...
![[Images/sw05292026setupimg6.png]]
...
![[Images/sw05292026strategiesimg1.png]]
...
![[Images/sw05292026strategiesimg3.png]]

At the end of this process we’ll reach some vertex in the graph (i.e. some state in the finite state machine). In the particular case shown here, the state we reach is. And then we take the output of the strategy—i.e. the next action for the agent to take—to be.

It’s sometimes convenient to show the states of the finite state machine arranged on a line:

![[Images/sw05292026strategiesimg4.png]]

And then we can summarize the path taken with a certain input by showing the successive states reached:

![[Images/sw05292026strategiesimg5.png]]
...
The number of possible graphs for finite state machines with *s* states is (2 *s* <sup>2</sup>) <sup><i>s</i></sup>. But some of those graphs correspond to machines with identical behavior—so that the number of distinct machines is smaller:

![[Images/sw06032026spaceimg1B.png]]

### 2-State Machines

In the 2-state case, the 22 distinct machines are

![[Images/sw06012026spaceimg3.png]]
...
![[Images/sw06012026spaceimg4.png]]
...
![[Images/sw06012026spaceimg5.png]]
...
![[Images/sw06012026spaceimg12.png]]
...
![[Images/sw06012026spaceimg22.png]]
...
![[Images/sw06012026spaceimg23.png]]
...
![[Images/sw05292026complexityimg1.png]]
...
We can get some sense of this complexity by [looking at the compressed size](https://writings.stephenwolfram.com/2025/11/whats-special-about-life-bulk-orchestration-and-the-rulial-ensemble-in-biology-and-beyond/#measuring-mechanoidal-behavior) (as obtained from [Compress](https://reference.wolfram.com/language/ref/Compress.html)) of the array of behavior shown above:

![[Images/sw05292026complexityimg2.png]]
...
![[Images/sw05292026complexityimg3.png]]
...
![[Images/sw05292026complexityimg4.png]]

with the “behavior traces” of the machines indicated being

![[Images/sw05292026complexityimg5.png]]

and

![[Images/sw05292026complexityimg6.png]]
...
![[Images/sw06012026competitionsimg1B.png]]
...
![[Images/sw06012026competitionsimg2.png]]
...
![[Images/sw06012026evolutionimg1.png]]

or, with a different graph rendering:

![[Images/sw06012026evolutionimg2.png]]
...
![[Images/sw06012026evolutionimg3.png]]
...
![[Images/sw06012026evolutionimg4.png]]

which “loses” (always having payoff –1) against machine 1165:

![[Images/sw06012026evolutionimg5.png]]
...
![[Images/sw06012026evolutionimg8.png]]
...
![[Images/sw06012026evolutionimg9.png]]
...
![[Images/sw06012026evolutionimg10.png]]
...
![[Images/sw06012026evolutionimg11.png]]
...
![[Images/sw06012026evolutionimg15.png]]
...
![[Images/sw06012026evolutionimg16.png]]
...
![[Images/sw06012026evolutionimg17.png]]
...
![[Images/sw06012026evolutionimg18.png]]
...
![[Images/06012026prisonerimg1.png]]

where in the usual narrative for the game one interprets as “defect” and as “cooperate”.
...
![[Images/06012026prisonerimg2.png]]
...
![[Images/06012026prisonerimg3.png]]
...
![[Images/06012026prisonerimg4.png]]
...
![[Images/06012026prisonerimg5.png]]

The answer turns out to be machine 30:

![[Images/06012026prisonerimg6.png]]

In the literature of prisoner’s dilemma this is often called “grim trigger”, because it yields a strategy that starts with, then repeats this until its opponent first gives —after which it always gives.

Running this machine against all other 2-state machines we get the following behaviors

![[Images/06012026prisonerimg7.png]]

corresponding to the following mean payoffs:

![[Images/06012026prisonerimg8.png]]

Looking at the average mean payoff for all 2-state machines, the ranking of these machines is:

![[Images/06012026prisonerimg9.png]]
...
![[Images/06012026prisonerimg10.png]]
...
![[Images/06012026prisonerimg23.png]]

The mean payoffs against each 2-state machine in this case

![[Images/06012026prisonerimg24.png]]
...
![[Images/sw06022026gamesimg1.png]]
...
![[Images/sw06022026gamesimg4.png]]
...
![[Images/sw06022026gamesimg5A.png]]
...
![[Images/sw06012026cellstratimg1B.png]]
...
![[Images/sw06012026cellstratimg3.png]]
...
![[Images/sw06012026cellstratimg4A.png]]

then the successive steps in running them against each other give

![[Images/sw06012026cellstratimg5.png]]
...
![[Images/sw06012026cellstratimg16.png]]

In a sense, rule 14 finds a very “simple solution”, generating either constant or period-2 behavior, and forcing its opponent to do likewise—and in the end giving an average mean payoff of exactly – ≈ –0.69:

![[Images/sw06012026cellstratimg18.png]]

What about with more complicated cellular automaton rules? Are the winners still ones with simple behavior?

Let’s look at the 3-color analogs of our cellular automaton rules. There are 3 <sup>3 <sup>2</sup></sup> = 19683 of these. And in each case we can “make a decision about the next action” by looking at the final value mod 2. Running all these rules against the 16 2-color rules the distribution of scores is:

![[Images/sw06012026cellstratimg20.png]]

And once again the best-performing rules (such as rule 15911) behave in rather simple ways:

![[Images/sw06032026cellstratAimg21.png]]
...
![[Images/sw06012026cellstratimg22.png]]
...
![[Images/sw06012026cellstratimg23.png]]

Some of the more complicated competitions in this case are:

![[Images/sw06012026cellstratimg24.png]] ![[Images/sw06012026cellstratimg25.png]]
...
![[Images/sw06012026cellstratimg29.png]]
...
![[Images/sw06012026adaptevoimg4.png]]
...
![[Images/sw06012026adaptevoimg5.png]]
...
![[Images/sw06012026adaptevoimg6.png]]
...
![[Images/sw06012026adaptevoimg7.png]]

And here are the corresponding actual behaviors:

![[Images/sw06012026adaptevoimg8.png]]
...
![[Images/sw06012026adaptevoimg9.png]]
...
![[Images/sw06032026turingimg1A.png]]
...
![[Images/sw06032026turingimg3.png]]
...
![[Images/sw06032026turingimg9.png]]
...
![[Images/sw06032026turingimg10.png]]

The maximum of +0.4 is achieved for Turing machine 2403

![[Images/sw06012026turingimg11C.png]]
...
![[Images/sw06032026turingimg12.png]]
...
![[Images/sw06012026historicalimg1.png|Games between programs]]
...
Stephen Wolfram (2026), "Games between Programs: The Ruliology of Competition," Stephen Wolfram Writings. writings.stephenwolfram.com/2026/06/games-between-programs-the-ruliology-of-competition.
...
Wolfram, Stephen. "Games between Programs: The Ruliology of Competition," Stephen Wolfram Writings. June 4, 2026. writings.stephenwolfram.com/2026/06/games-between-programs-the-ruliology-of-competition.

APA

Wolfram, S. (2026, June 4). Games between programs: The ruliology of competition. Stephen Wolfram Writings. writings.stephenwolfram.com/2026/06/games-between-programs-the-ruliology-of-competition.

Posted in: [Artificial Intelligence](https://writings.stephenwolfram.com/category/artificial-intelligence/), [Computational Science](https://writings.stephenwolfram.com/category/computational-science/), [Life Science](https://writings.stephenwolfram.com/category/life-science/), [Ruliology](https://writings.stephenwolfram.com/category/ruliology/)