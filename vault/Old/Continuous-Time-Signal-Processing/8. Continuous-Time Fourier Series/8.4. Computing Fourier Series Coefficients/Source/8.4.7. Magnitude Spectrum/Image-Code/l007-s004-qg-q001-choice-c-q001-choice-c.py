...
"""Render the centered magnitude-spectrum stem plot for q001-choice-c."""
...
SPEC = {'covered_template': 'magnitude-spectrum-stem-plot',
 'equal_aspect': True,
 'render_notes': ['Centered distractor spectrum that swaps the first- and second-harmonic pair heights.',
                  'Blue stems, manual origin-centered axes, and half-unit grid match the answer set.'],
 'show_grid': True,
 'show_origin': True,
 'stems': [(-2, 3.0), (-1, 0.5), (0, 4.0), (1, 0.5), (2, 3.0)],
 'x_axis_label': '$k$',
 'x_minor_grid_step': 1,
 'xlim': (-2.7, 2.7),
 'xticks': [-2, -1, 1, 2],
...
OUTPUT_PATH = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/8.4--computing-fourier-series-coefficients-Images/images/l007-s004-qg-q001-choice-c-q001-choice-c.png")
