...
"""Render the centered magnitude-spectrum stem plot for q001-choice-b."""
...
SPEC = {'covered_template': 'magnitude-spectrum-stem-plot',
 'equal_aspect': True,
 'render_notes': ['Distractor stem plot with the same harmonic indices but negative stem heights below the axis.',
                  'Shared axis limits keep the incorrect sign convention obvious at a glance.'],
 'show_grid': True,
 'show_origin': True,
 'stems': [(-2, -0.5), (-1, -3.0), (0, -4.0), (1, -3.0), (2, -0.5)],
 'x_axis_label': '$k$',
 'x_minor_grid_step': 1,
 'xlim': (-2.7, 2.7),
 'xticks': [-2, -1, 1, 2],
...
OUTPUT_PATH = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/8.4--computing-fourier-series-coefficients-Images/images/l007-s004-qg-q001-choice-b-q001-choice-b.png")
