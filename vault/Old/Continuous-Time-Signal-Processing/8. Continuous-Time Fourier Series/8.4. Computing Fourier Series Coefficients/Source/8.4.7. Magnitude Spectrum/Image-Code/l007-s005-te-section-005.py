...
"""Render the centered magnitude-spectrum stem plot for section-005."""
...
SPEC = {'covered_template': 'magnitude-spectrum-stem-plot',
 'equal_aspect': True,
 'render_notes': ['Centered practice spectrum with a dominant DC stem, a smaller first-harmonic pair, and zero '
                  'second-harmonic stems omitted.',
                  'The compact 0.5-unit grid makes the missing and present harmonics easy to read.'],
 'show_grid': True,
 'show_origin': True,
 'stems': [(-1, 1.0), (0, 5.0), (1, 1.0)],
 'x_axis_label': '$k$',
 'x_minor_grid_step': 1,
 'xlim': (-2.7, 2.7),
 'xticks': [-2, -1, 1, 2],
 ...
 'ylim': (-0.4, 5.4),
 'yticks': [1, 2, 3, 4, 5]}
OUTPUT_PATH = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/8.4--computing-fourier-series-coefficients-Images/images/l007-s005-te-section-005.png")
