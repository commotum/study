...
CONFIG = {'scene': 'matching_board',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/9.2--basic-fourier-transform-pairs-Images/images/l004-s005-te-section-005.png',
 'left_header': 'Rectangular pulses',
 'right_header': 'Sinc magnitude spectra',
 'bottom_caption': 'Width determines central-lobe width; amplitude determines spectral height.',
 'items': [{'duration': 1.5707963267948966,
            'amplitude': 0.9,
            'pulse_label': 'P1',
            'spectrum_label': 'S1',
            'xlim': [-4.5, 4.5],
            ...
            'spectrum_xlim': [-10.0, 10.0],
            'spectrum_ylim': [0.0, 8.896990394966293],
            'spectrum_xticks': [-8, -4, 0, 4, 8],
            'spectrum_yticks': [0, 0.7068583470577035, 1.413716694115407],
            'show_x_tick_labels': False,
            'show_spectrum_x_tick_labels': False},
           {'duration': 2.356194490192345,
            'amplitude': 1.2,
            'pulse_label': 'P2',
            'spectrum_label': 'S2',
            'xlim': [-4.5, 4.5],
            ...
            'spectrum_ylim': [0.0, 8.896990394966293],
            'spectrum_xticks': [-8, -4, 0, 4, 8],
            'spectrum_yticks': [0, 1.413716694115407, 2.827433388230814],
            'show_x_tick_labels': False,
            'show_spectrum_x_tick_labels': False},
           {'duration': 4.71238898038469,
            'amplitude': 1.0,
            'pulse_label': 'P3',
            'spectrum_label': 'S4',
            'xlim': [-4.5, 4.5],
            ...
            'spectrum_ylim': [0.0, 8.896990394966293],
            'spectrum_xticks': [-8, -4, 0, 4, 8],
            'spectrum_yticks': [0, 2.356194490192345, 4.71238898038469],
            'show_x_tick_labels': False,
            'show_spectrum_x_tick_labels': False},
           {'duration': 4.71238898038469,
            'amplitude': 1.6,
            ...
            'spectrum_ylim': [0.0, 8.896990394966293],
            'spectrum_xticks': [-8, -4, 0, 4, 8],
            'spectrum_yticks': [0, 3.7699111843077517, 7.5398223686155035],
            'show_x_tick_labels': False,
            'show_spectrum_x_tick_labels': False},
           {'duration': 3.141592653589793,
            ...
            'spectrum_ylim': [0.0, 8.896990394966293],
            'spectrum_xticks': [-8, -4, 0, 4, 8],
            'spectrum_yticks': [0, 2.5132741228718345, 5.026548245743669],
            'show_x_tick_labels': True,
            'show_spectrum_x_tick_labels': True}]}
