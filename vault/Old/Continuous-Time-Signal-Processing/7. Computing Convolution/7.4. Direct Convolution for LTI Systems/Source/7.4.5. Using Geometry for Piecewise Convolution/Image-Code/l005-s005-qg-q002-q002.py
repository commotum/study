...
def main():
    ...
    rect_x0, rect_x1, rect_h = 0.0, 1.0, 3.0
    ...
    draw_duration_bracket(ax, tri_x0, tri_x1, y=-0.40, label='$3-t$')
    ax.text((rect_x0 + rect_x1) / 2, rect_h / 2, '$3$', fontsize=16, ha="center", va="center", color=LABEL_COLOR)
    ax.text((tri_x0 + tri_x1) / 2 + 0.18, tri_h * 0.62, '$3-t$', fontsize=16, ha="center", va="center", color=LABEL_COLOR)
    ax.text((rect_x0 + tri_x1) / 2, -0.12, '2 <= t <= 3', fontsize=15, ha="center", va="top", color=LABEL_COLOR)
    plt.tight_layout()
    Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l005-s005-qg-q002-q002.png').parent.mkdir(parents=True, exist_ok=True)
    fig.savefig('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l005-s005-qg-q002-q002.png', bbox_inches="tight", facecolor="white")
    plt.close(fig)
