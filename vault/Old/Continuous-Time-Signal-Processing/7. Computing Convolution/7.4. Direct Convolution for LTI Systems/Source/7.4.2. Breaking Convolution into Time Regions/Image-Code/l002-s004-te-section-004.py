...
CONFIG = {'kind': 'classification_rows',
 'figsize': (9.12, 9.2),
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s004-te-section-004.png',
 'xlim': (-3.4, 6.7),
 'ylim': (-0.8, 5.25),
 'axis_y': -0.45,
 'rows': [{'y': 4.1,
           ...
           'moving_label': '$h(t-\\tau)\\text{ support }[-3,-1]$',
           'region_label': '$t<0: \\text{no-overlap}$',
           't_text': '$t=-1$'},
          {'y': 3.05,
           'fixed': (0.0, 3.0),
           'moving': (-1.0, 1.0),
           ...
           'moving_center': 0.0,
           'fixed_label': '$x(\\tau)\\text{ support }[0,3]$',
           'moving_label': '$h(t-\\tau)\\text{ support }[-1,1]$',
           'region_label': '$0<t<2: \\text{overlap}$',
           't_text': '$t=1$'},
          {'y': 2.0,
           'fixed': (0.0, 3.0),
           'moving': (0.5, 2.5),
           ...
           'moving_center': 1.5,
           'fixed_label': '$x(\\tau)\\text{ support }[0,3]$',
           'moving_label': '$h(t-\\tau)\\text{ support }[1/2,5/2]$',
           'region_label': '$2<t<3: \\text{overlap}$',
           't_text': '$t=5/2$'},
          {'y': 0.95,
           'fixed': (0.0, 3.0),
           'moving': (2.0, 4.0),
           ...
           'moving_center': 3.0,
           'fixed_label': '$x(\\tau)\\text{ support }[0,3]$',
           'moving_label': '$h(t-\\tau)\\text{ support }[2,4]$',
           'region_label': '$3<t<5: \\text{overlap}$',
           't_text': '$t=4$'},
          {'y': -0.1,
           'fixed': (0.0, 3.0),
           'moving': (4.0, 6.0),
           ...
           'moving_center': 5.0,
           'fixed_label': '$x(\\tau)\\text{ support }[0,3]$',
           'moving_label': '$h(t-\\tau)\\text{ support }[4,6]$',
           'region_label': '$t>5: \\text{no-overlap}$',
           't_text': '$t=6$'}]}
OUTPUT_PATH = Path(r'/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s004-te-section-004.png')
