...
CONFIG = {'kind': 'endpoint_alignment',
 'figsize': (9.12, 7.68),
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s002-qg-q002-q002.png',
 'xlim': (-1.45, 2.75),
 'ylim': (-0.15, 1.65),
 'xticks': [-1, 0, 1, 2],
 'fixed': (-1.0, 2.0),
 ...
 'fixed_y': 1.05,
 'moving_y': 0.4,
 'fixed_label': '$x(\\tau)\\text{ nonzero on }[-1,2]$',
 'moving_label': '$h(t-\\tau)\\text{ nonzero on }[t-5/2,t-1/2]$',
 'endpoint_labels': [(-1.0, '$-1$', 1.28), (2.0, '$2$', 1.28), (-0.25, '$t-5/2$', 0.63), (1.75, '$t-1/2$', 0.63)]}
OUTPUT_PATH = Path(r'/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s002-qg-q002-q002.png')
