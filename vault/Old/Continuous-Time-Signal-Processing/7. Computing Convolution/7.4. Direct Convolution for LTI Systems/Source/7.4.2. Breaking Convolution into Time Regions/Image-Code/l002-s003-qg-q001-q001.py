...
CONFIG = {'kind': 'ordering',
 'figsize': (9.12, 7.68),
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s003-qg-q001-q001.png',
 'xlim': (-1.45, 5.55),
 'ylim': (-0.35, 1.75),
 'fixed': (0.0, 3.0),
 'moving': (1.05, 4.05),
 ...
 'moving_label': '$h(t-\\tau)\\text{ support }[t-4,t+1]$',
 'endpoint_labels': [(0.0, '$0$', 1.28), (3.0, '$3$', 1.28), (1.05, '$t-4$', 0.66), (4.05, '$t+1$', 0.66)],
 'callouts': [(0.1, 1.57, '$t=4$'), (1.65, 1.57, '$t=7$'), (3.05, 1.57, '$t=-1$'), (4.6, 1.57, '$t=2$')],
 'bottom_xlim': (-1.1, 5.1)}
OUTPUT_PATH = Path(r'/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s003-qg-q001-q001.png')
