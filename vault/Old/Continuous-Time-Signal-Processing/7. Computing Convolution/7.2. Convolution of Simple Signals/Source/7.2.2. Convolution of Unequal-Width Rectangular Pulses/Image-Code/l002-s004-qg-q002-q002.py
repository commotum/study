...
CONFIG = {'kind': 'single',
 ...
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l002-s004-qg-q002-q002.png',
 'figsize': (9.2, 5.9),
 'panel': {'xlim': (-1.8, 7.8),
           'ylim': (-0.7, 3.5),
           ...
           'moving': {'left': 0.5,
                      ...
                      'label': '$h(t-\\tau)$',
                      'fill_alpha': 0.08},
           'overlap': {'left': 0.5, 'right': 4.0, 'height': 1.55, 'label': '', 'alpha': 0.12},
           'brackets': [{'start': 0.0, 'end': 6.0, 'y': -0.44, 'label': '$2\\leq t\\leq 6$'}],
           'edge_labels': [{'x': 0.0, 'y': -0.16, 'text': '$0$', 'fontsize': 15, 'va': 'top'},
                           {'x': 6.0, 'y': -0.16, 'text': '$6$', 'fontsize': 15, 'va': 'top'},
                           {'x': 0.5, 'y': -0.16, 'text': '$t-2$', 'fontsize': 15, 'va': 'top'},
                           {'x': 4.0, 'y': -0.16, 'text': '$t$', 'fontsize': 15, 'va': 'top'}]},
 'python_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/code/l002-s004-qg-q002-q002.py',
 'slot_key': 'l002-s004-qg-q002-q002',
 'lesson_index': 2,
