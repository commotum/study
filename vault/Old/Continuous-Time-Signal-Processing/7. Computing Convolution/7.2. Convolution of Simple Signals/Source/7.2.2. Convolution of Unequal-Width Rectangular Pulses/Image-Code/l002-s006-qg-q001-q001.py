...
CONFIG = {'kind': 'assembly',
 ...
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l002-s006-qg-q001-q001.png',
 'figsize': (10.4, 8.6),
 'inputs': [{'xlim': (-0.6, 4.6),
             'ylim': (-0.7, 3.2),
             'xticks': [0, 1, 2, 3, 4],
 ...
 'output': {'xlim': (-0.8, 11.8),
            ...
            'equal_aspect': False,
            'curve': False,
            'breakpoints': [0.0, 3.0, 8.0, 11.0],
            'show_break_labels': True,
            'break_label_y': -0.18,
            'labels': [],
            'extra_text': [{'x': 1.5, 'y': 1.0, 'text': 'zero before 0', 'fontsize': 14},
                           {'x': 1.5, 'y': 2.2, 'text': 'rising from 0 to 3', 'fontsize': 14},
                           {'x': 5.5, 'y': 2.2, 'text': 'plateau from 3 to 8', 'fontsize': 14},
                           {'x': 9.5, 'y': 2.2, 'text': 'falling from 8 to 11', 'fontsize': 14},
                           {'x': 10.2, 'y': 1.0, 'text': 'zero after 11', 'fontsize': 14}]},
 'python_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/code/l002-s006-qg-q001-q001.py',
 'slot_key': 'l002-s006-qg-q001-q001',
 'lesson_index': 2,
 'lesson_title': 'Convolution of Unequal-Width Rectangular Pulses',
 'section_index': 6,
 'source_stage': 'question-generation',
 'image_slot_id': 'q001',
 'template': 'output-assembly-guide-with-breakpoints'}
