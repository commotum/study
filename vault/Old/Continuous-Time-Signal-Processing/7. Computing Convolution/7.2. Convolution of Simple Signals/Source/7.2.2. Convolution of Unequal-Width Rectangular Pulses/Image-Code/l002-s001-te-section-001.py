...
CONFIG = {'kind': 'timeline',
 ...
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l002-s001-te-section-001.png',
 'figsize': (9.2, 7.1),
 'top_panel': {'xlim': (-1.0, 7.0),
               'ylim': (-0.7, 3.4),
               ...
               'overlap': {'left': 1.6,
                           ...
                           'label': '$L(t)$',
                           'alpha': 0.18},
               'brackets': [{'start': 0.0, 'end': 6.0, 'y': -0.44, 'label': 'fixed support'},
                            {'start': 1.6, 'end': 4.0, 'y': -0.44, 'label': 'moving support'}]},
 'timeline': {'xlim': (-0.5, 6.5),
              'breakpoints': [0.0, 3.0, 6.0],
              'labels': {},
              'region_labels': [{'x': 0.0, 'y': 0.22, 'text': 'first contact', 'fontsize': 14},
                                {'x': 3.0, 'y': 0.22, 'text': 'full overlap', 'fontsize': 14},
                                {'x': 6.0, 'y': 0.22, 'text': 'last contact', 'fontsize': 14}],
              'axis_label': '$t$'},
 'python_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/code/l002-s001-te-section-001.py',
 'slot_key': 'l002-s001-te-section-001',
 'lesson_index': 2,
 'lesson_title': 'Convolution of Unequal-Width Rectangular Pulses',
 'section_index': 1,
 'source_stage': 'tutorial-example',
 'image_slot_id': 'section-001',
 'template': 'rectangular-pulse-sliding-overlap-concept'}
