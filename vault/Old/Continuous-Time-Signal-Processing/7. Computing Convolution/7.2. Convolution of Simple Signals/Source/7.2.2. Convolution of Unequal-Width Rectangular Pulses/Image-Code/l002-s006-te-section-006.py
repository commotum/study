...
CONFIG = {'kind': 'assembly',
 'slot_id': 'section-006',
 'section_title': 'Assembling the Piecewise Trapezoidal Output',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l002-s006-te-section-006.png',
 'figsize': (10.4, 8.6),
 'inputs': [{'xlim': (-0.6, 4.6),
             'ylim': (-0.7, 3.2),
             'xticks': [0, 1, 2, 3, 4],
            ...
            {'xlim': (-0.6, 7.6),
             ...
             'height': 3.0,
             'label': '$h(t)$',
             'interval_label': '$0\\leq t\\leq 7$',
             'bracket_y': -0.42}],
 'output': {'xlim': (-0.8, 11.8),
            'ylim': (-0.9, 26.8),
            'xticks': [0, 4, 7, 11],
            'yticks': [24],
            'x_axis_label': '$t$',
            ...
            'equal_aspect': False,
            'curve': True,
            'breakpoints': [0.0, 4.0, 7.0, 11.0],
            'show_break_labels': True,
            'break_label_y': -0.2,
            'labels': [{'x': 1.0, 'y': 1.6, 'text': 'zero', 'fontsize': 14},
                       {'x': 2.0, 'y': 12.8, 'text': 'rising branch', 'fontsize': 14},
                       {'x': 5.5, 'y': 24.9, 'text': '24', 'fontsize': 14},
                       {'x': 5.5, 'y': 20.8, 'text': 'plateau', 'fontsize': 14},
                       {'x': 9.0, 'y': 12.8, 'text': 'shrinking branch', 'fontsize': 14},
                       {'x': 10.5, 'y': 1.6, 'text': 'zero', 'fontsize': 14}],
            'extra_text': [{'x': 1.0, 'y': 1.0, 'text': 'zero before 0', 'fontsize': 14},
                           {'x': 1.0, 'y': 2.2, 'text': 'rising from 0 to 2', 'fontsize': 14},
                           {'x': 4.0, 'y': 2.2, 'text': 'plateau from 2 to 6', 'fontsize': 14},
                           {'x': 7.0, 'y': 2.2, 'text': 'falling from 6 to 8', 'fontsize': 14},
                           {'x': 7.8, 'y': 1.0, 'text': 'zero after 8', 'fontsize': 14}],
            'x_points': [0.0, 4.0, 7.0, 11.0],
            'y_points': [0.0, 24.0, 24.0, 0.0]},
 'python_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/code/l002-s006-te-section-006.py',
 'slot_key': 'l002-s006-te-section-006',
 'lesson_index': 2,
 'lesson_title': 'Convolution of Unequal-Width Rectangular Pulses',
 'section_index': 6,
 'source_stage': 'tutorial-example',
 'image_slot_id': 'section-006',
 'template': 'assembled-trapezoidal-convolution-output'}
