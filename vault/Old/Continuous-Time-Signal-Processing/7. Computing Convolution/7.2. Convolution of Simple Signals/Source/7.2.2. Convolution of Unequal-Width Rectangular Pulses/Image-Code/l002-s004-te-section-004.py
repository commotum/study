...
CONFIG = {'kind': 'single',
 ...
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l002-s004-te-section-004.png',
 'figsize': (9.2, 5.9),
 'panel': {'xlim': (-2.8, 6.2),
           'ylim': (-0.7, 3.5),
           'xticks': [-2, 0, 2, 4, 6],
           ...
           'edge_labels': [{'x': 0.0, 'y': -0.16, 'text': '$0$', 'fontsize': 15, 'va': 'top'},
                           ...
                           {'x': -1.5, 'y': -0.16, 'text': '$t-7$', 'fontsize': 15, 'va': 'top'},
                           {'x': 5.5, 'y': -0.16, 'text': '$t$', 'fontsize': 15, 'va': 'top'}]},
 'python_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/code/l002-s004-te-section-004.py',
 'slot_key': 'l002-s004-te-section-004',
 'lesson_index': 2,
