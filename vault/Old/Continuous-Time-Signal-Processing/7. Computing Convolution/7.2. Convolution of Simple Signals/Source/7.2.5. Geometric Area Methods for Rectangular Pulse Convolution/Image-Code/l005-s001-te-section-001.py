...
OUTPUT_PATH = r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l005-s001-te-section-001.png"
...
def main():
    render_single_overlap_scene(
        ...
        fixed_interval=(0, 5),
        fixed_height=2,
        fixed_label=r"$x(\tau)=A$",
        moving_interval=(2, 7),
        moving_height=1,
        moving_label=r"$h(t-\tau)=B$",
        overlap_start=2,
        overlap_end=5,
        width_label=r"$L(t)$",
        product_text=r"$AB$",
