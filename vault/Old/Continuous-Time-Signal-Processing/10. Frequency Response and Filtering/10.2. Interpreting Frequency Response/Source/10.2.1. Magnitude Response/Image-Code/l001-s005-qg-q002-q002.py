...
def build_curve():
    ...
    anchors_x = np.array([0.0, 1.2, 2.2, 3.1, 3.8, 4.5, 5.2, 6.2, 7.4, 8.3, 9.0])
    anchors_y = np.array([0.72, 0.72, 0.79, 1.10, 1.46, 1.50, 1.28, 0.92, 0.60, 0.47, 0.45])
...
def main():
    ...
    save_figure(
        fig,
        "/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/10.2--interpreting-frequency-response-Images/images/l001-s005-qg-q002-q002.png",
    )
