...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l007-s004-te-section-004.png',
 ...
 'panels': [{'xlim': (-0.4, 4.4),
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 0, 'end': 3, 'height': 2},
            ...
            {'xlim': (-0.4, 4.4),
             ...
             'texts': [{'text': '$x(\\tau)h(1-\\tau)=-2$',
                        ...
                        'y': -1.02,
                        'fontsize': 15},
                       {'text': '$-4 = y(1)$', 'x': 2.0, 'y': -2.12, 'fontsize': 15}]}],
