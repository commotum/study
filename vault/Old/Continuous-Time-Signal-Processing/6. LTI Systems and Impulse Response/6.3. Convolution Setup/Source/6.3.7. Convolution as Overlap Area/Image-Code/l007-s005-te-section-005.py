...
SPEC = {'layout': 'comparison',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l007-s005-te-section-005.png',
 ...
 'columns': [{'header_text': 'fixed $t=1$',
              'panels': [{'xlim': (-1.4, 4.4),
                         ...
                         {'xlim': (-1.4, 4.4),
                          ...
                          'equal_aspect': True,
                          'show_origin': True,
                          'main_rect': {'start': -1, 'end': 2, 'height': 2},
                          'overlap': {'start': 1,
                                      'end': 2,
                                      'height': 2,
                                      'fill_alpha': 0.22},
              ...
              'panels': [{'xlim': (-1.4, 4.4),
                         ...
                         {'xlim': (-1.4, 4.4),
                          ...
                          'texts': [{'text': '$y(3)=6$',
                                     ...
                                     'y': 1.18,
                                     'fontsize': 15}]}]}],
 'figure_texts': [{'text': 'y(3) > y(1)', 'x': 0.5, 'y': 0.03, 'fontsize': 16}]}
