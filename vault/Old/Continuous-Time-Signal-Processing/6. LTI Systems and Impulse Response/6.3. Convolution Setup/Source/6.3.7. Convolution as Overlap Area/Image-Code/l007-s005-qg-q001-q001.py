...
SPEC = {'layout': 'comparison',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l007-s005-qg-q001-q001.png',
 'figure_size': (13.6, 9.7),
 'columns': [{'header_text': 'fixed $t=1$',
              'panels': [{'xlim': (-1.4, 5.4),
                          'ylim': (-0.35, 1.65),
                          'xticks': [-1, 0, 2, 5],
                          'yticks': [1],
                         ...
                         {'xlim': (-1.4, 5.4),
                          ...
                          'equal_aspect': True,
                          'show_origin': True,
                          'main_rect': {'start': -1, 'end': 2, 'height': 4},
                          'overlap': {'start': 0,
                                      'end': 2,
                                      'height': 4,
                                      'fill_alpha': 0.22},
                         ...
                         {'xlim': (-1.4, 5.4),
                          ...
                          'main_rect': {'start': 0,
                                        ...
                                        'height': 4,
                                        'fill_alpha': 0.18},
                          'texts': [{'text': '$x(\\tau)h(1-\\tau)=4$',
                                     'x': 1.0,
                                     'y': 1.9,
                                     'fontsize': 15}]}]},
             {'header_text': 'fixed $t=4$',
              'panels': [{'xlim': (-1.4, 5.4),
                          'ylim': (-0.35, 1.65),
                          'xticks': [-1, 0, 2, 5],
                          'yticks': [1],
