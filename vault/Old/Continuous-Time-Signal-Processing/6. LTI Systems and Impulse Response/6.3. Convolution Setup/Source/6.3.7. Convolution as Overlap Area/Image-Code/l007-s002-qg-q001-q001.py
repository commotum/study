...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l007-s002-qg-q001-q001.png',
 'figure_size': (10.0, 9.6),
 'panels': [{'xlim': (-1.4, 2.4),
             'ylim': (-0.35, 2.65),
             'xticks': [-1, 0, 1, 2],
             'yticks': [2],
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 0, 'end': 2, 'height': 2},
             'overlap': {'start': 0, 'end': 1, 'height': 2, 'fill_alpha': 0.22},
             'texts': [{'text': '$x(\\tau)=2$', 'x': 0.95, 'y': 2.2, 'fontsize': 15},
                       {'text': 'overlap 0<=tau<=1',
                        'x': 0.5,
                        'y': 1.18,
                        'fontsize': 14}]},
            {'xlim': (-1.4, 2.4),
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': -1, 'end': 1, 'height': 1},
             'overlap': {'start': 0, 'end': 1, 'height': 1, 'fill_alpha': 0.22},
             'texts': [{'text': '$h(1-\\tau)=1$', 'x': 0.0, 'y': 1.18, 'fontsize': 15},
                       {'text': 'overlap 0<=tau<=1',
                        'x': 0.5,
                        'y': 0.68,
                        'fontsize': 14}]},
            {'xlim': (-1.4, 2.4),
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 0, 'end': 1, 'height': 2, 'fill_alpha': 0.18},
             'texts': [{'text': '$x(\\tau)h(1-\\tau)=2$',
                        'x': 0.5,
                        'y': 1.18,
                        'fontsize': 15}]}],
