...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l007-s006-te-section-006.png',
 ...
 'panels': [{'xlim': (-0.4, 4.4),
             ...
             'texts': [{'text': '$x(\\tau)=1$', 'x': 1.0, 'y': 1.18, 'fontsize': 15},
            ...
            {'xlim': (-0.4, 4.4),
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 3, 'end': 4, 'height': 1},
             'texts': [{'text': '$h(5-\\tau)=1$', 'x': 3.5, 'y': 1.18, 'fontsize': 15},
                       {'text': 'no overlap', 'x': 2.5, 'y': 0.45, 'fontsize': 14}]},
            {'xlim': (-0.4, 4.4),
             'ylim': (-0.25, 0.65),
             'xticks': [0, 2, 3, 4],
