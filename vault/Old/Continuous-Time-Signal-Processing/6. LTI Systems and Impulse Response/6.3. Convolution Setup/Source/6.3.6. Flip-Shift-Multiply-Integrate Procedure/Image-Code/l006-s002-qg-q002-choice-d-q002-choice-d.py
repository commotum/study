...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s002-qg-q002-choice-d-q002-choice-d.png',
 'panel': {'segments': [(-1, 1, 2, True, False), (1, 2, 1, True, True)],
           'xlim': (-1.85, 2.85),
           'ylim': (-0.7, 2.7),
           'xticks': [-1, 0, 1, 2],
           'yticks': [1, 2],
