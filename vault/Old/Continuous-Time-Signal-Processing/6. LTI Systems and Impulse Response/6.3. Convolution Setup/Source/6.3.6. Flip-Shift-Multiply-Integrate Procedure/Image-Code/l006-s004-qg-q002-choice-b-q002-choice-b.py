...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s004-qg-q002-choice-b-q002-choice-b.png',
 'panel': {'segments': [(0, 4, -1, True, True)],
           'xlim': (-0.85, 4.85),
           'ylim': (-1.7, 0.7),
           'xticks': [0, 4],
           'yticks': [-1],
           ...
           'baseline': 0.0,
           'reflection_axis': None,
           'shade_regions': [{'x_left': 0, 'x_right': 4, 'alpha': 0.09}],
           'support_brackets': [],
           'vertical_lines': [],
           'horizontal_lines': [],
           'texts': []},
