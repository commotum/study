...
OUTPUT_PATH = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.1--time-shifting-Images/images/l001-s005-qg-q002-q002.png")
...
def main():
    ...
    draw_triangle_signal(ax, *(-1.0, 3.0, 7.0, 2.0))
    label_point(ax, -1.0, 0.0, '$-1$', dx=-0.08, dy=-0.3, ha='right', va='top')
    label_point(ax, 3.0, 2.0, '$3$', dx=0.0, dy=0.28, ha='center', va='bottom')
    label_point(ax, 7.0, 0.0, '$7$', dx=0.08, dy=-0.3, ha='left', va='top')
    draw_shift_arrow(ax, -0.1, 4.1, 2.55, label='$2$')
