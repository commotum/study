"""Generated matplotlib figure for l006-s006-qg-q002-choice-d-q002-choice-d."""
...
OUTPUT_PATH = Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l006-s006-qg-q002-choice-d-q002-choice-d.png')

def main():
    panel_specs = [{'xlim': (-4, 2), 'xticks': [-3, 0, 1], 'signal_label': '$y(t)$', 'pulse': {'start': -3, 'peak': 0, 'end': 1}}]
