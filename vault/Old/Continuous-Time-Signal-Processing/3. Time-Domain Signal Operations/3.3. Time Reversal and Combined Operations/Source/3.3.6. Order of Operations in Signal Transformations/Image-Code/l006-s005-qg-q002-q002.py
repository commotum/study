"""Generated matplotlib figure for l006-s005-qg-q002-q002."""
...
OUTPUT_PATH = Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l006-s005-qg-q002-q002.png')

def main():
    panel_specs = [{'xlim': (-1, 9), 'xticks': [0, 6, 8], 'signal_label': '$x(t)$', 'pulse': {'start': 0, 'peak': 6, 'end': 8}}, {'xlim': (-1, 9), 'xticks': [-1, 2, 3], 'signal_label': '$y(t)$', 'pulse': {'start': -1, 'peak': 2, 'end': 3}}]
