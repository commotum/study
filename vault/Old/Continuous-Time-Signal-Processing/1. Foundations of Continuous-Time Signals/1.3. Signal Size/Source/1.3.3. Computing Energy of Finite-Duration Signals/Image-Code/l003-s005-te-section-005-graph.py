...
def render():
    ...
    plot_signal(ax, np.array([0.0, 1.0, 2.0]), np.array([0.0, 2.0, 0.0]))
    ...
    save_figure(
        fig,
        "/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.3--signal-size-Images/images/l003-s005-te-section-005-graph.png",
    )
    plt.close(fig)
