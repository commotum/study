...
OUTPUT_PATH = r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l003-s003-te-section-003.png"
...
def main():
    ...
    plot_signal(ax, [-2, 0], [0, 2])
    plot_signal(ax, [0, 3], [2, -1])
    draw_point(ax, -2, 0)
    draw_point(ax, 0, 2)
    draw_point(ax, 3, -1)
