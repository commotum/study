...
OUTPUT_PATH = r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l003-s002-te-section-002.png"
...
def main():
    ...
    plot_signal(ax, [3, 5], [-1, -1])
    draw_closed_endpoint(ax, 0, 2)
    draw_open_endpoint(ax, 3, 2)
    draw_closed_endpoint(ax, 3, -1)
    draw_closed_endpoint(ax, 5, -1)
