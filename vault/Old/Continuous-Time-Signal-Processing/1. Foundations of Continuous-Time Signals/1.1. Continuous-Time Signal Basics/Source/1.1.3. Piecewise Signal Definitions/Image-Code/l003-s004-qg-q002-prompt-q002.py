...
OUTPUT_PATH = r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l003-s004-qg-q002-prompt-q002.png"
...
def main():
    ...
    plot_signal(ax, [-3, 2], [1, 1])
    plot_signal(ax, [2, 4], [5, 5])
    draw_closed_endpoint(ax, -3, 1)
    draw_closed_endpoint(ax, 2, 1)
    draw_open_endpoint(ax, 2, 5)
    draw_closed_endpoint(ax, 4, 5)
