...
OUTPUT_PATH = r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l003-s004-qg-q001-prompt-q001.png"
...
def main():
    ...
    plot_signal(ax, [-2, 0], [4, 4])
    plot_signal(ax, [0, 3], [-2, -2])
    draw_closed_endpoint(ax, -2, 4)
    draw_open_endpoint(ax, 0, 4)
    draw_closed_endpoint(ax, 0, -2)
    draw_closed_endpoint(ax, 3, -2)
