...
def draw_highlight(ax, t, x):
    ax.plot(t, x, marker="o", linestyle="None", markersize=HIGHLIGHT_SIZE,
            markerfacecolor=SIGNAL_COLOR, markeredgecolor=SIGNAL_COLOR,
...
def main():
    ...
    plot_signal(ax, t, x)
    draw_highlight(ax, [-1, 1], [1, 1])

    # lightly indicate the mirror axis at t=0 using subtle guide points
    ax.plot([0, 0], [-0.1, 2.1], color=AXIS_COLOR, linestyle=(0, (2, 3)),
            linewidth=TICK_LW * 0.8, alpha=0.35)

    output_path = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l005-s002-te-section-002.png")
