...
def main():
    ...
    draw_zero(ax, -1.0, 0.0, label='$-1$', label_offset=(0.12, 0.16))
    draw_zero(ax, 0.0, 1.0, label='$j$', label_offset=(0.12, 0.18))
    draw_zero(ax, 0.0, -1.0, label='$-j$', label_offset=(0.12, -0.34))
    draw_pole(ax, 1.0, 0.0, label='$1$', label_offset=(0.12, 0.16))
    draw_pole(ax, -2.0, 0.0, label='$-2$', label_offset=(0.12, -0.34))
    draw_pole(ax, 0.0, 2.0, label='$2j$', label_offset=(0.12, 0.18))
    draw_pole(ax, 0.0, -2.0, label='$-2j$', label_offset=(0.12, -0.34))
    save_figure(fig, Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l003-s004-te-section-004.png'))
