...
def main():
    ...
    setup_axes(ax, xlim=xlim, ylim=ylim, xticks=[-3, -2, -1, 1, 2], yticks=[-2, -1, 1, 2])
    draw_zero(ax, -2.0, 0.0, label='-2', label_offset=(0.16, 0.16))
    draw_zero(ax, -1.0, 0.0, label='-1', label_offset=(0.16, -0.34))
    draw_pole(ax, 1.0, 0.0, label='1', label_offset=(0.1, 0.16))
    save_figure(fig, Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l003-s002-te-section-002.png'))
