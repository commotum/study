...
CONFIG = {'covered_template': 's-plane-damped-oscillation', 'xlim': (-3.2, 1.5), 'ylim': (-5.0, 5.0), 'xticks': [-3, -2, -1, 1], 'yticks': [-4, -2, 2, 4], 'x_axis_label': '$\\sigma$', 'y_axis_label': '$\\omega$', 'poles': [{'x': -0.5, 'y': 3, 'label': '$-0.5+j3$', 'label_offset': (0.12, 0.3), 'label_ha': 'left', 'label_va': 'bottom'}], 'guides': [{'x_values': [-0.5, -0.5], 'y_values': [0, 3], 'color': '#777777'}, {'x_values': [0, -0.5], 'y_values': [3, 3], 'color': '#777777'}], 'annotations': [{'text': '$e^{-0.5t}$ envelope', 'xy': (-0.5, 3), 'xytext': (-2.55, 4.1), 'arrow': True, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}, {'text': '$3\\,\\mathrm{rad/s}$', 'xy': (-0.5, 3), 'xytext': (0.22, 3.55), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}, {'text': 'decaying sinusoid', 'xy': (-0.5, 3), 'xytext': (-2.55, -1.55), 'arrow': True, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}], 'render_notes': ['Section-only damped sinusoid example with one mixed pole.', 'The annotation ties the pole to both the exponential envelope and oscillation rate.'], 'show_grid': True, 'show_origin': True, 'x_minor_grid_step': 1, 'y_minor_grid_step': 1, 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l007-s005-te-section-005.png'}
