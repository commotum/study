...
CONFIG = {'covered_template': 's-plane-single-pole', 'xlim': (-3.5, 3.5), 'ylim': (-4.5, 4.5), 'xticks': [-3, -2, -1, 1, 2, 3], 'yticks': [-4, -3, -2, -1, 1, 2, 3, 4], 'x_axis_label': '$\\sigma$', 'y_axis_label': '$j\\omega$', 'poles': [{'x': -1, 'y': 3, 'label': '$-1+j3$', 'label_offset': (0.1, 0.28), 'label_ha': 'left', 'label_va': 'bottom'}], 'guides': [{'x_values': [-1, -1], 'y_values': [0, 3], 'color': '#777777'}, {'x_values': [0, -1], 'y_values': [3, 3], 'color': '#777777'}], 'annotations': [{'text': '$\\sigma=-1$', 'xy': (-1, 0), 'xytext': (-2.15, -0.95), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}, {'text': '$\\omega=3$', 'xy': (0, 3), 'xytext': (0.35, 3.3), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}], 'render_notes': ['Single-pole coordinate-reading prompt with guide lines to the axes.', 'Emphasizes the point at -1+j3 on a light s-plane grid.'], 'show_grid': True, 'show_origin': True, 'x_minor_grid_step': 1, 'y_minor_grid_step': 1, 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l007-s002-qg-q001-q001.png'}
