...
CONFIG = {'covered_template': 's-plane-multi-pole-comparison', 'xlim': (-7.5, 2.5), 'ylim': (-7.5, 7.5), 'xticks': [-7, -5, -3, -1, 1, 2], 'yticks': [-6, -4, -2, 2, 4, 6], 'x_axis_label': '$\\sigma$', 'y_axis_label': '$\\omega$', 'poles': [{'x': -4, 'y': 0, 'label': '$-4$', 'label_offset': (-0.18, 0.28), 'label_ha': 'left', 'label_va': 'bottom'}, {'x': -1, 'y': 4, 'label': '$-1+j4$', 'label_offset': (0.1, 0.25), 'label_ha': 'left', 'label_va': 'bottom'}, {'x': -1, 'y': -2, 'label': '$-1-j2$', 'label_offset': (0.1, -0.6), 'label_ha': 'left', 'label_va': 'top'}], 'annotations': [{'text': '$\\sigma=-4$', 'xy': (-4, 0), 'xytext': (-5.55, 1.45), 'arrow': True, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 10}, {'text': '$\\sigma=-1,\\ \\omega=4$', 'xy': (-1, 4), 'xytext': (-0.95, 4.85), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 10}, {'text': '$\\sigma=-1,\\ \\omega=-2$', 'xy': (-1, -2), 'xytext': (-0.95, -3.05), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 10}], 'render_notes': ['Section-only multi-pole comparison showing the closest pole to the imaginary axis and the oscillatory pair.', 'Coordinate labels and annotations make the dominance comparison visually explicit.'], 'show_grid': True, 'show_origin': True, 'x_minor_grid_step': 1, 'y_minor_grid_step': 1, 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l007-s006-te-section-006.png'}
