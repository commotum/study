...
id: q-1
content: |-
  What is $\displaystyle \lim_{n \to \infty}(1 + \frac{1}{n})^{-2n}$?
options:
- id: a
  content: |-
    $\frac{e}{2}$
...
id: q-2
content: |-
  What is $\displaystyle \lim_{n \to \infty}(1 + \frac{1}{n})^{n/2}$?
options:
- id: a
  content: |-
    $\frac{2}{e}$
...
id: q-3
content: |-
  What is $\displaystyle \lim_{n \to \infty}(1 + \frac{1}{n})^{4nx}$?
options:
- id: a
  content: |-
    $4e^{-4x}$
...
id: q-4
content: |-
  What is $\displaystyle \lim_{n \to \infty}(1 + \frac{1}{n})^{nx/2}$?
options:
- id: a
  content: |-
    $\frac{\sqrt{e}}{2}$
...
$$
\begin{aligned}
\left[\lim_{n\to\infty}\left(1+\frac{1}{n/x}\right)^{n/x}\right]^x
&= \left[\underbrace{\lim_{m\to\infty}\left(1+\frac{1}{m}\right)^m}_{e}\right]^x \\
&= e^{x}
\end{aligned}
$$
...
id: q-5
content: |-
  What is $\displaystyle \lim_{n \to \infty}(1 + \frac{x}{n})^{-3n}$?
options:
- id: a
  content: |-
    $e^{3x}$
...
id: q-6
content: |-
  What is $\displaystyle \lim_{n \to \infty}(1 + \frac{x}{n})^{2nx}$?
options:
- id: a
  content: |-
    $e^{2}$
