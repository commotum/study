...
- [The Generalized Binomial Theorem](<../../../../MA/Mathematical-Structures-&-Proof/DSM/5. Sequences/5.3. The Binomial Theorem/Lessons/5.3.1. The Generalized Binomial Theorem.md>)
...
id: ma-13656
content: |-
  What is the binomial expansion of $\frac{5}{6 - 2x}$ up to the third term for $\mid x \mid < 3$?
options:
- id: a
  content: |-
    $\frac{5}{6} + \frac{5}{6}x + \frac{5}{6}x^{2} + ⋯$
- id: b
  content: |-
    $\frac{5}{6} - \frac{5}{6}x + \frac{5}{6}x^{2} + ⋯$
- id: c
  content: |-
    $1 + \frac{5}{6}x + \frac{5}{36}x^{2} + ⋯$
- id: d
  content: |-
    $\frac{5}{6} + \frac{5}{18}x + \frac{5}{54}x^{2} + ⋯$
  correct: true
- id: e
  content: |-
    $\frac{5}{6} - \frac{5}{12}x + \frac{5}{24}x^{2} + ⋯$
```
...
id: ma-13680
content: |-
  What is the binomial expansion of $(8)/((2 + 4x)^{3})$ up to the third term for $\mid x \mid < \frac{1}{2}$?
options:
- id: a
  content: |-
    $-1 - 6x - 24x^{2} + ⋯$
...
id: ma-33547
content: |-
  What is the binomial expansion of $\frac{6}{\sqrt{9 + 8x}}$ up to the third term for $\mid x \mid < \frac{9}{8}$?
options:
- id: a
  content: |-
    $2 - \frac{8}{9}x + \frac{16}{27}x^{2} + ⋯$
  correct: true
- id: b
  content: |-
    $2 + \frac{8}{9}x + \frac{16}{27}x^{2} + ⋯$
- id: c
  content: |-
    $2 - \frac{4}{9}x + \frac{8}{27}x^{2} + ⋯$
- id: d
  content: |-
    $1 - \frac{4}{9}x + \frac{8}{27}x^{2} + ⋯$
- id: e
  content: |-
    $2 + \frac{4}{9}x + \frac{8}{27}x^{2} + ⋯$
```
