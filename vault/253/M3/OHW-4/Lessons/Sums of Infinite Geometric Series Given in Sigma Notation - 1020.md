...
$$
\begin{aligned}
\sum_{n=1}^{\infty}3(\frac{1}{4})^{n} &= \frac{a_{1}}{1 - r} \\
...
id: ma-50484
content: |-
  Given that $a_{1} =-18$ and $\frac{a_{n + 1}}{a_{n}} =-0.9$ for all integers $n \ge 1$, find the value of $\displaystyle \sum_{n=1}^{\infty}a_{n}$.
options:
- id: a
  content: |-
    $-\frac{19}{2}$
...
id: ma-50495
content: |-
  Given that $a_{1} = 5$ and $\frac{a_{n + 1}}{a_{n}} = \frac{3}{5}$ for all integers $n \ge 1$, find the value of $\displaystyle \sum_{n=1}^{\infty}a_{n}$.
options:
- id: a
  content: |-
    $4$
...
$$
\begin{aligned}
\sum_{n=1}^{\infty}2(0.5)^{n} &= \frac{a_{1}}{1 - r} \\
&= \frac{1}{1 - 0.5} \\
&= \frac{1}{0.5} \\
&= 2
\end{aligned}
...
id: ma-14092
content: |-
  What is $\displaystyle \sum_{n=1}^{\infty}\frac{1}{2}(0.3)^{n}$?
options:
- id: a
  content: |-
    $\frac{2}{7}$
...
id: ma-13581
content: |-
  What is $\displaystyle \sum_{n=1}^{\infty}5(\frac{1}{4})^{n}$?
options:
- id: a
  content: |-
    $\frac{1}{2}$
...
$$
\begin{aligned}
\sum_{n=2}^{\infty}(\frac{2}{3})^{n} &= \frac{a_{2}}{1 - r} \\
&= \frac{(\frac{4}{9})}{(1 - \frac{2}{3})} \\
...
id: ma-40404
content: |-
  What is $\displaystyle \sum_{n=3}^{\infty}\frac{9}{2}(\frac{1}{3})^{n}$?
options:
- id: a
  content: |-
    $\frac{1}{5}$
...
id: ma-67228
content: |-
  Evaluate the series $\displaystyle \sum_{n=2}^{\infty}(\frac{1}{4})^{n}$.
options:
- id: a
  content: |-
    $\frac{7}{12}$
...
$$
\begin{aligned}
\sum_{n=3}^{\infty}\frac{5}{2}(\frac{1}{2})^{2n} &= \frac{a_{3}}{1 - r} \\
&= \frac{5(\frac{1}{2})^{7}}{(1 - \frac{1}{4})} \\
&= \frac{(\frac{5}{128})}{(\frac{3}{4})} \\
&= (\frac{5}{128})(\frac{4}{3}) \\
&= \frac{5}{3(32)} \\
&= \frac{5}{96}
\end{aligned}
...
content: |-
  ...
  Evaluate the geometric series $\displaystyle \sum_{n=2}^{\infty}8(-\frac{3}{5})^{n - 1}$.
options:
- id: a
  content: |-
    $-3$
...
content: |-
  ...
  Evaluate the geometric series $\displaystyle \sum_{n=1}^{\infty}3(0.5)^{4n}$.
options:
- id: a
  content: |-
    $2$
