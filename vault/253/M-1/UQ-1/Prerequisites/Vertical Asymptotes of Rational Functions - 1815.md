...
id: q-1
content: |-
  Find the vertical asymptotes of $y = f(x) = \frac{2}{4x - 3}$.
options:
- id: a
  content: |-
    $x =-\frac{4}{3}$
...
id: q-2
content: |-
  Find the vertical asymptotes of $y = f(x) = \frac{1}{x^{2} - x - 6}$.
options:
- id: a
  content: |-
    There are no vertical asymptotes.
...
id: q-3
content: |-
  Find the vertical asymptotes of $f(x) = \frac{2x - 6}{x^{2} - 7x + 12}$.
options:
- id: a
  content: |-
    $x = 4, x = 3$
...
id: q-4
content: |-
  Find the vertical asymptotes of $f(x) = \frac{x^{2} + 3x}{2x^{2} + x}$.
options:
- id: a
  content: |-
    $x = 0$, $x = \frac{1}{2}$
...
id: q-5
content: |-
  Find the vertical asymptotes of $f(x) = \frac{4x^{2} - 3x}{8x - 6}$.
options:
- id: a
  content: |-
    $x = \frac{3}{2}$
...
id: q-6
content: |-
  Find the vertical asymptotes of $f(x) = ((x - 1)(x^{3} + 1))/(x^{2} - 1)$.
options:
- id: a
  content: |-
    No vertical asymptotes
...
id: q-7
content: |-
  Find the vertical asymptotes of $f(x) = \frac{1}{3x} + \frac{1}{x + 2}$.
options:
- id: a
  content: |-
    No vertical asymptotes
...
id: q-8
content: |-
  Find the vertical asymptotes of $f(x) = \frac{1}{x - 1} - \frac{1}{x + 4}$.
options:
- id: a
  content: |-
    $x =-4$
