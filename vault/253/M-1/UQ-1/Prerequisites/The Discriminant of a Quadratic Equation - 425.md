...
id: q-1
content: |-
  Calculate the discriminant of the quadratic equation $2x^{2} + 3x - 5 = 0$.
options:
- id: a
  content: |-
    $-49$
...
id: q-2
content: |-
  Calculate the discriminant of the quadratic equation $3x^{2} + 2x + 1 = 0$.
options:
- id: a
  content: |-
    $-16$
...
id: q-3
content: |-
  Consider the quadratic equation $x^{2} - 10x + 25 = 0$. How many distinct real solutions does it have?
options:
- id: a
  content: |-
    $2$
...
id: q-5
content: |-
  Find the values of $k$ for which the quadratic equation $x^{2} + kx + 25 = 0$ has one distinct real solution.
options:
- id: a
  content: |-
    $k = ± 100$
...
id: q-6
content: |-
  Find the values of $k$ for which the quadratic equation $-2x^{2} - 8x =-k$ has two distinct real solutions.
options:
- id: a
  content: |-
    $k > - 4$
