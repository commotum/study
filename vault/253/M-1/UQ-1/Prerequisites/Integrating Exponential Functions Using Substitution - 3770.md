...
$$
\begin{aligned}
\int2xe^{x^{2}}dx &= \inte^{x^{2}}2xdx_(⏟)_(du) \\
&= \inte^{u}du \\
&= e^{u} + C \\
&= e^{x^{2}} + C
\end{aligned}
...
$$
\begin{aligned}
\intx^{2}e^{x^{3} + 1}dx &= \inte^{x^{3} + 1} \cdot x^{2}dx \\
&= \inte^{u} \cdot \frac{1}{3}du \\
&= \frac{1}{3}\inte^{u}du \\
&= \frac{1}{3}e^{u} + C \\
&= \frac{1}{3}e^{x^{3} + 1} + C
\end{aligned}
...
&= \frac{1}{2}\ln\begin{vmatrix}u & + C \\ = \frac{1}{2}\ln & e^{2x} + 1\end{vmatrix}+ C \\
