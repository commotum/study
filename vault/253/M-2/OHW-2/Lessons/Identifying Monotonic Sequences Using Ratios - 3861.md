...
- Statement I is true. Computing the ratio $L$, we get
$\frac{a_{n + 1}}{a_{n}}|= (((6^{n + 1})/((n + 5)!)))/(((6^{n})/((n + 4)!))); = (6^{n + 1} \cdot (n + 4)!)/(6^{n} \cdot (n + 5)!); = (6^{n} \cdot 6 \cdot (n + 4)!)/(6^{n} \cdot (n + 5) \cdot (n + 4)!); = (6^{n} \cdot 6 \cdot (n + 4)!)/(6^{n} \cdot (n + 5) \cdot (n + 4)!); = \frac{6}{n + 5}; \le 1$.
- Statement II is false, whereas statement III is true. Since $0\lt L\leq 1$ for all $n\geq 1$, we can conclude that the sequence $a_n$ is decreasing.
...
Given that $a_{n} = (1)/((2n)!)$ for $n \ge 1$, which of the following statements are true?
...
Given that $a_{n} = ((n + 1)!)/(3^{n})$ for $n \ge 1$, which of the following statements are true?
