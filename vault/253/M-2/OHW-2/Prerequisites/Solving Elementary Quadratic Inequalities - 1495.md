...
id: q-1
content: |-
  Solve the inequality $x^{2} > 9$ using a graphical method.
options:
- id: a
  content: |-
    $x ∈ (- ∞,-9)∪(9, ∞)$
...
id: q-2
content: |-
  Solve the inequality $x^{2} < 4$ using a graphical method.
options:
- id: a
  content: |-
    $(- ∞,-2)∪(2, ∞)$
...
id: q-3
content: |-
  Solve the inequality $x^{2} \ge 1$ using the absolute value method.
options:
- id: a
  content: |-
    $x ∈ (- ∞, ∞)$
...
id: q-4
content: |-
  Solve the inequality $x^{2} - 3 > 0$ using the absolute value method.
options:
- id: a
  content: |-
    $x ∈ (- ∞, ∞)$
...
- id: c
  content: |-
    $[MATH: x ∈ (- ∞,-\sqrt{\frac{2}{3}}]∪[\sqrt{\frac{2}{3}}, ∞)]$
- id: d
  content: |-
    $[MATH: x ∈ (- ∞, \frac{2}{3}]]$
- id: e
...
id: q-7
content: |-
  Solve the inequality $x^{2} < - \sqrt{2}$.
options:
- id: a
  content: |-
    $-2 < x < 2$
