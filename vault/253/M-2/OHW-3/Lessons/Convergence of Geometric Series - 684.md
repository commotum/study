...
id: q-1
content: |-
  Which of the following statements is true regarding the series $∑_(n = 1)^(∞)2(0.25)^{2n}$?
options:
- id: a
  content: |-
...
id: q-2
content: |-
  Which of the following statements is true regarding the series $∑_(n = 1)^(∞)9(4)^{n}$?
options:
- id: a
  content: |-
    The series is divergent because $\mid r \mid < 1$.
...
id: q-3
content: |-
  Which of the following statements is true regarding the series $∑_(n = 0)^(∞)(5)^{n}$?
options:
- id: a
  content: |-
    The series is divergent because $\mid r \mid \ge 1$.
...
id: q-4
content: |-
  Which of the following statements is true regarding the series $∑_(n = 2)^(∞)(\frac{1}{4})^{n}$?
options:
- id: a
  content: |-
    The series is divergent because $\mid r \mid < 1$.
...
id: q-7
content: |-
  For which values of $k$ does the series $∑_(n = 1)^(∞)\frac{3^{2n + 1}}{9^{kn}}$ converge?
options:
- id: a
  content: |-
    $k > 0$
...
id: q-8
content: |-
  For which values of $k$ does the series $∑_(n = 1)^(∞)(\frac{3^{k}}{27})^{n}$ converge?
options:
- id: a
  content: |-
    $k < 3$
