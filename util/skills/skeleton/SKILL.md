---
name: skeleton
description: Create Obsidian assignment skeletons in this study vault. Use when the user provides a course folder target, a document or assignment name, and a problem count and wants a WHW-style folder with Prerequisites, Lessons, shared Source, and a same-name markdown index generated from util/Skeleton.
---
...
4. Let the CLI create the document folder, `Prerequisites`, `Lessons`, `Source`, and the same-name markdown file.
5. Verify the result with `find <document-folder> -maxdepth 2 -print` and inspect the first part of the generated markdown.
