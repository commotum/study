...
"""Render the centered magnitude-spectrum stem plot for section-004."""
...
SPEC = {'covered_template': 'magnitude-spectrum-stem-plot',
 'equal_aspect': True,
 'render_notes': ['Centered tutorial spectrum with DC, first-harmonic, and second-harmonic magnitudes all nonnegative.',
                  'Uses the same harmonic-index axis and blue stems as the later practice images.'],
 'show_grid': True,
 'show_origin': True,
 'stems': [(-2, 1.0), (-1, np.float64(2.8284271247461903)), (0, 6.0), (1, np.float64(2.8284271247461903)), (2, 1.0)],
 'x_axis_label': '$k$',
 'x_minor_grid_step': 1,
 'xlim': (-2.7, 2.7),
 'xticks': [-2, -1, 1, 2],
 ...
 'ylim': (-0.4, 6.4),
 'yticks': [1, 2, 3, 4, 5, 6]}
OUTPUT_PATH = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/8.4--computing-fourier-series-coefficients-Images/images/l007-s004-te-section-004.png")
