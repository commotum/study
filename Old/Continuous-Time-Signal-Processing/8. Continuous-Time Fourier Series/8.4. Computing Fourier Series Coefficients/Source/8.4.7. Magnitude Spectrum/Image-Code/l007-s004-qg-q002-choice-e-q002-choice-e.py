...
"""Render the centered magnitude-spectrum stem plot for q002-choice-e."""
...
SPEC = {'covered_template': 'magnitude-spectrum-stem-plot',
 'equal_aspect': True,
 'render_notes': ['Centered distractor spectrum that drops the negative-index harmonic stems.',
                  'Maintains the same axis limits as the other q002 options for direct side-by-side comparison.'],
 'show_grid': True,
 'show_origin': True,
 'stems': [(0, 5.0), (2, 2.0)],
 'x_axis_label': '$k$',
...
OUTPUT_PATH = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/8.4--computing-fourier-series-coefficients-Images/images/l007-s004-qg-q002-choice-e-q002-choice-e.png")
