...
CONFIG = {'kind': 'ordering',
 'figsize': (9.12, 7.68),
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s003-qg-q002-q002.png',
 'xlim': (-1.45, 5.55),
 'ylim': (-0.35, 1.75),
 'fixed': (-0.5, 1.5),
 'moving': (0.05, 2.05),
 'fixed_y': 1.05,
 'moving_y': 0.42,
 'fixed_label': '$x(\\tau)\\text{ support }[-1/2,3/2]$',
 'moving_label': '$h(t-\\tau)\\text{ support }[t-3,t-1]$',
 'endpoint_labels': [(-0.5, '$-1/2$', 1.28), (1.5, '$3/2$', 1.28), (0.05, '$t-3$', 0.66), (2.05, '$t-1$', 0.66)],
 'callouts': [(0.15, 1.57, '$t=5/2$'), (1.55, 1.57, '$t=9/2$'), (2.95, 1.57, '$t=1/2$'), (4.2, 1.57, '$t=5/2$')],
 'bottom_xlim': (-1.1, 5.1)}
OUTPUT_PATH = Path(r'/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s003-qg-q002-q002.png')
