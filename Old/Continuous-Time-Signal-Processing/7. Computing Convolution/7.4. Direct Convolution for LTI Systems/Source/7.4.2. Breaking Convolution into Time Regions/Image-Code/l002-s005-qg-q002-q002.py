...
CONFIG = {'kind': 'bounds_rows',
 'figsize': (9.12, 7.9),
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s005-qg-q002-q002.png',
 'xlim': (0.4, 7.4),
 'ylim': (-0.65, 3.35),
 'axis_y': -0.35,
 'rows': [{'y': 2.35,
           ...
           'fixed_center': 2.5,
           'moving_center': 1.0,
           'fixed_label': '$x(\\tau)\\text{ support }[1,4]$',
          ...
          {'y': 0.15,
           ...
           't_text': '$t=6$',
           'bounds': ('$t-3$', '$4$')}]}
OUTPUT_PATH = Path(r'/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s005-qg-q002-q002.png')
