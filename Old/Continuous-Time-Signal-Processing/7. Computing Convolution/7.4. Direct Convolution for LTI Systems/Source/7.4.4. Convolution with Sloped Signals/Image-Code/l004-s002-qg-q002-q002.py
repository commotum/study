...
plot_signal(ax, [-0.28, 0.0, 0.0, 3.0, 3.0, 3.65], [0.0, 0.0, 3.0, 0.0, 0.0, 0.0])
draw_closed_endpoint(ax, 0.0, 3.0)
draw_closed_endpoint(ax, 3.0, 0.0)

ax.text(0.00, 3.25, r"$(0,3)$", fontsize=15, ha="center", va="bottom", color=LABEL_COLOR)
ax.text(3.00, 0.25, r"$(3,0)$", fontsize=15, ha="center", va="bottom", color=LABEL_COLOR)
ax.text(1.55, 1.65, r"$x(\tau)$", fontsize=18, ha="center", va="bottom", color=LABEL_COLOR)
ax.text(1.50, -0.30, r"$0\leq \tau\leq 3$", fontsize=15, ha="center", va="top", color=ANNOTATION_COLOR)

Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l004-s002-qg-q002-q002.png').parent.mkdir(parents=True, exist_ok=True)
plt.tight_layout()
fig.savefig('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l004-s002-qg-q002-q002.png', bbox_inches="tight", facecolor="white")
plt.close(fig)
