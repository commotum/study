...
ax.text(-0.2, 0.73, '$t-1$', fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR)
ax.text(0.8, 0.73, '$t$', fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR)

ax.text((0.0 + 0.8) / 2.0, 0.98, r"overlap", fontsize=15, ha="center", va="center", color=ANNOTATION_COLOR)
ax.text(0.0, 0.02, '$\\max(0,t-1)=0$', fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR)
ax.text(0.8, 0.02, '$\\min(2,t)=t$', fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR)
ax.text(1.45, 1.68, '$0\\leqq t\\leqq 1$', fontsize=15, ha="center", va="bottom", color=LABEL_COLOR)

Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l004-s003-te-section-003.png').parent.mkdir(parents=True, exist_ok=True)
plt.tight_layout()
fig.savefig('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l004-s003-te-section-003.png', bbox_inches="tight", facecolor="white")
plt.close(fig)
