...
ax.axvspan(1.5, 2.0, color=SIGNAL_COLOR, alpha=0.12, zorder=1)

ax.plot([0.0, 2.0], [1.20, 1.20], color=SIGNAL_COLOR, linewidth=10, solid_capstyle="butt", zorder=4)
ax.plot([1.5, 2.5], [0.45, 0.45], color=SIGNAL_COLOR, linewidth=10, solid_capstyle="butt", zorder=4)

draw_dotted_guide(ax, [0.0, 0.0], [0.10, 1.20])
draw_dotted_guide(ax, [2.0, 2.0], [0.10, 1.20])
draw_dotted_guide(ax, [1.5, 1.5], [0.10, 0.45])
draw_dotted_guide(ax, [2.5, 2.5], [0.10, 0.45])

ax.text((0.0 + 2.0) / 2.0, 1.38, '$x(\\tau)\\neq0$ on $[0,2]$', fontsize=16, ha="center", va="bottom", color=LABEL_COLOR)
ax.text((1.5 + 2.5) / 2.0, 0.63, '$h(t-\\tau)\\neq0$ on $[t-1,t]$', fontsize=16, ha="center", va="bottom", color=LABEL_COLOR)

ax.text(0.0, 1.55, '$0$', fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR)
ax.text(2.0, 1.55, '$2$', fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR)
ax.text(1.5, 0.73, '$t-1$', fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR)
ax.text(2.5, 0.73, '$t$', fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR)

ax.text((1.5 + 2.0) / 2.0, 0.98, r"overlap", fontsize=15, ha="center", va="center", color=ANNOTATION_COLOR)
ax.text(1.5, 0.02, '$\\max(0,t-1)=t-1$', fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR)
ax.text(2.0, 0.02, '$\\min(2,t)=2$', fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR)
ax.text(2.45, 1.68, '$2\\leqq t\\leqq 3$', fontsize=15, ha="center", va="bottom", color=LABEL_COLOR)

Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l004-s003-qg-q002-q002.png').parent.mkdir(parents=True, exist_ok=True)
plt.tight_layout()
fig.savefig('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l004-s003-qg-q002-q002.png', bbox_inches="tight", facecolor="white")
plt.close(fig)
