...
def main():
    ...
    ax.text(x0 - 0.48, h_left / 2, '$3$', fontsize=16, ha="right", va="center", color=LABEL_COLOR)
    ax.text(x1 + 0.48, h_right / 2, '$t+2$', fontsize=16, ha="left", va="center", color=LABEL_COLOR)
    ax.text((x0 + x1) / 2, -0.12, '1 <= t <= 2', fontsize=15, ha="center", va="top", color=LABEL_COLOR)
    plt.tight_layout()
    Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l005-s004-qg-q001-q001.png').parent.mkdir(parents=True, exist_ok=True)
    fig.savefig('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l005-s004-qg-q001-q001.png', bbox_inches="tight", facecolor="white")
    plt.close(fig)
