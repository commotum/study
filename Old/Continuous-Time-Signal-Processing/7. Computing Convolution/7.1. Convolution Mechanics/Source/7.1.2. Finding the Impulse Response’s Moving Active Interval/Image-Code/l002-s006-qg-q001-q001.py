...
def build_figure():
    ...
    draw_panel(
        ...
        support_left=2.0,
        support_right=8.0,
        endpoint_labels=(r"$t-4$", r"$t-1$"),
        axis_label=r"$\tau$",
        function_label=r"$h(t-\tau)$",
        annotations=[
            (2.0, 0.50, r"$u=4 \mapsto \tau=t-4$", "center"),
            (8.0, 0.50, r"$u=1 \mapsto \tau=t-1$", "center"),
...
def main():
    ...
    output_path = Path(
        ...
        "7.1--convolution-mechanics-Images/images/l002-s006-qg-q001-q001.png"
    )
