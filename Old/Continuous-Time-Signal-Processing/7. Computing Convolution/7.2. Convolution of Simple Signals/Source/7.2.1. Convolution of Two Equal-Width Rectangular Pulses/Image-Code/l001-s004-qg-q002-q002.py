...
def main():
    ...
    draw_note(ax, 2.0, 1.04, '$[0,\\,4]$', ha='center', va='center', size=14)
    draw_note(ax, 4.0, 0.22, '$[t-4,\\,t]$', ha='center', va='center', size=14)
    draw_note(ax, 3.0, 0.94, '$L(t)$', ha='center', va='center', size=15)
    save(fig, '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l001-s004-qg-q002-q002.png')
