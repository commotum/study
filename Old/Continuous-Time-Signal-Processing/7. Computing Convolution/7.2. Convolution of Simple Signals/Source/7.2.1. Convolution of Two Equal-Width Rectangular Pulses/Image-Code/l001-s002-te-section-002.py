...
def main():
    configure()
    fig, axes = plt.subplots(1, 3, figsize=(13.8, 4.7), dpi=160, sharey=True)
    panels = [{'title': 'first contact\n$t = 0$', 'fixed': (0, 4), 'moving': (-4, 0), 'overlap': None, 'xticks': [(-4, '$-4$'), (0, '$0$'), (4, '$4$'), (8, '$8$')], 'marks': [{'x': -4, 'y0': 0.0, 'y1': 1.1, 'label': '$t-T$', 'label_y': 1.48}, {'x': 0, 'y0': 0.0, 'y1': 1.1, 'label': '$t$', 'label_y': 1.48}]}, {'title': 'peak alignment\n$t = T$', 'fixed': (0, 4), 'moving': (0, 4), 'overlap': (0, 4), 'xticks': [(-4, '$-4$'), (0, '$0$'), (4, '$4$'), (8, '$8$')], 'marks': [{'x': 0, 'y0': 0.0, 'y1': 1.1, 'label': '$t-T$', 'label_y': 1.48}, {'x': 4, 'y0': 0.0, 'y1': 1.1, 'label': '$t$', 'label_y': 1.48}]}, {'title': 'last contact\n$t = 2T$', 'fixed': (0, 4), 'moving': (4, 8), 'overlap': None, 'xticks': [(-4, '$-4$'), (0, '$0$'), (4, '$4$'), (8, '$8$')], 'marks': [{'x': 4, 'y0': 0.0, 'y1': 1.1, 'label': '$t-T$', 'label_y': 1.48}, {'x': 8, 'y0': 0.0, 'y1': 1.1, 'label': '$t$', 'label_y': 1.48}]}]
    for ax, panel in zip(axes, panels):
        draw_panel(ax, panel)
    fig.subplots_adjust(wspace=0.24)
    save(fig, '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l001-s002-te-section-002.png')
