...
def main():
    ...
    draw_note(ax, 2.0, 1.02, '$A$', ha='center', va='center', size=15)
    draw_note(ax, 1.0, 0.2, '$B$', ha='center', va='center', size=15)
    draw_note(ax, 1.5, 0.95, '$AB$', ha='center', va='center', size=15)
    save(fig, '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l001-s005-te-section-005.png')
