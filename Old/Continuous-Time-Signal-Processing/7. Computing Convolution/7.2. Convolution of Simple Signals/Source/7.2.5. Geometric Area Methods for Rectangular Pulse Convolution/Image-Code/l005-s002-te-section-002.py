...
OUTPUT_PATH = r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l005-s002-te-section-002.png"
...
def main():
    render_single_overlap_scene(
        ...
        moving_interval=(1, 6),
        moving_height=3,
        moving_label='$h(t-\\tau)=3$',
        overlap_start=1,
        overlap_end=4,
        width_label='$4-1=3$',
        product_text='$6$',
        lower_texts=[
            (0.4, -0.46, r"Fixed-time geometric area"),
        ],
    )
