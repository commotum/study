...
OUTPUT_PATH = r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l005-s004-te-section-004.png"

def main():
    render_sequence_scene(
        OUTPUT_PATH,
        panels=[{'panel_label': '$t<0$', 'moving_interval': (-2, 0), 'overlap_interval': (0, 0), 'length_label': '$0$', 'no_overlap_text': '$0$', 'show_ylabel': True, 'show_origin': True}, {'panel_label': '$0<t<2$', 'moving_interval': (0, 2), 'overlap_interval': (0, 2), 'length_label': '$t$', 'show_ylabel': False, 'show_origin': False}, {'panel_label': '$2<t<5$', 'moving_interval': (1.5, 3.5), 'overlap_interval': (1.5, 3.5), 'length_label': '$2$', 'show_ylabel': False, 'show_origin': False}, {'panel_label': '$5<t<7$', 'moving_interval': (4, 6), 'overlap_interval': (4, 5), 'length_label': '$7-t$', 'show_ylabel': False, 'show_origin': False}, {'panel_label': '$t=7$', 'moving_interval': (5.2, 7.2), 'overlap_interval': (0, 0), 'length_label': '$0$', 'no_overlap_text': '$0$', 'show_ylabel': False, 'show_origin': False}],
        xlim=(-2.4, 7.6),
        ylim=(-0.7, 1.75),
        xticks=[0, 2, 5, 7],
        yticks=[0, 1],
