...
CONFIG = {'kind': 'timeline',
 ...
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l002-s002-te-section-002.png',
 'figsize': (9.6, 7.2),
 'top_panel': {'xlim': (-2.8, 5.8),
               ...
               'brackets': [{'start': 0.0,
                             'end': 4.0,
                             'y': -0.46,
                             'label': '$0\\leq \\tau\\leq 4$'},
                            {'start': -2.0,
                             'end': 5.0,
                             'y': -0.46,
                             'label': '$t-7\\leq \\tau\\leq t$'}],
               'edge_labels': [{'x': 0.0, 'y': -0.16, 'text': '$0$', 'fontsize': 15, 'va': 'top'},
                               ...
                               {'x': -2.0,
                                ...
                                'fontsize': 15,
                                'va': 'top'},
                               {'x': 5.0, 'y': -0.16, 'text': '$t$', 'fontsize': 15, 'va': 'top'}]},
 'timeline': {'xlim': (-0.5, 11.5),
              'breakpoints': [0.0, 4.0, 7.0, 11.0],
              'labels': {0.0: '$0$', 4.0: '$4$', 7.0: '$7$', 11.0: '$11$'},
              'region_labels': [{'x': 0.0, 'y': 0.22, 'text': 'first contact', 'fontsize': 13},
                                ...
                                {'x': 7.0,
                                 ...
                                 'fontsize': 13},
                                {'x': 11.0, 'y': 0.22, 'text': 'last contact', 'fontsize': 13}],
              'axis_label': '$t$'},
 'python_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/code/l002-s002-te-section-002.py',
 'slot_key': 'l002-s002-te-section-002',
 'lesson_index': 2,
