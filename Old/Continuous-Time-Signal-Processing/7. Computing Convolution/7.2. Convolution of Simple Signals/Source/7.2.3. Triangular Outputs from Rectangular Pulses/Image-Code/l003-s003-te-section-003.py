...
def main():
    ...
    image_output_path = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l003-s003-te-section-003.png")
    image_output_path.parent.mkdir(parents=True, exist_ok=True)

    fig = plt.figure(figsize=(9.6, 7.8), dpi=DPI)
    gs = fig.add_gridspec(2, 1, height_ratios=[1.25, 0.82], hspace=0.28)
    ...
    ax_main.text((overlap_left + overlap_right) / 2, 0.20, r"overlap length t", fontsize=13, color=ANNOTATION_COLOR, ha="center", va="bottom")
    ...
    ax_main.text(0.5, 1.03, r"Rising overlap region and output branch", transform=ax_main.transAxes, fontsize=15, color=LABEL_COLOR, ha="center", va="bottom")
    ...
    draw_line_segment(ax_branch, 0, 0, 2, 12)
    ax_branch.text(1.0, 12.12, r"y(t)=6t", fontsize=14.5, color=LABEL_COLOR, ha="center", va="bottom")
