...
SPEC = {'layout': 'two-panel',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l002-s002-te-section-002.png',
 'xlim': [-5.0, 5.0],
 'ylim': [-0.8, 2.8],
 'xticks': [-4, -2, 2, 4],
 'yticks': [1, 2],
 'left': {'components': [{'kind': 'spike', 't': 3, 'height': 2, 'base': 0.0}],
          'texts': [],
          'y_label': '$x(t)$',
          'x_label': '$t$',
          'y_tick_label_side': 'left'},
 'right': {'components': [{'kind': 'spike', 't': -3, 'height': 2, 'base': 0.0}],
           'texts': [],
           'y_label': '$x(-t)$',
           'x_label': '$t$',
           'y_tick_label_side': 'left'},
 'template': 'two-panel-peak-reflection',
 'notes': ['original and reflected peak shown side by side'],
 'show_grid': True,
 'show_origin': True,
 'equal_aspect': True,
 'gap_px': 46}
