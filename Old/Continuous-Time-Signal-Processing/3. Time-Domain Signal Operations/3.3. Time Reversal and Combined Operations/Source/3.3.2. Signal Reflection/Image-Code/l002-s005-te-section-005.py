...
SPEC = {'layout': 'two-panel',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l002-s005-te-section-005.png',
 'xlim': [-3.5, 3.5],
 'ylim': [-2.8, 3.8],
 'xticks': [-3, -2, -1, 0, 1, 2, 3],
 'yticks': [-2, -1, 1, 2, 3],
 'left': {'components': [{'kind': 'spike', 't': 0, 'height': 3, 'base': 0.0},
                         {'kind': 'pulse', 'start': -2.3, 'end': -1.7, 'height': 1, 'base': 0.0},
                         {'kind': 'pulse', 'start': 1.7, 'end': 2.3, 'height': 1, 'base': 0.0}],
          'texts': [],
          'y_label': '$x(t)$',
          'x_label': '$t$',
          'y_tick_label_side': 'left'},
 'right': {'components': [{'kind': 'spike', 't': 0, 'height': 3, 'base': 0.0},
                          {'kind': 'pulse', 'start': -2.3, 'end': -1.7, 'height': 1, 'base': 0.0},
                          {'kind': 'pulse', 'start': 1.7, 'end': 2.3, 'height': 1, 'base': 0.0}],
           'texts': [],
           'y_label': '$x(-t)$',
           'x_label': '$t$',
           'y_tick_label_side': 'left'},
 'template': 'two-panel-fixed-point-reflection',
 'notes': ['feature at t=0 stays fixed while symmetric pulses remain aligned'],
 'show_grid': True,
 'show_origin': True,
 'equal_aspect': True,
 'gap_px': 46}
