...
SPEC = {'layout': 'two-panel',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l002-s004-te-section-004.png',
 'xlim': [-4.8, 4.8],
 'ylim': [-3.2, 3.8],
 'xticks': [-4, -2, 0, 2, 4],
 'yticks': [-3, -1, 1, 2, 3],
 'left': {'components': [{'kind': 'spike', 't': -2, 'height': 3, 'base': 0.0},
                         {'kind': 'spike', 't': 1, 'height': -1, 'base': 0.0},
                         {'kind': 'pulse', 'start': 3, 'end': 4, 'height': 2, 'base': 0.0}],
          'texts': [],
          'y_label': '$x(t)$',
          'x_label': '$t$',
          'y_tick_label_side': 'left'},
 'right': {'components': [{'kind': 'spike', 't': 2, 'height': 3, 'base': 0.0},
                          {'kind': 'spike', 't': -1, 'height': -1, 'base': 0.0},
                          {'kind': 'pulse', 'start': -4, 'end': -3, 'height': 2, 'base': 0.0}],
           'texts': [],
           'y_label': '$x(-t)$',
           'x_label': '$t$',
           'y_tick_label_side': 'left'},
 'template': 'two-panel-multi-feature-reflection',
 'notes': ['multiple separated features shown before and after reflection'],
 'show_grid': True,
 'show_origin': True,
 'equal_aspect': True,
 'gap_px': 46}
