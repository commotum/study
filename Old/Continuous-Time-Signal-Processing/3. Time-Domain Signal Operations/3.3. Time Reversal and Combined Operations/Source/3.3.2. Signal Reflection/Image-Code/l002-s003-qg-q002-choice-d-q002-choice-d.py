...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l002-s003-qg-q002-choice-d-q002-choice-d.png',
 'xlim': [-5.5, 5.5],
 'ylim': [-3.5, 3.5],
 'xticks': [-5, -2, -1, 0, 1, 2, 5],
 'yticks': [-3, -2, -1, 1, 2, 3],
 'components': [{'kind': 'segment', 'points': [[-5, 0], [-4, 3], [-1, 0]]}],
 'texts': [],
 'template': 'triangle-reflection-plot',
 'notes': ['triangle shifted left without time reversal'],
 'y_label': '$x(t)$',
 'y_tick_label_side': 'left',
 'show_grid': True,
 'show_origin': True,
