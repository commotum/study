"""Generated matplotlib figure for l006-s006-te-section-001."""
...
OUTPUT_PATH = Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l006-s006-te-section-001.png')

def main():
    panel_specs = [{'xlim': (-0.5, 8.5), 'xticks': [0, 6, 8], 'signal_label': '$x(t)$', 'pulse': {'start': 0, 'peak': 6, 'end': 8}}, {'xlim': (-0.5, 8.5), 'xticks': [2, 5, 6], 'signal_label': '$y_1(t)$', 'pulse': {'start': 2, 'peak': 5, 'end': 6}}, {'xlim': (-0.5, 8.5), 'xticks': [1, 4, 5], 'signal_label': '$y_2(t)$', 'pulse': {'start': 1, 'peak': 4, 'end': 5}}]
