...
OUTPUT_PATH = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.1--time-shifting-Images/images/l001-s002-qg-q002-q002.png")
...
def main():
    ...
    draw_triangle_signal(ax_l, *(-3.0, -2.0, -1.0, 3.0))
    draw_triangle_signal(ax_r, *(2.0, 3.0, 4.0, 3.0))
    label_point(ax_l, -2.0, 3.0, '$-2$', dx=0.0, dy=0.3, ha='center', va='bottom')
    label_point(ax_r, 3.0, 3.0, '$3$', dx=0.0, dy=0.3, ha='center', va='bottom')

    fig.canvas.draw()

    draw_cross_panel_arrow(fig, ax_l, ax_r, -2.0, 3.0, 3.0, label='$5$', label_offset=(0.0, 0.014))
