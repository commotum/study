...
OUTPUT_PATH = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.1--time-shifting-Images/images/l001-s005-qg-q001-q001.png")
...
def main():
    ...
    draw_triangle_signal(ax, *(-2.0, 0.0, 5.0, 2.0))
    label_point(ax, -2.0, 0.0, '$-2$', dx=-0.08, dy=-0.3, ha='right', va='top')
    label_point(ax, 0.0, 2.0, '$0$', dx=0.0, dy=0.28, ha='center', va='bottom')
    label_point(ax, 5.0, 0.0, '$5$', dx=0.08, dy=-0.3, ha='left', va='top')
    draw_shift_arrow(ax, -0.2, 4.2, 2.55, label='$4$')
