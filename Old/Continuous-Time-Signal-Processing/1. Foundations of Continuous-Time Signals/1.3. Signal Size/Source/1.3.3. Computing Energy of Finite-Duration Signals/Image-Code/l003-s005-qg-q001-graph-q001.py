...
def render():
    ...
    plot_signal(ax, np.array([0.0, 1.0, 2.0]), np.array([0.0, 1.0, 0.0]))

    label_text(ax, 0.06, -0.26, r"$t=0$", ha="left", va="top")
    label_text(ax, 1.0, 1.08, r"$(1,1)$", ha="center", va="bottom")
    label_text(ax, 2.0, -0.26, r"$t=2$", ha="center", va="top")

    save_figure(
        fig,
        "/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.3--signal-size-Images/images/l003-s005-qg-q001-graph-q001.png",
    )
    plt.close(fig)
