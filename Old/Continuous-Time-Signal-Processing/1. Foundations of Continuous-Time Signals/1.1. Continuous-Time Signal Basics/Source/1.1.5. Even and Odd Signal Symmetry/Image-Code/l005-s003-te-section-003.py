...
def main():
    ...
    plot_signal(ax, t, x)
    mark_points(ax, [-1, 1], [-1, 1])
    ax.plot(0, 0, marker="o", markersize=HIGHLIGHT_SIZE, markerfacecolor="white",
            markeredgecolor=SIGNAL_COLOR, markeredgewidth=2.0)

    output_path = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l005-s003-te-section-003.png")
