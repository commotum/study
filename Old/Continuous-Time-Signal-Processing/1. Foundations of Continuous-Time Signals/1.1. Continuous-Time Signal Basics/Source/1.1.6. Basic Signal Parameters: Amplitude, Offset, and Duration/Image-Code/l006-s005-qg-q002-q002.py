...
OUTPUT_PATH = Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l006-s005-qg-q002-q002.png')
...
def main():
    ...
    t = np.array([-3, -2, -2, -1, 0, 2, 4, 4, 5], dtype=float)
    x = np.array([0, 0, -5, 3, -5, 3, 0, 0, 0], dtype=float)
    plot_signal(ax, t, x)
    draw_dotted_guide(ax, [-2, 4], [-1, -1])
