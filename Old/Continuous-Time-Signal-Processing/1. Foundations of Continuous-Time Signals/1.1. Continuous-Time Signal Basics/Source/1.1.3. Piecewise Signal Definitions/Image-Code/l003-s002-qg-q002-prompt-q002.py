...
OUTPUT_PATH = r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l003-s002-qg-q002-prompt-q002.png"
...
def main():
    ...
    plot_signal(ax, [0, 2], [-1, -1])
    plot_signal(ax, [2, 5], [4, 4])
    draw_closed_endpoint(ax, 0, -1)
    draw_open_endpoint(ax, 2, -1)
    draw_closed_endpoint(ax, 2, 4)
    draw_closed_endpoint(ax, 5, 4)
