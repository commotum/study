...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s002-qg-q001-choice-a-q001-choice-a.png',
 'panel': {'segments': [(-1, 0, 1, True, False), (0, 2, 3, True, True)],
           'xlim': (-1.85, 2.85),
           'ylim': (-0.7, 3.7),
           'xticks': [-1, 0, 2],
           'yticks': [1, 3],
