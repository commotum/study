...
SPEC = {'kind': 'stacked',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s002-te-section-002.png',
 'xlim': (-3.85, 3.85),
 'panel_ylims': [(-0.7, 2.7), (-0.7, 2.7)],
 'panels': [{'segments': [(1, 2, 1, True, False), (2, 3, 2, True, True)],
             'xlim': (-0.85, 3.85),
             'ylim': (-0.7, 2.7),
             'xticks': [1, 2, 3],
             'yticks': [1, 2],
             ...
             'horizontal_lines': [],
             'texts': []},
            {'segments': [(-3, -2, 2, True, False), (-2, -1, 1, True, True)],
             'xlim': (-3.85, 0.85),
             'ylim': (-0.7, 2.7),
             'xticks': [-3, -2, -1],
             'yticks': [1, 2],
             ...
             'texts': []}],
 'gap_px': 52,
 'fig_texts': [{'x': 0.27, 'y': 0.515, 'text': '$1\\to -1$', 'fontsize': 17, 'ha': 'center', 'va': 'center'},
               {'x': 0.5, 'y': 0.515, 'text': '$2\\to -2$', 'fontsize': 17, 'ha': 'center', 'va': 'center'},
               {'x': 0.73, 'y': 0.515, 'text': '$3\\to -3$', 'fontsize': 17, 'ha': 'center', 'va': 'center'}],
 'fig_arrows': []}
