...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s005-qg-q001-prompt-q001.png',
 'panel': {'segments': [(1, 4, 3, True, True)],
           'xlim': (-0.85, 4.85),
           'ylim': (-1.25, 3.7),
           'xticks': [0, 1, 4],
           'yticks': [3],
           ...
           'baseline': 0.0,
           'reflection_axis': None,
           'shade_regions': [{'x_left': 1, 'x_right': 4, 'alpha': 0.09}],
           'support_brackets': [{'start': 1, 'end': 4, 'y': -0.45, 'label': '3'}],
           'vertical_lines': [],
           'horizontal_lines': [],
           'texts': [{'x': -0.7999999999999999,
                      'y': 3.6500000000000004,
                      'text': '$p(\\tau)=x(\\tau)h(2-\\tau)$',
                      'fontsize': 17,
                      'ha': 'left',
                      'va': 'top'},
                     {'x': -0.7999999999999999,
                      'y': 3.4000000000000004,
                      'text': '$\\int_{-\\infty}^{\\infty} p(\\tau)\\,d\\tau$',
                      'fontsize': 17,
                      'ha': 'left',
                      'va': 'top'}]},
 'fig_texts': [],
