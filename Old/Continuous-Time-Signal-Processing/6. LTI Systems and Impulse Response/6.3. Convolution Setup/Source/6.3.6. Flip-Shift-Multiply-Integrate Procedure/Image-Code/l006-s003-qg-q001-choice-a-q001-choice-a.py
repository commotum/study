...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s003-qg-q001-choice-a-q001-choice-a.png',
 'panel': {'segments': [(-7, -5, 2, True, False), (-5, -4, 1, True, True)],
           'xlim': (-7.85, 0.85),
           'ylim': (-0.7, 2.7),
           'xticks': [-7, -5, -4],
           'yticks': [1, 2],
