...
SPEC = {'kind': 'stacked',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s003-te-section-003.png',
 'xlim': (-4.85, 1.85),
 'panel_ylims': [(-0.7, 2.7), (-0.7, 2.7)],
 'panels': [{'segments': [(-4, -2, 2, True, False), (-2, -1, 1, True, True)],
             'xlim': (-4.85, 0.85),
             'ylim': (-0.7, 2.7),
             'xticks': [-3, -2, -1],
             'yticks': [1, 2],
             ...
             'horizontal_lines': [],
             'texts': []},
            {'segments': [(-1, 0, 2, True, False), (0, 1, 1, True, True)],
             'xlim': (-1.85, 1.85),
             'ylim': (-0.7, 2.7),
             'xticks': [-1, 0, 1],
             'yticks': [1, 2],
 ...
 'fig_texts': [{'x': 0.62,
                'y': 0.535,
                'text': 'shift right by $2$',
                'fontsize': 17,
                'ha': 'center',
                'va': 'center'},
               {'x': 0.3, 'y': 0.48, 'text': '$-3\\to -1$', 'fontsize': 16, 'ha': 'center', 'va': 'center'},
               {'x': 0.5, 'y': 0.48, 'text': '$-2\\to 0$', 'fontsize': 16, 'ha': 'center', 'va': 'center'},
               {'x': 0.7, 'y': 0.48, 'text': '$-1\\to 1$', 'fontsize': 16, 'ha': 'center', 'va': 'center'}],
 'fig_arrows': [{'x1': 0.46, 'y1': 0.535, 'x2': 0.54, 'y2': 0.535, 'lw': 2.0}]}
