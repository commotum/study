...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s002-qg-q001-choice-e-q001-choice-e.png',
 'panel': {'segments': [(0, 2, 3, True, True), (2, 3, 1, False, True)],
           'xlim': (-0.85, 3.85),
           'ylim': (-0.7, 3.7),
           'xticks': [0, 1, 2, 3],
           'yticks': [1, 3],
