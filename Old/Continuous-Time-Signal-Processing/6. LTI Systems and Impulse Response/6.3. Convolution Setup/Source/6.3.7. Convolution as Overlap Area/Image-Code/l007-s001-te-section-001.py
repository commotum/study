...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l007-s001-te-section-001.png',
 'figure_size': (10.2, 10.8),
 'panels': [{'xlim': (-0.4, 4.4),
             'ylim': (-0.35, 1.65),
             'xticks': [0, 1, 2, 3, 4],
             'yticks': [1],
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 0, 'end': 3, 'height': 1},
             'overlap': {'start': 1, 'end': 3, 'height': 1, 'fill_alpha': 0.22},
             'texts': [{'text': '$x(\\tau)$', 'x': 1.45, 'y': 1.22, 'fontsize': 15},
                       {'text': 'overlap 1<=tau<=3',
                        'x': 2.0,
                        'y': 0.45,
                        'fontsize': 14}]},
            {'xlim': (-0.4, 4.4),
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 1, 'end': 4, 'height': 2},
             'overlap': {'start': 1, 'end': 3, 'height': 2, 'fill_alpha': 0.22},
             'texts': [{'text': '$h(t_0-\\tau)$', 'x': 2.35, 'y': 2.34, 'fontsize': 15},
                       {'text': 'overlap 1<=tau<=3',
                        'x': 2.0,
                        'y': 0.82,
                        'fontsize': 14}]},
            {'xlim': (-0.4, 4.4),
             ...
             'yticks': [2],
             'x_label': '$\\tau$',
             'y_label': '$x(\\tau)h(t_0-\\tau)$',
             'zero_line': False,
             'y_tick_label_side': 'left',
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 1, 'end': 3, 'height': 2, 'fill_alpha': 0.18},
             'texts': [{'text': '$x(\\tau)h(t_0-\\tau)$',
                        'x': 2.0,
                        'y': 2.18,
                        'fontsize': 15}],
             'annotations': [{'text': 'area that becomes y(t_0)',
                              'xy': (2.0, 1.0),
                              'xytext': (3.35, 1.92),
