...
OUTPUT = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.3--stability-of-lti-systems-Images/images/l001-s003-qg-q002-graph-q002.png")
...
plot_signal(ax, np.array([-2.3, 0.0]), np.array([0.0, 0.0]))
plot_signal(ax, np.array([0.0, 0.0]), np.array([0.0, 1.25]))
t_tail = np.linspace(0.0, 3.8, 320)
y_tail = 1.0 * np.exp(-0.92 * t_tail)
