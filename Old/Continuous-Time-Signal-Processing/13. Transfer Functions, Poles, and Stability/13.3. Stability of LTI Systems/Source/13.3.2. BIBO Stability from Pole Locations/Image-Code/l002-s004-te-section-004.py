...
if __name__ == "__main__":
    output_path = Path(
        "/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.3--stability-of-lti-systems-Images/images/l002-s004-te-section-004.png"
    )
    poles = np.array([-1.0 + 0.0j, -4.0 + 0.0j, 0.8 + 0.0j])
    zeros = np.array([0.0 + 2.0j, 0.0 - 2.0j])
    render(output_path, poles, zeros, r"Stability depends on pole real parts only.")
