...
def label(ax, text, x, y, *, color=LABEL_COLOR, size=12.0, ha="center", va="center"):
...
def main():
    ...
    out = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.5--circuit-transfer-functions-Images/images/l003-s001-te-section-001.png")
