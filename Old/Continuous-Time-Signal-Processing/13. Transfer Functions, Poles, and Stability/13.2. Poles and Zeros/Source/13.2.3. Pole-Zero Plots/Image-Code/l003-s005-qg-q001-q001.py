...
def main():
    ...
    setup_axes(ax, xlim=xlim, ylim=ylim, xticks=[-5, -4, -3, -2, -1, 1, 2, 3, 4, 5], yticks=[-4, -3, -2, -1, 1, 2, 3, 4])
    save_figure(fig, Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l003-s005-qg-q001-q001.png'))
