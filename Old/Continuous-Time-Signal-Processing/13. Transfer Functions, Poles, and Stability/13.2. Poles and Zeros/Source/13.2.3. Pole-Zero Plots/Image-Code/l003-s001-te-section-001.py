...
def main():
    ...
    setup_axes(ax, xlim=xlim, ylim=ylim, xticks=[-3, -2, -1, 1, 2, 3], yticks=[-2, -1, 1, 2])
    draw_zero(ax, -1.0, 0.0, label='zero', label_offset=(0.16, 0.14))
    draw_pole(ax, -2.0, 0.0, label='pole', label_offset=(0.16, -0.28))
    save_figure(fig, Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l003-s001-te-section-001.png'))
