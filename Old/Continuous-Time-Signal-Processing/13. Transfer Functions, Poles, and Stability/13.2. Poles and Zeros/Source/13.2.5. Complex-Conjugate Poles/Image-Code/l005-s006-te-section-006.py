...
def main():
    output_path = Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l005-s006-te-section-006.png')
    fig, ax = make_figure((-5.5, 2.5), (-5.5, 5.5))
    setup_axes(
        ax,
        xlim=(-5.5, 2.5),
        ylim=(-5.5, 5.5),
    ...
    draw_pole(ax, -2, 4)
    add_label(ax, -2, 4, r"$(-2, 4)$", dx=0.18, dy=0.20, va="bottom")
    draw_pole(ax, -2, -4)
    add_label(ax, -2, -4, r"$(-2, -4)$", dx=0.18, dy=-0.36, va="top")
