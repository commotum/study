...
CONFIG = {'covered_template': 's-plane-multi-pole-comparison', 'xlim': (-7.5, 2.5), 'ylim': (-7.5, 7.5), 'xticks': [-7, -5, -3, -1, 1, 2], 'yticks': [-6, -4, -2, 2, 4, 6], 'x_axis_label': '$\\sigma$', 'y_axis_label': '$\\omega$', 'poles': [{'x': -5, 'y': 0, 'label': '$-5$', 'label_offset': (-0.25, 0.28), 'label_ha': 'left', 'label_va': 'bottom'}, {'x': -2, 'y': 6, 'label': '$-2+j6$', 'label_offset': (0.1, 0.25), 'label_ha': 'left', 'label_va': 'bottom'}, {'x': -2, 'y': -1, 'label': '$-2-j1$', 'label_offset': (0.1, -0.6), 'label_ha': 'left', 'label_va': 'top'}], 'annotations': [{'text': '$\\sigma=-5$', 'xy': (-5, 0), 'xytext': (-6.6, 1.45), 'arrow': True, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 10}, {'text': '$\\sigma=-2,\\ \\omega=6$', 'xy': (-2, 6), 'xytext': (-1.95, 6.9), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 10}, {'text': '$\\sigma=-2,\\ \\omega=-1$', 'xy': (-2, -1), 'xytext': (-1.95, -2.1), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 10}], 'render_notes': ['Three-pole comparison plot that labels each pole with its coordinate pair.', 'The layout encourages comparison by real part first, then oscillation frequency.'], 'show_grid': True, 'show_origin': True, 'x_minor_grid_step': 1, 'y_minor_grid_step': 1, 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l007-s006-qg-q001-q001.png'}
