...
OUTPUT_PATH = Path(
    "/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/10.3--rc-filters-Images/images/l009-s001-te-section-001-rc-comparison-plot.png"
)

MODE = "comparison"
SHOW_CURVE_LABELS = True
SHOW_FREQUENCY_END_LABELS = True
