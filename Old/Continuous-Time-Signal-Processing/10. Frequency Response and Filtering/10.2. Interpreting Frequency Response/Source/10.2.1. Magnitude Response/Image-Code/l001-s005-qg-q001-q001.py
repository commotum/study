...
def build_curve():
    ...
    anchors_x = np.array([0.0, 1.0, 1.9, 2.8, 3.6, 4.4, 5.2, 6.0, 7.0, 8.0, 9.0])
    anchors_y = np.array([1.60, 1.58, 1.34, 1.18, 1.06, 1.00, 0.97, 0.86, 0.70, 0.50, 0.35])
...
def main():
    ...
    save_figure(
        fig,
        "/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/10.2--interpreting-frequency-response-Images/images/l001-s005-qg-q001-q001.png",
    )
