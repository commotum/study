...
def main():
    ...
    draw_point(ax, -2, 3, '$s=-2+j3$')
    draw_projection(ax, -2, 3)
    draw_point(ax, 0, 3, '$s=j3$')
    draw_projection(ax, 0, 3)
    draw_point(ax, 2, 3, '$s=2+j3$')
    draw_projection(ax, 2, 3)

    output_path = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/11.1--motivation-for-the-laplace-transform-Images/images/l006-s004-te-section-004.png")
