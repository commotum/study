...
def main():
    ...
    draw_point(ax, 0, -2, '$s=-2j$')
    draw_annotation(ax, "$\\sigma=0$", 0.6, -2.55, ha='left', va='top', size=ANNOTATION_SIZE * 0.9)

    output_path = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/11.1--motivation-for-the-laplace-transform-Images/images/l006-s005-qg-q001-point-q001.png")
