...
def main():
    ...
    draw_point(ax, 5, -3, '$s=5-3j$')
    draw_annotation(ax, "$\\sigma\\neq 0$", 3.7, -3.85, ha='left', va='top', size=ANNOTATION_SIZE * 0.9)

    output_path = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/11.1--motivation-for-the-laplace-transform-Images/images/l006-s005-qg-q002-point-q002.png")
