...
$$
\begin{aligned}
[\lim_{n \to \infty}(1 + \frac{1}{n/x})^{n/x}]^{x} &= [\underbrace{\lim_{m \to \infty}(1 + \frac{1}{m})^{m}}_{e}]^{x} \\
&= e^{x}
\end{aligned}
$$
...
- [Next: Improper Integrals of the Second Kind](<Improper Integrals of the Second Kind - 759.md>)
