...
def main():
    ...
    draw_point(ax, 0, 2, '$s=j2$')
    draw_projection(ax, 0, 2)
    draw_annotation(ax, "$\\sigma=0$ (Fourier line)", -0.5, 3.55, ha='left', va='bottom', size=ANNOTATION_SIZE * 0.9)

    output_path = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/11.1--motivation-for-the-laplace-transform-Images/images/l006-s005-te-section-005.png")
