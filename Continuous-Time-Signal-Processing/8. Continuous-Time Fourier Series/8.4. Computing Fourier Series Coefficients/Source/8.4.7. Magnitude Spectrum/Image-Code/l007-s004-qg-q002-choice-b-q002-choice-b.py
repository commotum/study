...
"""Render the centered magnitude-spectrum stem plot for q002-choice-b."""
...
SPEC = {'covered_template': 'magnitude-spectrum-stem-plot',
 'equal_aspect': True,
 'render_notes': ['Centered correct spectrum with DC magnitude 5 and equal second-harmonic stems at ±2.',
                  'Half-unit grid and origin-centered axes preserve the magnitude-reading layout.'],
 'show_grid': True,
 'show_origin': True,
 'stems': [(-2, 2.0), (0, 5.0), (2, 2.0)],
 'x_axis_label': '$k$',
 'x_minor_grid_step': 1,
 'xlim': (-2.7, 2.7),
 'xticks': [-2, -1, 1, 2],
...
OUTPUT_PATH = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/8.4--computing-fourier-series-coefficients-Images/images/l007-s004-qg-q002-choice-b-q002-choice-b.png")
