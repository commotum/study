...
"""Render the centered magnitude-spectrum stem plot for q002-choice-c."""
...
SPEC = {'covered_template': 'magnitude-spectrum-stem-plot',
 'equal_aspect': True,
 'render_notes': ['Centered distractor spectrum that swaps the zero-magnitude first pair for a nonzero pair at ±1.',
                  'Same scaling as the other q002 choices keeps the mistaken harmonic pair easy to spot.'],
 'show_grid': True,
 'show_origin': True,
 'stems': [(-1, 2.0), (0, 5.0), (1, 2.0)],
 'x_axis_label': '$k$',
 'x_minor_grid_step': 1,
 'xlim': (-2.7, 2.7),
 'xticks': [-2, -1, 1, 2],
...
OUTPUT_PATH = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/8.4--computing-fourier-series-coefficients-Images/images/l007-s004-qg-q002-choice-c-q002-choice-c.png")
