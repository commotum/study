...
"""Render the centered magnitude-spectrum stem plot for q001-choice-a."""
...
SPEC = {'covered_template': 'magnitude-spectrum-stem-plot',
 'equal_aspect': True,
 'render_notes': ['Centered answer-choice spectrum with symmetric nonnegative stems at k=0, ±1, and ±2.',
                  'Same axis scale as the other q001 choices so the distractors compare directly.'],
 'show_grid': True,
 'show_origin': True,
...
OUTPUT_PATH = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/8.4--computing-fourier-series-coefficients-Images/images/l007-s004-qg-q001-choice-a-q001-choice-a.png")
