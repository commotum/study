...
"""Render the centered magnitude-spectrum stem plot for q001-choice-d."""
...
SPEC = {'covered_template': 'magnitude-spectrum-stem-plot',
 'equal_aspect': True,
 'render_notes': ['Centered distractor spectrum with the DC stem removed while keeping the harmonic pairs symmetric.',
                  'Same vertical scale as the other q001 options to make the missing DC term obvious.'],
 'show_grid': True,
 'show_origin': True,
 'stems': [(-2, 0.5), (-1, 3.0), (1, 3.0), (2, 0.5)],
 'x_axis_label': '$k$',
 'x_minor_grid_step': 1,
 'xlim': (-2.7, 2.7),
 'xticks': [-2, -1, 1, 2],
...
OUTPUT_PATH = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/8.4--computing-fourier-series-coefficients-Images/images/l007-s004-qg-q001-choice-d-q001-choice-d.png")
