...
"""Render the centered coefficient-magnitude card for q001-prompt."""
...
SPEC = {'covered_template': 'coefficient-magnitude-card',
 ...
 'render_notes': ['Centered coefficient-magnitude card with three rows and no stems or axes.',
                  'Dark labels and blue magnitudes keep the prompt consistent with the spectrum theme.'],
 'rows': [('DC', '$4$'), ('$k = \\pm 1$', '$3$'), ('$k = \\pm 2$', '$\\frac{1}{2}$')]}
OUTPUT_PATH = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/8.4--computing-fourier-series-coefficients-Images/images/l007-s004-qg-q001-prompt-q001.png")
