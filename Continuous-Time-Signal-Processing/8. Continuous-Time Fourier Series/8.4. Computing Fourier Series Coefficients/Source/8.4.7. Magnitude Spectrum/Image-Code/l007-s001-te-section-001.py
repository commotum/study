...
"""Render the centered magnitude-spectrum stem plot for section-001."""
...
SPEC = {'covered_template': 'magnitude-spectrum-stem-plot',
 'equal_aspect': True,
 'render_notes': ['Centered blue stem plot of coefficient magnitudes with manual axes through the origin.',
                  'Half-unit y-grid keeps the nonnegative harmonic heights easy to compare.'],
 'show_grid': True,
 'show_origin': True,
 'stems': [(-2, 1.0), (-1, 2.5), (0, 4.0), (1, 2.5), (2, 1.0)],
 'x_axis_label': '$k$',
 'x_minor_grid_step': 1,
 'xlim': (-2.7, 2.7),
 'xticks': [-2, -1, 1, 2],
 ...
 'ylim': (-0.4, 4.4),
 'yticks': [1, 2, 3, 4]}
OUTPUT_PATH = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/8.4--computing-fourier-series-coefficients-Images/images/l007-s001-te-section-001.png")
