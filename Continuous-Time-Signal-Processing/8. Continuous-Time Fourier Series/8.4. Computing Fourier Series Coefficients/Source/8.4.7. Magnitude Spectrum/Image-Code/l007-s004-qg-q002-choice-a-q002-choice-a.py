...
"""Render the centered magnitude-spectrum stem plot for q002-choice-a."""
...
SPEC = {'covered_template': 'magnitude-spectrum-stem-plot',
 'equal_aspect': True,
 'render_notes': ['Centered distractor spectrum that treats the second-harmonic pair as negative values.',
                  'Uses the same axis scale as the other q002 choices for direct comparison.'],
 'show_grid': True,
 'show_origin': True,
...
OUTPUT_PATH = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/8.4--computing-fourier-series-coefficients-Images/images/l007-s004-qg-q002-choice-a-q002-choice-a.png")
