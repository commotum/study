...
plot_signal(ax, [-0.30, 1.5, 1.5, 2.5, 2.5, 2.0], [0.0, 0.0, 4.0, 4.0, 0.0, 0.0])

draw_closed_endpoint(ax, 2.0, 2.0)
draw_closed_endpoint(ax, 1.5, 4.0)
draw_closed_endpoint(ax, 2.5, 4.0)

ax.text(0.75, 2.0 * 0.52 + 0.18, '$x(\\tau)=\\tau$', fontsize=16, ha="center", va="bottom", color=LABEL_COLOR)
ax.text((1.5 + 2.5) / 2.0, 4.0 + 0.18, '$h(t-\\tau)=4$', fontsize=16, ha="center", va="bottom", color=LABEL_COLOR)
ax.text(2.0, 2.0 + 0.28, '$(2,2)$', fontsize=15, ha="center", va="bottom", color=LABEL_COLOR)
ax.text(1.5, 4.0 + 0.22, '$(t-1,4)$', fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR)
ax.text(2.5, 4.0 + 0.22, '$(t,4)$', fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR)

ax.text((1.5 + 2.0) / 2.0, 0.28, 'overlap $[t-1,2]$', fontsize=15, ha="center", va="bottom", color=LABEL_COLOR)
ax.text(1.5, 0.05, '$t-1\\leqq \\tau\\leqq 2$', fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR)
ax.text(2.0, 0.05, '$2\\leqq t\\leqq 3$', fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR)
ax.text(2.55, 4.85 - 0.4, '$\\tau\\cdot 4$', fontsize=15, ha="center", va="top", color=LABEL_COLOR)

Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l004-s004-qg-q002-q002.png').parent.mkdir(parents=True, exist_ok=True)
plt.tight_layout()
fig.savefig('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l004-s004-qg-q002-q002.png', bbox_inches="tight", facecolor="white")
plt.close(fig)
