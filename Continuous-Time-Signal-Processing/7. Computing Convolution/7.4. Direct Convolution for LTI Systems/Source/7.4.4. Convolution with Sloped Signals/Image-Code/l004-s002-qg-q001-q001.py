...
plot_signal(ax, [-0.28, 0.0, 1.0, 1.0, 3.0, 3.0, 3.65], [0.0, 0.0, 0.0, 3.0, 7.0, 0.0, 0.0])
draw_closed_endpoint(ax, 1.0, 3.0)
draw_closed_endpoint(ax, 3.0, 7.0)

ax.text(1.0, 3.35, r"$(1,3)$", fontsize=15, ha="center", va="bottom", color=LABEL_COLOR)
ax.text(3.0, 7.35, r"$(3,7)$", fontsize=15, ha="center", va="bottom", color=LABEL_COLOR)
ax.text(1.95, 5.05, r"$x(\tau)$", fontsize=18, ha="center", va="bottom", color=LABEL_COLOR)
ax.text(1.90, -0.30, r"$1\leq \tau\leq 3$", fontsize=15, ha="center", va="top", color=ANNOTATION_COLOR)

Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l004-s002-qg-q001-q001.png').parent.mkdir(parents=True, exist_ok=True)
plt.tight_layout()
fig.savefig('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l004-s002-qg-q001-q001.png', bbox_inches="tight", facecolor="white")
plt.close(fig)
