...
plot_signal(ax, [-0.18, 0.0, 2.0, 2.0, 2.55], [0.0, 0.0, 4.0, 0.0, 0.0])
draw_closed_endpoint(ax, 0.0, 0.0)
draw_closed_endpoint(ax, 2.0, 4.0)

ax.text(0.94, 4.18, r"$(0,0)$", fontsize=15, ha="center", va="bottom", color=LABEL_COLOR)
ax.text(2.02, 4.18, r"$(2,4)$", fontsize=15, ha="center", va="bottom", color=LABEL_COLOR)
ax.text(0.90, 2.15, r"$x(\tau)$", fontsize=18, ha="center", va="bottom", color=LABEL_COLOR)
ax.text(1.00, -0.30, r"$0\leq \tau\leq 2$", fontsize=15, ha="center", va="top", color=ANNOTATION_COLOR)

Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l004-s002-te-section-002.png').parent.mkdir(parents=True, exist_ok=True)
plt.tight_layout()
fig.savefig('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l004-s002-te-section-002.png', bbox_inches="tight", facecolor="white")
plt.close(fig)
