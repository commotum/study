...
CONFIG = {'kind': 'endpoint_alignment',
 'figsize': (9.12, 7.68),
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s002-qg-q001-q001.png',
 'xlim': (-0.35, 4.75),
 'ylim': (-0.15, 1.65),
 'xticks': [1, 2, 3, 4],
 'fixed': (1.0, 4.0),
 ...
 'fixed_y': 1.05,
 'moving_y': 0.4,
 'fixed_label': '$x(\\tau)\\text{ nonzero on }[1,4]$',
 'moving_label': '$h(t-\\tau)\\text{ nonzero on }[t-3,t-1]$',
 'endpoint_labels': [(1.0, '$1$', 1.28), (4.0, '$4$', 1.28), (0.8, '$t-3$', 0.63), (2.8, '$t-1$', 0.63)]}
OUTPUT_PATH = Path(r'/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s002-qg-q001-q001.png')
