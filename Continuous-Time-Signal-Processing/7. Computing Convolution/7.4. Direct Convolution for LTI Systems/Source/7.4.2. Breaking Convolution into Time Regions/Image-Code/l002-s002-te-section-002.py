...
CONFIG = {'kind': 'endpoint_alignment',
 'figsize': (9.12, 7.68),
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s002-te-section-002.png',
 'xlim': (-0.45, 3.75),
 'ylim': (-0.15, 1.65),
 'xticks': [0, 1, 2, 3],
 'fixed': (0.0, 3.0),
 ...
 'fixed_y': 1.05,
 'moving_y': 0.4,
 'fixed_label': '$x(\\tau)\\text{ nonzero on }[0,3]$',
 'moving_label': '$h(t-\\tau)\\text{ nonzero on }[t-2,t]$',
 'endpoint_labels': [(0.0, '$0$', 1.28), (3.0, '$3$', 1.28), (0.65, '$t-2$', 0.63), (2.65, '$t$', 0.63)]}
OUTPUT_PATH = Path(r'/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s002-te-section-002.png')
