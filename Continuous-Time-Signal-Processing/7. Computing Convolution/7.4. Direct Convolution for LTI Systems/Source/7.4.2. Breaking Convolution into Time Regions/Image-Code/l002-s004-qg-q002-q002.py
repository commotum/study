...
CONFIG = {'kind': 'classification_rows',
 'figsize': (9.12, 7.68),
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s004-qg-q002-q002.png',
 'xlim': (-3.4, 4.7),
 'ylim': (-0.7, 0.95),
 'axis_y': -0.45,
 'rows': [{'y': 0.16,
           ...
           'fixed_center': 2.0,
           'moving_center': -2.0,
           'fixed_label': '$x(\\tau)\\text{ support }[0,4]$',
           'moving_label': '$h(t-\\tau)\\text{ support }[t-3,t-1]$',
           'region_label': '$t<1: \\text{no-overlap}$',
           't_text': '$t=0$'}]}
OUTPUT_PATH = Path(r'/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l002-s004-qg-q002-q002.png')
