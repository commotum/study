...
draw_block(ax_block)
setup_axis(ax_signal, (-0.2, 6.0), (-0.45, 1.55))

t = np.array([0.0, 0.0, 2.0, 4.0, 6.0, 6.0])
y = np.array([0.0, 0.0, 1.2, 1.2, 0.0, 0.0])
ax_signal.plot(t, y, color=SIGNAL_COLOR, linewidth=SIGNAL_LW)
for x, txt in zip([0.0, 2.0, 4.0, 6.0], [r'$a$', r'$b$', r'$c$', r'$d$']):
    ax_signal.text(x, -0.10, txt, fontsize=TICK_LABEL_SIZE*0.7, ha='center', va='top', color=TICK_LABEL_COLOR)
ax_signal.text(1.0, 1.0, r'$a<t<b$', fontsize=22, color=AXIS_COLOR)
ax_signal.text(3.0, 1.0, r'$b<t<c$', fontsize=22, color=AXIS_COLOR)
ax_signal.text(5.0, 1.0, r'$c<t<d$', fontsize=22, color=AXIS_COLOR)

out = Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.4--direct-convolution-for-lti-systems-Images/images/l007-s006-te-section-006.png')
