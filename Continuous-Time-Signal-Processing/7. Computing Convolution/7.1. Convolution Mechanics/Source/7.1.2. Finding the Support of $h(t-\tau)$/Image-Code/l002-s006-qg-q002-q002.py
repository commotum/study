...
def build_figure():
    ...
    draw_panel(
        ...
        support_left=2.0,
        support_right=8.0,
        endpoint_labels=(r"$t-3$", r"$t+2$"),
        axis_label=r"$\tau$",
        function_label=r"$h(t-\tau)$",
        annotations=[
            (2.0, 0.50, r"$u=3 \mapsto \tau=t-3$", "center"),
            (8.0, 0.50, r"$u=-2 \mapsto \tau=t+2$", "center"),
...
def main():
    ...
    output_path = Path(
        ...
        "7.1--convolution-mechanics-Images/images/l002-s006-qg-q002-q002.png"
    )
