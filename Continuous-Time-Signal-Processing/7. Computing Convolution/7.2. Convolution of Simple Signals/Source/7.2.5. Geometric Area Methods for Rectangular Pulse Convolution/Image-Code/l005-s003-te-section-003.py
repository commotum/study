...
OUTPUT_PATH = r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l005-s003-te-section-003.png"

def main():
    render_sequence_scene(
        OUTPUT_PATH,
        panels=[{'panel_label': '$t<0$', 'moving_interval': (-4, -1), 'overlap_interval': (0, 0), 'length_label': '$0$', 'no_overlap_text': '$0$', 'show_ylabel': True, 'show_origin': True}, {'panel_label': '$0<t<3$', 'moving_interval': (-1.5, 1.5), 'overlap_interval': (0, 1.5), 'length_label': '$t$', 'show_ylabel': False, 'show_origin': False}, {'panel_label': '$t=3$', 'moving_interval': (0, 3), 'overlap_interval': (0, 3), 'length_label': '$3$', 'show_ylabel': False, 'show_origin': False}, {'panel_label': '$3<t<6$', 'moving_interval': (1.5, 4.5), 'overlap_interval': (1.5, 3), 'length_label': '$6-t$', 'show_ylabel': False, 'show_origin': False}, {'panel_label': '$t=6$', 'moving_interval': (3.2, 6.2), 'overlap_interval': (0, 0), 'length_label': '$0$', 'no_overlap_text': '$0$', 'show_ylabel': False, 'show_origin': False}],
        xlim=(-4.0, 6.8),
        ylim=(-0.7, 1.75),
        xticks=[-3, 0, 3, 6],
        yticks=[0, 1],
