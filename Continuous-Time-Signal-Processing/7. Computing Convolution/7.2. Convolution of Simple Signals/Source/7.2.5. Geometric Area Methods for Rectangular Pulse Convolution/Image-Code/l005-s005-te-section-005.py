...
OUTPUT_PATH = r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l005-s005-te-section-005.png"

def main():
    render_single_overlap_scene(
        OUTPUT_PATH,
        xlim=(-0.6, 6.6),
        ylim=(-1.3, 4.8),
        xticks=[0, 3, 6],
        ...
        fixed_interval=(0, 3),
        fixed_height=4,
        fixed_label=r"$x(\tau)=4$",
        moving_interval=(1, 4),
        moving_height=0.5,
        moving_label=r"$h(t-\tau)=\frac{1}{2}$",
        overlap_start=1,
        overlap_end=3,
        width_label=r"$L(t)$",
        product_text=r"$4\times\frac{1}{2}=2$",
        lower_texts=[
            (0.2, -0.68, r"$L(t)=t,\;0\leq t\leq 3$"),
            (0.2, -1.03, r"$L(t)=6-t,\;3\leq t\leq 6$"),
        ],
    )
