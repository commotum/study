...
CONFIG = {'kind': 'timeline',
 ...
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l002-s002-qg-q002-q002.png',
 'figsize': (9.5, 7.0),
 'top_panel': {'xlim': (-2.8, 5.8),
               'ylim': (-0.8, 3.4),
               ...
               'overlap': {'left': 0.0,
                           ...
                           'label': 'overlap',
                           'alpha': 0.12},
               'brackets': [{'start': 0.0, 'end': 6.0, 'y': -0.46, 'label': 'fixed support'},
                            {'start': -1.0, 'end': 1.0, 'y': -0.46, 'label': 'moving support'}],
               'edge_labels': [{'x': 0.0, 'y': -0.16, 'text': '$0$', 'fontsize': 15, 'va': 'top'},
                               {'x': 6.0, 'y': -0.16, 'text': '$6$', 'fontsize': 15, 'va': 'top'},
                               {'x': -1.0,
                                'y': -0.16,
                                'text': '$t-2$',
                                'fontsize': 15,
                                'va': 'top'},
                               {'x': 1.0, 'y': -0.16, 'text': '$t$', 'fontsize': 15, 'va': 'top'}]},
 'timeline': {'xlim': (-0.5, 4.5),
              'breakpoints': [0.0, 1.0, 2.0, 3.0],
              'labels': {},
              'region_labels': [{'x': 0.0, 'y': 0.22, 'text': 'first contact', 'fontsize': 13},
                                {'x': 1.0,
                                 'y': 0.22,
                                 'text': 'start of full overlap',
                                 'fontsize': 13},
                                {'x': 2.0,
                                 'y': 0.22,
                                 'text': 'end of full overlap',
                                 'fontsize': 13},
                                {'x': 3.0, 'y': 0.22, 'text': 'last contact', 'fontsize': 13}],
              'axis_label': '$t$'},
 'python_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/code/l002-s002-qg-q002-q002.py',
 'slot_key': 'l002-s002-qg-q002-q002',
 'lesson_index': 2,
 'lesson_title': 'Convolution of Unequal-Width Rectangular Pulses',
 'section_index': 2,
 'source_stage': 'question-generation',
 'image_slot_id': 'q002',
 'template': 'breakpoint-timeline-two-rectangles'}
