...
CONFIG = {'kind': 'timeline',
 ...
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l002-s002-qg-q001-q001.png',
 'figsize': (9.5, 7.0),
 'top_panel': {'xlim': (-2.8, 5.8),
               ...
               'overlap': {'left': 0.0,
                           ...
                           'label': 'overlap',
                           'alpha': 0.12},
               'brackets': [{'start': 0.0, 'end': 3.0, 'y': -0.46, 'label': 'fixed support'},
                            {'start': -6.0, 'end': 2.0, 'y': -0.46, 'label': 'moving support'}],
               'edge_labels': [{'x': 0.0, 'y': -0.16, 'text': '$0$', 'fontsize': 15, 'va': 'top'},
                               {'x': 3.0, 'y': -0.16, 'text': '$3$', 'fontsize': 15, 'va': 'top'},
                               {'x': -6.0,
                                'y': -0.16,
                                'text': '$t-8$',
                                'fontsize': 15,
                                'va': 'top'},
                               {'x': 2.0, 'y': -0.16, 'text': '$t$', 'fontsize': 15, 'va': 'top'}]},
 'timeline': {'xlim': (-0.5, 4.5),
              ...
              'axis_label': '$t$'},
 'python_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/code/l002-s002-qg-q001-q001.py',
 'slot_key': 'l002-s002-qg-q001-q001',
 'lesson_index': 2,
