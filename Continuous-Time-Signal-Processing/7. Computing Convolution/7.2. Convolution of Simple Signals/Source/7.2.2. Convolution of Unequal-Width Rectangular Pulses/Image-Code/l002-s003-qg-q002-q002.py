...
CONFIG = {'kind': 'single',
 ...
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l002-s003-qg-q002-q002.png',
 'figsize': (9.2, 5.8),
 'panel': {'xlim': (-4.8, 5.2),
           'ylim': (-0.7, 3.4),
           'xticks': [-4, -2, 0, 2, 4],
           ...
           'moving': {'left': -3.0,
                      ...
                      'label': '$h(t-\\tau)$',
                      'fill_alpha': 0.08},
           'overlap': {'left': 1.0, 'right': 3.5, 'height': 1.45, 'label': '', 'alpha': 0.12},
           'brackets': [{'start': 1.0, 'end': 4.0, 'y': -0.44, 'label': '$1\\leq t\\leq 4$'}],
           'edge_labels': [{'x': 0.0, 'y': -0.16, 'text': '$0$', 'fontsize': 15, 'va': 'top'},
                           {'x': 4.0, 'y': -0.16, 'text': '$4$', 'fontsize': 15, 'va': 'top'},
                           {'x': -3.0, 'y': -0.16, 'text': '$t-7$', 'fontsize': 15, 'va': 'top'},
                           {'x': 4.0, 'y': -0.16, 'text': '$t$', 'fontsize': 15, 'va': 'top'}]},
 'python_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/code/l002-s003-qg-q002-q002.py',
 'slot_key': 'l002-s003-qg-q002-q002',
 'lesson_index': 2,
