...
CONFIG = {'h_width': 7,
 'left_region': '$t<0$',
 'moving_left_labels': ['$t-7$', '$t-7$'],
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l004-s003-qg-q002-prompt-q002.png',
 'right_region': '$t>11$',
 'scene': 'no_overlap',
 'snapshot_titles': [None, None],
 'snapshot_ts': [-1.0, 12.0],
 'timeline_title': None,
 'x_width': 4}
