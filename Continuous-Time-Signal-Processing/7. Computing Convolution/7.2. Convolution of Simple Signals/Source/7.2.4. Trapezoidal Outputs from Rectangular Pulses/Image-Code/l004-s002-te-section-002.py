...
CONFIG = {'breakpoints': [0, 2, 5, 7],
 'h_width': 2,
 'moving_left_labels': ['$-2$', '$0$', '$3$', '$5$'],
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l004-s002-te-section-002.png',
 'overlap_labels': ['$0$', '$2$', '$2$', '$0$'],
 'region_labels': ['$no\\ overlap$',
                   '$growing\\ overlap$',
                   '$full\\ overlap$',
                   '$shrinking\\ overlap$',
                   '$no\\ overlap$'],
 'scene': 'sweep_tutorial',
 'snapshot_titles': ['$t=0$', '$t=2$', '$t=5$', '$t=7$'],
 'snapshot_ts': [0.0, 2.0, 5.0, 7.0],
 'timeline_title': None,
 'x_width': 5}
