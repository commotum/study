...
CONFIG = {'h_width': 2,
 'left_region': '$t<0$',
 'moving_left_labels': ['$t-2$', '$t-2$'],
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l004-s003-te-section-003.png',
 'right_region': '$t>7$',
 'scene': 'no_overlap',
 'snapshot_titles': ['$t<0$', '$t>7$'],
 'snapshot_ts': [-1.0, 8.0],
 'timeline_title': None,
 'x_width': 5}
