...
CONFIG = {'h_width': 7,
 'moving_left_labels': ['$t-7$', '$t-7$', '$t-7$'],
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l004-s002-qg-q002-prompt-q002.png',
 'overlap_labels': ['$0$', '$t$', '$0$'],
 'scene': 'sweep_prompt',
 'snapshot_titles': [None, None, None],
 'snapshot_ts': [-1.0, 1.0, 10.0],
 'x_width': 2}
