...
CONFIG = {'breakpoints': [0, 4, 7, 11],
 'h_width': 7,
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l004-s007-qg-q002-prompt-q002.png',
 'region_labels': ['$no\\ overlap$',
                   '$growing\\ overlap$',
                   '$full\\ overlap$',
                   '$shrinking\\ overlap$',
                   '$no\\ overlap$'],
 'scene': 'input_output_prompt',
 'timeline_title': None,
 'x_width': 4}
