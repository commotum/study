...
def main():
    ...
    panels = [
        {
            ...
            "line": None,
            "peak_text": None,
            "notes": [{'x': 2.0, 'y': 1.0, 'text': '$2$', 'size': 15}],
            "ylim": (-0.3, 2.65),
        },
        {
            "kind": 'rect',
            ...
            "line": None,
            "peak_text": None,
            "notes": [{'x': 2.0, 'y': 0.5, 'text': '$1$', 'size': 15}],
            "ylim": (-0.3, 1.65),
        },
        {
            "kind": 'triangle',
    ...
    save(fig, '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l001-s006-qg-q001-q001.png')
