...
def main():
    ...
    draw_support(ax, -2, 3, y=0.34, height=0.42, label='$h(t-\\tau)$')
    draw_mark(ax, 0, y0=0.0, y1=1.1, label=None, label_y=None)
    draw_mark(ax, 3, y0=0.0, y1=1.1, label=None, label_y=None)
    draw_note(ax, 2.5, 1.02, '$2$', ha='center', va='center', size=15)
    draw_note(ax, 0.5, 0.2, '$3$', ha='center', va='center', size=15)
    draw_note(ax, 1.5, 0.95, '$2\\times 3 = 6$', ha='center', va='center', size=15)
    save(fig, '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l001-s005-qg-q001-q001.png')
