...
def main():
    ...
    panels = [{'title': 'first contact\n$t = -2$', 'fixed': (-2, 4), 'moving': (-8, -2), 'overlap': None, 'xticks': [(-8, '$-8$'), (-2, '$-2$'), (4, '$4$'), (10, '$10$')], 'marks': [{'x': -8, 'y0': 0.0, 'y1': 1.1, 'label': '$t-6$', 'label_y': 1.48}, {'x': -2, 'y0': 0.0, 'y1': 1.1, 'label': '$t$', 'label_y': 1.48}]}, {'title': 'peak alignment\n$t = 4$', 'fixed': (-2, 4), 'moving': (-2, 4), 'overlap': (-2, 4), 'xticks': [(-8, '$-8$'), (-2, '$-2$'), (4, '$4$'), (10, '$10$')], 'marks': [{'x': -2, 'y0': 0.0, 'y1': 1.1, 'label': '$t-6$', 'label_y': 1.48}, {'x': 4, 'y0': 0.0, 'y1': 1.1, 'label': '$t$', 'label_y': 1.48}]}, {'title': 'last contact\n$t = 10$', 'fixed': (-2, 4), 'moving': (4, 10), 'overlap': None, 'xticks': [(-8, '$-8$'), (-2, '$-2$'), (4, '$4$'), (10, '$10$')], 'marks': [{'x': 4, 'y0': 0.0, 'y1': 1.1, 'label': '$t-6$', 'label_y': 1.48}, {'x': 10, 'y0': 0.0, 'y1': 1.1, 'label': '$t$', 'label_y': 1.48}]}]
    for ax, panel in zip(axes, panels):
        draw_panel(ax, panel)
    fig.subplots_adjust(wspace=0.24)
    save(fig, '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l001-s002-qg-q002-q002.png')
