...
def main():
    ...
    draw_span(ax, 2, 6)
    draw_support(ax, 2, 8, y=1.18, height=0.42, label='$x(\\tau)$')
    draw_support(ax, 0, 6, y=0.34, height=0.42, label='$h(t-\\tau)$')
    draw_mark(ax, 2, y0=0.0, y1=1.1, label=None, label_y=None)
    draw_mark(ax, 6, y0=0.0, y1=1.1, label=None, label_y=None)
    draw_note(ax, 5.0, 1.04, '$[2,\\,8]$', ha='center', va='center', size=14)
    draw_note(ax, 3.0, 0.22, '$[t-6,\\,t]$', ha='center', va='center', size=14)
    draw_note(ax, 4.0, 0.94, '$L(t)$', ha='center', va='center', size=15)
    save(fig, '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l001-s003-qg-q002-q002.png')
