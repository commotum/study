...
def main():
    ...
    panels = [
        {
            ...
            "line": None,
            "peak_text": None,
            "notes": [{'x': 2.0, 'y': 0.9, 'text': '$A$', 'size': 15}],
            "ylim": (-0.3, 2.55),
        },
        {
            "kind": 'rect',
            ...
            "line": None,
            "peak_text": None,
            "notes": [{'x': 2.0, 'y': 1.2, 'text': '$B$', 'size': 15}],
            "ylim": (-0.3, 3.2),
        },
        {
            "kind": 'triangle',
    ...
    save(fig, '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l001-s006-te-section-006.png')
