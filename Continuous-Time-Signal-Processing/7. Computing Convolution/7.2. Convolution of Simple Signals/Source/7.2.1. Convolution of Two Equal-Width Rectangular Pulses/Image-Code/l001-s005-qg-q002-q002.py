...
def main():
    ...
    draw_support(ax, 2, 6, y=0.34, height=0.42, label='$h(t-\\tau)$')
    draw_mark(ax, 2, y0=0.0, y1=1.1, label=None, label_y=None)
    draw_mark(ax, 4, y0=0.0, y1=1.1, label=None, label_y=None)
    draw_note(ax, 2.0, 1.02, '$3$', ha='center', va='center', size=15)
    draw_note(ax, 4.0, 0.2, '$5$', ha='center', va='center', size=15)
    draw_note(ax, 3.0, 0.95, '$3\\times 5 = 15$', ha='center', va='center', size=15)
    save(fig, '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l001-s005-qg-q002-q002.png')
