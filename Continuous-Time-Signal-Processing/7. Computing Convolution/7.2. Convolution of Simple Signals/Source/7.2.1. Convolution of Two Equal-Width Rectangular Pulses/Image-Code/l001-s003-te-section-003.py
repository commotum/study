...
def main():
    ...
    draw_note(ax, 0.5, 0.22, '$[t-T,\\,t]$', ha='center', va='center', size=14)
    draw_note(ax, 1.5, 0.94, '$L(t)$', ha='center', va='center', size=15)
    save(fig, '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l001-s003-te-section-003.png')
