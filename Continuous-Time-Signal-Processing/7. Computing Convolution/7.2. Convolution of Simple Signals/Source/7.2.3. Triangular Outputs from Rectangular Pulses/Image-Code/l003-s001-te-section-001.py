...
def main():
    ...
    image_output_path = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l003-s001-te-section-001.png")
    image_output_path.parent.mkdir(parents=True, exist_ok=True)

    fig = plt.figure(figsize=(11.3, 8.5), dpi=DPI)
    gs = fig.add_gridspec(2, 3, height_ratios=[1.0, 1.12], hspace=0.52, wspace=0.34)
    ...
    def draw_contact_panel(ax, t_shift, title):
        ...
        ax.text((overlap_left + overlap_right) / 2, 0.16, r"overlap interval", fontsize=12.5, color=ANNOTATION_COLOR, ha="center", va="bottom")
    ...
    draw_triangle_output(ax4, 0, 2, 4, 2.0)
    ax4.text(2, 2.18, r"$y(t)$", fontsize=18, color=LABEL_COLOR, ha="center", va="bottom")
    ax4.text(2, 2.06, r"peak", fontsize=12.5, color=ANNOTATION_COLOR, ha="center", va="bottom")
    ax4.text(0.25, 2.18, r"zero", fontsize=12.5, color=ANNOTATION_COLOR, ha="left", va="bottom")
    ax4.text(3.62, 2.18, r"zero", fontsize=12.5, color=ANNOTATION_COLOR, ha="left", va="bottom")
