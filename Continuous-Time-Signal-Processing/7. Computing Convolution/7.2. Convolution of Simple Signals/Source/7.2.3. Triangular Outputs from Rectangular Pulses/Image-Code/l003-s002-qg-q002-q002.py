...
def main():
    ...
    image_output_path = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l003-s002-qg-q002-q002.png")
    ...
    draw_pulse_box(ax_main, 0, 4, height=1, baseline=0, fill_alpha=0.10)
    draw_pulse_box(ax_main, 2.0, 6.0, height=1, baseline=0, fill_alpha=0.05)
    ...
    ax_main.text(2.0 - 0.08, 1.16, r"$h(t-\tau)$", fontsize=16, color=LABEL_COLOR, ha="left", va="bottom")
    ax_main.text(0, -0.17, r"$0$", fontsize=15, color=TICK_LABEL_COLOR, ha="center", va="top")
    ax_main.text(4, -0.17, r"$4$", fontsize=15, color=TICK_LABEL_COLOR, ha="center", va="top")
    ax_main.text(2.0, -0.17, r"$t-4$", fontsize=15, color=TICK_LABEL_COLOR, ha="center", va="top")
    ax_main.text(6.0, -0.17, r"$t$", fontsize=15, color=TICK_LABEL_COLOR, ha="center", va="top")
    ax_main.text(0.5, 1.03, r"Locating the time regions for width-4 rectangular pulses", transform=ax_main.transAxes, fontsize=15, color=LABEL_COLOR, ha="center", va="bottom")
    ...
    draw_timeline_axis(
        ...
        8,
        markers=[0, 4, 8],
        marker_labels=[(0, r"first contact"), (4, r"maximum overlap"), (8, r"last contact")],
        label_y=-0.22,
    )
