...
def main():
    ...
    image_output_path = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/7.2--convolution-of-simple-signals-Images/images/l003-s005-te-section-005.png")
    image_output_path.parent.mkdir(parents=True, exist_ok=True)

    fig = plt.figure(figsize=(10.0, 7.9), dpi=DPI)
    gs = fig.add_gridspec(2, 1, height_ratios=[1.12, 1.02], hspace=0.28)
    ...
    draw_pulse_box(ax_inputs, 0, 2, height=2, baseline=0, fill_alpha=0.10)
    draw_pulse_box(ax_inputs, 0, 2, height=3, baseline=0, fill_alpha=0.05)
    ...
    ax_inputs.text(0 - 0.06, 3.13, r"$h(t-\tau)$", fontsize=15, color=LABEL_COLOR, ha="left", va="bottom")
    ax_inputs.text(0, -0.19, r"$0$", fontsize=15, color=TICK_LABEL_COLOR, ha="center", va="top")
    ax_inputs.text(2, -0.19, r"$2$", fontsize=15, color=TICK_LABEL_COLOR, ha="center", va="top")
    ax_inputs.text(0, -0.19, r"$t-2$", fontsize=15, color=TICK_LABEL_COLOR, ha="center", va="top")
    ax_inputs.text(2, -0.19, r"$t$", fontsize=15, color=TICK_LABEL_COLOR, ha="center", va="top")
    ax_inputs.text(0.5, 1.03, r"Complete triangular output sketch", transform=ax_inputs.transAxes, fontsize=15, color=LABEL_COLOR, ha="center", va="bottom")
    ...
    draw_triangle_output(ax_output, 0, 2, 4, 12)
    ax_output.text(2, 12.12, r"peak value 12 at t = 2", fontsize=13, color=ANNOTATION_COLOR, ha="center", va="bottom")
    ax_output.text(0.2, 0.08, r"y(t)=6t", fontsize=12.5, color=LABEL_COLOR, ha="left", va="bottom")
    ax_output.text(2.1, 0.08, r"y(t)=6(4-t)", fontsize=12.5, color=LABEL_COLOR, ha="left", va="bottom")
