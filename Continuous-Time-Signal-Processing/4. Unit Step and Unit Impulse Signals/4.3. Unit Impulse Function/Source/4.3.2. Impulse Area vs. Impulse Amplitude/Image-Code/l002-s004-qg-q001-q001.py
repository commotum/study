"""Impulse area diagram for question q001: areas at t=-2, 1, 3."""
...
xlim = (-3, 4)
ylim = (-0.35, 1.35)
impulse_positions = np.array([-2, 1, 3])
impulse_areas = np.array([2, -1, 4])
stem_height = 0.8
x_ticks = np.array([-3, -2, -1, 0, 1, 2, 3, 4])
...
output_path = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/4.3--unit-impulse-function-Images/images/l002-s004-qg-q001-q001.png")
