"""Section example impulse area diagram for t=-1,0,2 with signed labels."""
...
xlim = (-2, 3)
ylim = (-0.35, 1.35)
impulse_positions = np.array([-1, 0, 2])
impulse_areas = np.array([3, -2, 4])
stem_height = 0.8
x_ticks = np.array([-2, -1, 0, 1, 2, 3])
...
output_path = Path("/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/4.3--unit-impulse-function-Images/images/l002-s004-te-section-004.png")
