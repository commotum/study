...
def main():
    ...
    t = np.array([-1.5, 0, 3, 6, 6.5], dtype=float)
    x = np.array([0, 0, 3, 0, 0], dtype=float)
    plot_signal(ax, t, x)
    save_figure(fig, Path(r'/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/4.2--constructing-signals-with-unit-steps-Images/images/l006-s005-qg-q002-q002.png'))
    plt.close(fig)
