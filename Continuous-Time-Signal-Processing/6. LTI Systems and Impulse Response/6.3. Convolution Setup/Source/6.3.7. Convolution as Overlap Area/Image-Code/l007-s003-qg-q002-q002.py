...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l007-s003-qg-q002-q002.png',
 ...
 'panels': [{'xlim': (0.6, 6.4),
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 1, 'end': 5, 'height': 2},
             'overlap': {'start': 3, 'end': 5, 'height': 2, 'fill_alpha': 0.22},
             'texts': [{'text': '$x(\\tau)=2$', 'x': 3.0, 'y': 2.18, 'fontsize': 15},
                       {'text': 'overlap 3<=tau<=5',
                        'x': 4.0,
                        'y': 0.9,
                        'fontsize': 14}]},
            {'xlim': (0.6, 6.4),
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 3, 'end': 6, 'height': 3},
             'overlap': {'start': 3, 'end': 5, 'height': 3, 'fill_alpha': 0.22},
             'texts': [{'text': '$h(5-\\tau)=3$', 'x': 4.5, 'y': 3.18, 'fontsize': 15},
                       {'text': 'overlap 3<=tau<=5',
                        'x': 4.0,
                        'y': 1.72,
                        'fontsize': 14}]},
            {'xlim': (0.6, 6.4),
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 3, 'end': 5, 'height': 6, 'fill_alpha': 0.18},
             'texts': [{'text': '$x(\\tau)h(5-\\tau)=6$',
                        'x': 4.0,
                        'y': 5.18,
                        'fontsize': 15}]}],
 'figure_texts': [{'text': 'fixed $t=5$',
                   'x': 0.5,
                   'y': 0.978,
                   'fontsize': 15,
                   'va': 'top'}]}
