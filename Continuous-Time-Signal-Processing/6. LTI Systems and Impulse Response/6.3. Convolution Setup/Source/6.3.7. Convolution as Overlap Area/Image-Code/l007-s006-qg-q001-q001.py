...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l007-s006-qg-q001-q001.png',
 'figure_size': (10.0, 9.3),
 'panels': [{'xlim': (0.6, 5.4),
             'ylim': (-0.35, 1.65),
             'xticks': [1, 2, 3, 4, 5],
             'yticks': [1],
             ...
             'texts': [{'text': '$x(\\tau)=1$', 'x': 2.0, 'y': 1.18, 'fontsize': 15},
                       {'text': 'no overlap', 'x': 3.5, 'y': 0.45, 'fontsize': 14}]},
            {'xlim': (0.6, 5.4),
             'ylim': (-0.35, 1.65),
             'xticks': [1, 2, 3, 4, 5],
             'yticks': [1],
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 4, 'end': 5, 'height': 1},
             'texts': [{'text': '$h(6-\\tau)=1$', 'x': 4.5, 'y': 1.18, 'fontsize': 15},
                       {'text': 'no overlap', 'x': 3.5, 'y': 0.45, 'fontsize': 14}]},
            {'xlim': (0.6, 5.4),
             'ylim': (-0.25, 0.65),
             'xticks': [1, 2, 3, 4, 5],
             ...
             'equal_aspect': True,
             'show_origin': True,
             'texts': [{'text': '$x(\\tau)h(6-\\tau)=0$',
                        'x': 3.0,
                        'y': 0.12,
                        'fontsize': 15}]}],
 'figure_texts': [{'text': 'fixed $t=6$',
                   'x': 0.5,
                   'y': 0.978,
                   'fontsize': 15,
                   'va': 'top'}]}
