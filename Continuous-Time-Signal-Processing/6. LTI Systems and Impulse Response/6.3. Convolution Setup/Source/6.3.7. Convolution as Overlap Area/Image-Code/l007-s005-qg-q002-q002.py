...
SPEC = {'layout': 'comparison',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l007-s005-qg-q002-q002.png',
 'figure_size': (13.6, 9.7),
 'columns': [{'header_text': 'fixed $t=2$',
              'panels': [{'xlim': (-0.4, 5.4),
                          'ylim': (-0.35, 2.65),
                          'xticks': [0, 1, 2, 3, 4, 5],
                          'yticks': [2],
             ...
             {'header_text': 'fixed $t=5$',
              'panels': [{'xlim': (-0.4, 5.4),
                         ...
                         {'xlim': (-0.4, 5.4),
                          ...
                          'equal_aspect': True,
                          'show_origin': True,
                          'main_rect': {'start': 2, 'end': 5, 'height': -1},
                          'overlap': {'start': 2,
                                      'end': 4,
                                      'height': -1,
                                      'fill_alpha': 0.22},
