...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l007-s003-te-section-003.png',
 ...
 'panels': [{'xlim': (-0.4, 4.4),
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 0, 'end': 4, 'height': 2},
             'overlap': {'start': 1, 'end': 3, 'height': 2, 'fill_alpha': 0.22},
             'texts': [{'text': '$x(\\tau)=2$', 'x': 1.4, 'y': 2.18, 'fontsize': 15},
            ...
            {'xlim': (-0.4, 4.4),
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 1, 'end': 3, 'height': 1},
             'overlap': {'start': 1, 'end': 3, 'height': 1, 'fill_alpha': 0.22},
             'texts': [{'text': '$h(3-\\tau)=1$', 'x': 2.0, 'y': 1.18, 'fontsize': 15},
                       {'text': 'overlap 1<=tau<=3',
                        'x': 2.0,
                        'y': 0.48,
                        'fontsize': 14}]},
            {'xlim': (-0.4, 4.4),
             ...
             'texts': [{'text': '$x(\\tau)h(3-\\tau)=2$',
                        'x': 2.0,
                        'y': 1.18,
                        'fontsize': 15},
                       {'text': '$+4 = y(3)$', 'x': 2.0, 'y': 2.28, 'fontsize': 15}]}],
 'figure_texts': [{'text': 'fixed $t=3$',
                   'x': 0.5,
                   'y': 0.978,
                   'fontsize': 15,
                   'va': 'top'}]}
