...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l007-s003-qg-q001-q001.png',
 'figure_size': (10.2, 9.7),
 'panels': [{'xlim': (-0.4, 5.4),
             'ylim': (-0.35, 1.65),
             'xticks': [0, 2, 4, 5],
             'yticks': [1],
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 0, 'end': 5, 'height': 1},
             'overlap': {'start': 2, 'end': 4, 'height': 1, 'fill_alpha': 0.22},
             'texts': [{'text': '$x(\\tau)=1$', 'x': 2.5, 'y': 1.18, 'fontsize': 15},
            ...
            {'xlim': (-0.4, 5.4),
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 2, 'end': 4, 'height': 3},
             'overlap': {'start': 2, 'end': 4, 'height': 3, 'fill_alpha': 0.22},
             'texts': [{'text': '$h(4-\\tau)=3$', 'x': 3.0, 'y': 3.18, 'fontsize': 15},
                       {'text': 'overlap 2<=tau<=4',
                        'x': 3.0,
                        'y': 1.72,
                        'fontsize': 14}]},
            {'xlim': (-0.4, 5.4),
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 2, 'end': 4, 'height': 3, 'fill_alpha': 0.18},
             'texts': [{'text': '$x(\\tau)h(4-\\tau)=3$',
                        'x': 3.0,
                        'y': 1.72,
                        'fontsize': 15}]}],
