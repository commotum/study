...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l007-s002-te-section-002.png',
 ...
 'panels': [{'xlim': (-0.4, 4.4),
             ...
             'texts': [{'text': '$x(\\tau)=1$', 'x': 1.5, 'y': 1.18, 'fontsize': 15},
            ...
            {'xlim': (-0.4, 4.4),
             ...
             'texts': [{'text': '$h(2-\\tau)=2$', 'x': 2.45, 'y': 2.18, 'fontsize': 15},
                       {'text': 'overlap 1<=tau<=3',
                        'x': 2.0,
                        'y': 0.9,
                        'fontsize': 14}]},
            {'xlim': (-0.4, 4.4),
             ...
             'texts': [{'text': '$x(\\tau)h(2-\\tau)=2$',
                        'x': 2.0,
                        'y': 1.18,
                        'fontsize': 15},
                       {'text': '$4 = y(2)$', 'x': 2.0, 'y': 2.28, 'fontsize': 15}]}],
 'figure_texts': [{'text': 'fixed $t=2$',
                   'x': 0.5,
                   'y': 0.978,
                   'fontsize': 15,
                   'va': 'top'}]}
