...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l007-s002-qg-q002-q002.png',
 'figure_size': (10.4, 10.0),
 'panels': [{'xlim': (0.6, 5.4),
             'ylim': (-0.35, 3.65),
             'xticks': [1, 2, 3, 4, 5],
             'yticks': [3],
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 1, 'end': 4, 'height': 3},
             'overlap': {'start': 2, 'end': 4, 'height': 3, 'fill_alpha': 0.22},
             'texts': [{'text': '$x(\\tau)=3$', 'x': 2.5, 'y': 3.18, 'fontsize': 15},
                       {'text': 'overlap 2<=tau<=4',
                        'x': 3.0,
                        'y': 1.72,
                        'fontsize': 14}]},
            {'xlim': (0.6, 5.4),
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 2, 'end': 5, 'height': 2},
             'overlap': {'start': 2, 'end': 4, 'height': 2, 'fill_alpha': 0.22},
             'texts': [{'text': '$h(4-\\tau)=2$', 'x': 3.55, 'y': 2.18, 'fontsize': 15},
                       {'text': 'overlap 2<=tau<=4',
                        'x': 3.0,
                        'y': 1.18,
                        'fontsize': 14}]},
            {'xlim': (0.6, 5.4),
             ...
             'equal_aspect': True,
             'show_origin': True,
             'main_rect': {'start': 2, 'end': 4, 'height': 6, 'fill_alpha': 0.18},
             'texts': [{'text': '$x(\\tau)h(4-\\tau)=6$',
                        'x': 3.0,
                        'y': 5.18,
                        'fontsize': 15}]}],
 'figure_texts': [{'text': 'fixed $t=4$',
                   'x': 0.5,
                   'y': 0.978,
                   'fontsize': 15,
                   'va': 'top'}]}
