...
def main():
    ...
    plot_signal(ax, [-0.4, 0, 0, 3, 3, 6, 6, 6.4], [0, 0, 2, 2, 4, 4, 0, 0])
    ax.text(3.0, 5.03, "fixed $t=5$",
            fontsize=14, ha="center", va="bottom", color=ANNOTATION_COLOR, clip_on=False)
    ax.annotate(
        "$\\tau=1\\Rightarrow u=5-1=4$",
        xy=[4, 4],
        xytext=[4.58, 4.35],
        fontsize=13,
        color=ANNOTATION_COLOR,
    ...
    fig.tight_layout()
    save_ct_figure(fig, "/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l002-s004-qg-q001-q001.png")
    plt.close(fig)
