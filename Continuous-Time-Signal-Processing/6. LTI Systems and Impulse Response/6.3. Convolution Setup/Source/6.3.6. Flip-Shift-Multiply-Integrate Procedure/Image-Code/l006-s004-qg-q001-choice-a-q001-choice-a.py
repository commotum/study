...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s004-qg-q001-choice-a-q001-choice-a.png',
 'panel': {'segments': [(0, 4, 6, True, True)],
           'xlim': (-0.85, 4.85),
           'ylim': (-0.7, 6.7),
           'xticks': [0, 4],
           'yticks': [6],
