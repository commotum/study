...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s003-qg-q001-choice-b-q001-choice-b.png',
 'panel': {'segments': [(4, 5, 1, True, True), (5, 7, 2, False, True)],
           'xlim': (-0.85, 7.85),
           'ylim': (-0.7, 2.7),
           'xticks': [4, 5, 7],
           'yticks': [1, 2],
