...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s005-qg-q002-prompt-q002.png',
 'panel': {'segments': [(-1, 2, -2, True, True)],
           'xlim': (-1.85, 2.85),
           'ylim': (-3.5, 0.7),
           'xticks': [-1, 0, 2],
           'yticks': [-2],
           ...
           'baseline': 0.0,
           'reflection_axis': None,
           'shade_regions': [{'x_left': -1, 'x_right': 2, 'alpha': 0.09}],
           'support_brackets': [{'start': -1, 'end': 2, 'y': -2.55, 'label': '3'}],
           'vertical_lines': [],
           'horizontal_lines': [],
           'texts': [{'x': -1.8,
                      'y': 0.6499999999999999,
                      'text': '$p(\\tau)=x(\\tau)h(3-\\tau)$',
                      'fontsize': 17,
                      'ha': 'left',
                      'va': 'top'},
                     {'x': -1.8,
