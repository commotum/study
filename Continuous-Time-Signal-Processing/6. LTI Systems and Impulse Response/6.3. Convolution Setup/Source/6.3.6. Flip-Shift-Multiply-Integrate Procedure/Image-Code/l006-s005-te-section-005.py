...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s005-te-section-005.png',
 'panel': {'segments': [(0, 1, 2, True, True)],
           'xlim': (-0.85, 1.85),
           'ylim': (-1.15, 2.7),
           'xticks': [0, 1],
           'yticks': [2],
           ...
           'baseline': 0.0,
           'reflection_axis': None,
           'shade_regions': [{'x_left': 0, 'x_right': 1, 'alpha': 0.09}],
           'support_brackets': [{'start': 0, 'end': 1, 'y': -0.45, 'label': '1'}],
           'vertical_lines': [],
           'horizontal_lines': [],
