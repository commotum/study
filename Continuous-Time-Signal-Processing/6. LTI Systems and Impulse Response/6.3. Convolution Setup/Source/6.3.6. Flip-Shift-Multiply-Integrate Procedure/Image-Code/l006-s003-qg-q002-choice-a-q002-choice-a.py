...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s003-qg-q002-choice-a-q002-choice-a.png',
 'panel': {'segments': [(2, 4, 3, True, False), (4, 6, 1, True, True)],
           'xlim': (-0.85, 6.85),
           'ylim': (-0.7, 3.7),
           'xticks': [2, 4, 6],
           'yticks': [1, 3],
