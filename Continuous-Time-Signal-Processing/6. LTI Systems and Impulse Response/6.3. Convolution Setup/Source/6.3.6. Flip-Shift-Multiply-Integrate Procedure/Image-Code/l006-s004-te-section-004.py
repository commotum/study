...
SPEC = {'kind': 'stacked',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s004-te-section-004.png',
 'xlim': (-1.85, 2.85),
 'panel_ylims': [(-0.7, 2.7), (-0.7, 2.7), (-0.7, 2.7)],
 'panels': [{'segments': [(0, 2, 2, True, True)],
             'xlim': (-0.85, 2.85),
             'ylim': (-0.7, 2.7),
             'xticks': [0, 1, 2],
             'yticks': [2],
             ...
             'baseline': 0.0,
             'reflection_axis': None,
             'shade_regions': [{'x_left': 0, 'x_right': 1, 'alpha': 0.08}],
             'support_brackets': [],
             'vertical_lines': [],
             'horizontal_lines': [],
             'texts': []},
            ...
            {'segments': [(0, 1, 2, True, True)],
             ...
             'baseline': 0.0,
             'reflection_axis': None,
             'shade_regions': [{'x_left': 0, 'x_right': 1, 'alpha': 0.1}],
             'support_brackets': [],
             'vertical_lines': [],
             'horizontal_lines': [],
             'texts': []}],
