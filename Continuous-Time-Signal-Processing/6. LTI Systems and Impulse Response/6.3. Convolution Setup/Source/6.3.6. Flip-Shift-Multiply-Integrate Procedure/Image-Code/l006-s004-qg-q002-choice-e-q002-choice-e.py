...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s004-qg-q002-choice-e-q002-choice-e.png',
 'panel': {'segments': [(-1, 1, -2, True, True)],
           'xlim': (-1.85, 1.85),
           'ylim': (-2.7, 0.7),
           'xticks': [-1, 0, 1],
           'yticks': [-2],
           ...
           'baseline': 0.0,
           'reflection_axis': None,
           'shade_regions': [{'x_left': -1, 'x_right': 1, 'alpha': 0.09}],
           'support_brackets': [],
           'vertical_lines': [],
           'horizontal_lines': [],
           'texts': []},
