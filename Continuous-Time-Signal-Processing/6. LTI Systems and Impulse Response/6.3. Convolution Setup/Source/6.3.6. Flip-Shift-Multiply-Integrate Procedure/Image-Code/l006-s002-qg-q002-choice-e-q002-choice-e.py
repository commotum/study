...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s002-qg-q002-choice-e-q002-choice-e.png',
 'panel': {'segments': [(-3, -2, 1, True, True), (-2, 0, 2, False, True)],
           'xlim': (-3.85, 0.85),
           'ylim': (-0.7, 2.7),
           'xticks': [-3, -2, 0],
           'yticks': [1, 2],
