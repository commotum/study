...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s002-qg-q001-choice-c-q001-choice-c.png',
 'panel': {'segments': [(-2, 0, 3, True, True), (0, 1, 1, False, True)],
           'xlim': (-2.85, 1.85),
           'ylim': (-0.7, 3.7),
           'xticks': [-2, 0, 1],
           'yticks': [1, 3],
