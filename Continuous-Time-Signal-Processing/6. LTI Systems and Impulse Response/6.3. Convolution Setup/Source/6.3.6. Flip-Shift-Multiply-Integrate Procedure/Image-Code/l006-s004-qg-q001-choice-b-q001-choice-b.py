...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s004-qg-q001-choice-b-q001-choice-b.png',
 'panel': {'segments': [(0, 3, 3, True, True)],
           'xlim': (-0.85, 3.85),
           'ylim': (-0.7, 3.7),
           'xticks': [0, 3],
           'yticks': [3],
           ...
           'baseline': 0.0,
           'reflection_axis': None,
           'shade_regions': [{'x_left': 0, 'x_right': 3, 'alpha': 0.09}],
           'support_brackets': [],
           'vertical_lines': [],
           'horizontal_lines': [],
           'texts': []},
