...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s002-qg-q002-choice-c-q002-choice-c.png',
 'panel': {'segments': [(2, 4, -2, True, False), (4, 5, -1, True, True)],
           'xlim': (-0.85, 5.85),
           'ylim': (-2.7, 0.7),
           'xticks': [0, 2, 4, 5],
           'yticks': [-2, -1],
