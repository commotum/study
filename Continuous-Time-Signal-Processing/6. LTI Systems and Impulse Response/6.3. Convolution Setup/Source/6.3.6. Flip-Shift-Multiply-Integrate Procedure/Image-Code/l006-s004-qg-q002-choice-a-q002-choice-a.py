...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s004-qg-q002-choice-a-q002-choice-a.png',
 'panel': {'segments': [(-1, 4, -2, True, True)],
           'xlim': (-1.85, 4.85),
           'ylim': (-2.7, 0.7),
           'xticks': [-1, 0, 4],
           'yticks': [-2],
