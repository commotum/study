...
SPEC = {'kind': 'single',
 'image_output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/6.3--convolution-setup-Images/images/l006-s002-qg-q002-choice-a-q002-choice-a.png',
 'panel': {'segments': [(-5, -4, 1, True, True), (-4, -2, 2, False, True)],
           'xlim': (-5.85, 0.85),
           'ylim': (-0.7, 2.7),
           'xticks': [-5, -4, -2],
           'yticks': [1, 2],
