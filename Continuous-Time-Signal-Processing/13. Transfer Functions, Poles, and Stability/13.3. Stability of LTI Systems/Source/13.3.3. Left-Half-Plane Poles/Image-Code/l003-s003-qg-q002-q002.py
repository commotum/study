...
OUTPUT_PATH = Path(
    "/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.3--stability-of-lti-systems-Images/images/l003-s003-qg-q002-q002.png"
)
...
def main():
    ...
    add_pole(ax, 0, 0, r"$0$", dx=0.14, dy=0.18, ha="left", va="bottom")
