...
OUTPUT_PATH = Path(
    "/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.3--stability-of-lti-systems-Images/images/l003-s001-te-section-001.png"
)
...
def main():
    ...
    ax.axvspan(xlim[0], 0, color=SIGNAL_COLOR, alpha=0.08, zorder=0)
    ...
    ax.text(-2.95, -2.45, r"all poles must satisfy $\Re\{s\}<0$", fontsize=ANNOTATION_SIZE, ha="left", va="center", color=ANNOTATION_COLOR, zorder=2)
