...
CONFIG = {'covered_template': 's-plane-damped-oscillation', 'xlim': (-3.2, 1.5), 'ylim': (-5.0, 5.0), 'xticks': [-3, -2, -1, 1], 'yticks': [-4, -2, 2, 4], 'x_axis_label': '$\\sigma$', 'y_axis_label': '$\\omega$', 'poles': [{'x': -0.25, 'y': -4, 'label': '$-0.25-j4$', 'label_offset': (-0.35, -0.6), 'label_ha': 'left', 'label_va': 'top'}], 'guides': [{'x_values': [-0.25, -0.25], 'y_values': [0, -4], 'color': '#777777'}, {'x_values': [0, -0.25], 'y_values': [-4, -4], 'color': '#777777'}], 'annotations': [{'text': '$\\sigma=-0.25$', 'xy': (-0.25, 0), 'xytext': (-1.85, -0.95), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}, {'text': '$\\omega=-4$', 'xy': (0, -4), 'xytext': (0.32, -4.35), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}, {'text': 'decay + oscillation', 'xy': (-0.25, -4), 'xytext': (-2.75, -2.0), 'arrow': True, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}], 'render_notes': ['Lower-half-plane mixed pole with guides to both coordinates.', 'The smaller magnitude of sigma indicates a slowly decaying envelope.'], 'show_grid': True, 'show_origin': True, 'x_minor_grid_step': 1, 'y_minor_grid_step': 1, 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l007-s005-qg-q002-q002.png'}
