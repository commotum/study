...
def main():
    ...
    setup_axes(ax, xlim=xlim, ylim=ylim, xticks=[-4, -2, 0, 2], yticks=[-2, -1, 1, 2])
    fig.text(0.08, 0.985, '$H(s)=\\frac{s-2}{s(s+4)}$', ha="left", va="top", fontsize=15, color=LABEL_COLOR)
    save_figure(fig, Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l003-s002-qg-q002-q002.png'))
