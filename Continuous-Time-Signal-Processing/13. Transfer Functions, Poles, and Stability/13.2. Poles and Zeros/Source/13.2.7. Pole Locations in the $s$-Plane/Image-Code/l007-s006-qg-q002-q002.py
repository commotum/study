...
CONFIG = {'covered_template': 's-plane-multi-pole-comparison', 'xlim': (-7.5, 2.5), 'ylim': (-7.5, 7.5), 'xticks': [-7, -5, -3, -1, 1, 2], 'yticks': [-6, -4, -2, 2, 4, 6], 'x_axis_label': '$\\sigma$', 'y_axis_label': '$\\omega$', 'poles': [{'x': 1, 'y': 2, 'label': '$1+j2$', 'label_offset': (0.1, 0.25), 'label_ha': 'left', 'label_va': 'bottom'}, {'x': -2, 'y': 7, 'label': '$-2+j7$', 'label_offset': (0.1, 0.25), 'label_ha': 'left', 'label_va': 'bottom'}, {'x': -6, 'y': 0, 'label': '$-6$', 'label_offset': (-0.18, 0.28), 'label_ha': 'left', 'label_va': 'bottom'}], 'annotations': [{'text': '$\\sigma=1$', 'xy': (1, 2), 'xytext': (1.1, 2.8), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 10}, {'text': '$|\\omega|=7$', 'xy': (-2, 7), 'xytext': (-1.9, 7.9), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 10}, {'text': '$\\sigma=-6$', 'xy': (-6, 0), 'xytext': (-6.7, 1.45), 'arrow': True, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 10}], 'render_notes': ['Comparison prompt with a right-half-plane pole, a high-frequency stable pair, and a fast-decay real pole.', 'Labels emphasize both the dominant real-part effect and the largest imaginary magnitude.'], 'show_grid': True, 'show_origin': True, 'x_minor_grid_step': 1, 'y_minor_grid_step': 1, 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l007-s006-qg-q002-q002.png'}
