...
CONFIG = {'covered_template': 's-plane-real-axis-pole', 'xlim': (-4, 4), 'ylim': (-1.8, 1.8), 'xticks': [-4, -3, -2, -1, 1, 2, 3, 4], 'yticks': [-1, 1], 'x_axis_label': '$\\sigma$', 'y_axis_label': '$\\omega$', 'show_grid': True, 'show_origin': True, 'shading': [{'x0': 0, 'x1': 4, 'color': '#2f78b7', 'alpha': 0.055}], 'poles': [{'x': 2, 'y': 0, 'label': '$2$', 'label_offset': (0.1, 0.28), 'label_ha': 'left', 'label_va': 'bottom'}], 'annotations': [{'text': 'growth', 'xy': (2, 0), 'xytext': (2.8, 1.0), 'arrow': True, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}, {'text': '$\\omega=0$', 'xy': (2, 0), 'xytext': (1.15, 0.52), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}], 'render_notes': ['Real-axis pole with right-half-plane shading to indicate growth.', 'The prompt isolates the sign of sigma while omega remains zero.'], 'x_minor_grid_step': 1, 'y_minor_grid_step': 1, 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l007-s003-qg-q002-q002.png'}
