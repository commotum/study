...
CONFIG = {'covered_template': 's-plane-real-axis-pole', 'xlim': (-4, 4), 'ylim': (-1.8, 1.8), 'xticks': [-4, -3, -2, -1, 1, 2, 3, 4], 'yticks': [-1, 1], 'x_axis_label': '$\\sigma$', 'y_axis_label': '$\\omega$', 'shading': [{'x0': -4, 'x1': 0, 'color': '#2f78b7', 'alpha': 0.05}], 'poles': [{'x': -3, 'y': 0, 'label': '$-3$', 'label_offset': (-0.18, 0.28), 'label_ha': 'left', 'label_va': 'bottom'}], 'annotations': [{'text': '$\\omega=0$', 'xy': (-3, 0), 'xytext': (-3.3, 0.55), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}, {'text': '$e^{-3t}$', 'xy': (-3, 0), 'xytext': (-1.8, -1.15), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}], 'render_notes': ['Section-only real-axis pole emphasizing the decaying exponential mode.', 'Light shading keeps the left-half-plane interpretation visible.'], 'show_grid': True, 'show_origin': True, 'x_minor_grid_step': 1, 'y_minor_grid_step': 1, 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l007-s003-te-section-003.png'}
