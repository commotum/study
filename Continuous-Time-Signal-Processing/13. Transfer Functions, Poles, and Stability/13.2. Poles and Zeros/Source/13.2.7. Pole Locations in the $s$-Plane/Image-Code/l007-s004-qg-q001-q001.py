...
CONFIG = {'covered_template': 's-plane-imag-axis-pole', 'xlim': (-1.2, 1.2), 'ylim': (-6.5, 6.5), 'xticks': [-1, 1], 'yticks': [-6, -4, -2, 2, 4, 6], 'x_axis_label': '$\\sigma$', 'y_axis_label': '$\\omega$', 'poles': [{'x': 0, 'y': 5, 'label': '$p=j5$', 'label_offset': (0.12, 0.2), 'label_ha': 'left', 'label_va': 'bottom'}], 'annotations': [{'text': 'sustained oscillation', 'xy': (0, 5), 'xytext': (0.45, 4.5), 'arrow': True, 'ha': 'left', 'va': 'center', 'color': '#555555', 'fontsize': 11}, {'text': '$\\omega=5$', 'xy': (0, 5), 'xytext': (0.12, 5.55), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}], 'render_notes': ['Imaginary-axis pole with explicit p=j5 label and oscillation-rate cue.', 'The real coordinate is zero, so the mode is sustained rather than decaying.'], 'show_grid': True, 'show_origin': True, 'x_minor_grid_step': 1, 'y_minor_grid_step': 1, 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l007-s004-qg-q001-q001.png'}
