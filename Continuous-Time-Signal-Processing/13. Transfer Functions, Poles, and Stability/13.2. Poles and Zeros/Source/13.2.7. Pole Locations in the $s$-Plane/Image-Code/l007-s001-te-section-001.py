...
CONFIG = {'covered_template': 's-plane-pole-introduction', 'xlim': (-4, 4), 'ylim': (-3.2, 3.2), 'xticks': [-4, -2, -1, 1, 2, 4], 'yticks': [-3, -2, -1, 1, 2, 3], 'x_axis_label': '$\\sigma$', 'y_axis_label': '$j\\omega$', 'poles': [{'x': -2, 'y': 0, 'label': '$-2$', 'label_offset': (-0.35, 0.3), 'label_ha': 'left', 'label_va': 'bottom'}, {'x': -1, 'y': 1, 'label': '$-1+j$', 'label_offset': (-0.32, 0.38), 'label_ha': 'left', 'label_va': 'bottom'}, {'x': 1, 'y': -1, 'label': '$1-j$', 'label_offset': (0.1, -0.55), 'label_ha': 'left', 'label_va': 'top'}], 'annotations': [{'text': '$\\sigma<0$ decay', 'xy': (-2, 0), 'xytext': (-3.5, 1.9), 'arrow': True, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}, {'text': '$\\sigma>0$ growth', 'xy': (1, -1), 'xytext': (2.05, -2.0), 'arrow': True, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}, {'text': '$\\sigma=-1,\\ \\omega=1$', 'xy': (-1, 1), 'xytext': (-0.25, 2.35), 'arrow': True, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}], 'render_notes': ['Instructional sign-convention overview with three sample poles.', 'Uses light coordinate notes to connect sigma and omega to pole location.'], 'show_grid': True, 'show_origin': True, 'x_minor_grid_step': 1, 'y_minor_grid_step': 1, 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l007-s001-te-section-001.png'}
