...
CONFIG = {'covered_template': 's-plane-single-pole', 'xlim': (-3.5, 3.5), 'ylim': (-3.5, 3.5), 'xticks': [-3, -2, -1, 1, 2, 3], 'yticks': [-3, -2, -1, 1, 2, 3], 'x_axis_label': '$\\sigma$', 'y_axis_label': '$j\\omega$', 'poles': [{'x': -2, 'y': 1, 'label': '$-2+j1$', 'label_offset': (-0.38, 0.38), 'label_ha': 'left', 'label_va': 'bottom'}], 'guides': [{'x_values': [-2, -2], 'y_values': [0, 1], 'color': '#777777'}, {'x_values': [0, -2], 'y_values': [1, 1], 'color': '#777777'}], 'annotations': [{'text': '$\\sigma=-2$', 'xy': (-2, 0), 'xytext': (-3.25, -0.95), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}, {'text': '$\\omega=1$', 'xy': (0, 1), 'xytext': (0.25, 1.22), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}], 'render_notes': ['Section-only coordinate-reading figure with light guides to both axes.', 'Uses a single pole at -2+j1 for direct component extraction.'], 'show_grid': True, 'show_origin': True, 'x_minor_grid_step': 1, 'y_minor_grid_step': 1, 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l007-s002-te-section-002.png'}
