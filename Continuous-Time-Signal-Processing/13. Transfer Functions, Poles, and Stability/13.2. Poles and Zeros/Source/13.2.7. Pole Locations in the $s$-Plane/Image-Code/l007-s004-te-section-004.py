...
CONFIG = {'covered_template': 's-plane-imag-axis-pole', 'xlim': (-1.2, 1.2), 'ylim': (-3.2, 3.2), 'xticks': [-1, 1], 'yticks': [-3, -2, -1, 1, 2, 3], 'x_axis_label': '$\\sigma$', 'y_axis_label': '$\\omega$', 'poles': [{'x': 0, 'y': 2, 'label': '$j2$', 'label_offset': (0.12, 0.22), 'label_ha': 'left', 'label_va': 'bottom'}], 'annotations': [{'text': 'oscillation rate', 'xy': (0, 2), 'xytext': (0.42, 2.75), 'arrow': True, 'ha': 'left', 'va': 'center', 'color': '#555555', 'fontsize': 11}, {'text': '$\\sigma=0$', 'xy': (0, 2), 'xytext': (-0.95, 0.3), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}], 'render_notes': ['Section-only imaginary-axis pole at j2 with a compact oscillation annotation.', 'No decay or growth is shown because sigma is zero.'], 'show_grid': True, 'show_origin': True, 'x_minor_grid_step': 1, 'y_minor_grid_step': 1, 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l007-s004-te-section-004.png'}
