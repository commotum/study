...
CONFIG = {'covered_template': 's-plane-damped-oscillation', 'xlim': (-3.2, 1.5), 'ylim': (-5.0, 5.0), 'xticks': [-3, -2, -1, 1], 'yticks': [-4, -2, 2, 4], 'x_axis_label': '$\\sigma$', 'y_axis_label': '$\\omega$', 'poles': [{'x': -1, 'y': 2, 'label': '$-1+j2$', 'label_offset': (0.1, 0.28), 'label_ha': 'left', 'label_va': 'bottom'}], 'guides': [{'x_values': [-1, -1], 'y_values': [0, 2], 'color': '#777777'}, {'x_values': [0, -1], 'y_values': [2, 2], 'color': '#777777'}], 'annotations': [{'text': '$\\sigma=-1$', 'xy': (-1, 0), 'xytext': (-2.15, -0.95), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}, {'text': '$\\omega=2$', 'xy': (0, 2), 'xytext': (0.3, 2.28), 'arrow': False, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}, {'text': 'decay + oscillation', 'xy': (-1, 2), 'xytext': (-2.7, 4.15), 'arrow': True, 'ha': 'left', 'va': 'bottom', 'color': '#555555', 'fontsize': 11}], 'render_notes': ['Mixed pole with dotted guides from the point to each axis intercept.', 'Combines decay from the negative real part with oscillation from the imaginary part.'], 'show_grid': True, 'show_origin': True, 'x_minor_grid_step': 1, 'y_minor_grid_step': 1, 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.2--poles-and-zeros-Images/images/l007-s005-qg-q001-q001.png'}
