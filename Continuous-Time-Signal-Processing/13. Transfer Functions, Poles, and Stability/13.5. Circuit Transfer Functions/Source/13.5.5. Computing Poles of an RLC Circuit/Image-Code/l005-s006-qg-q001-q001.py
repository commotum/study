...
def main():
    ...
    add_region_labels(ax, stable_xy=(-3.7, 2.55), unstable_xy=(1.15, 2.55), boundary_xy=(0.15, 0.95))

    draw_double_pole(ax, -2.0, 0.0)
    draw_pole(ax, -3.0, 2.0)
    draw_pole(ax, -3.0, -2.0)

    out = Path(
        "/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/13.5--circuit-transfer-functions-Images/images/l005-s006-qg-q001-q001.png"
    )
