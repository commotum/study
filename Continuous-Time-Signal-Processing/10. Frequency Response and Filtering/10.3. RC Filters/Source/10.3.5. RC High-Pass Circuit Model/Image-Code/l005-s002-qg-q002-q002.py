...
OUTPUT_PATH = Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/10.3--rc-filters-Images/images/l005-s002-qg-q002-q002.png')
SCENE = {'layout': 'single', 'kind': 'high-pass', 'mirror': True, 'show_source_label': True, 'show_input_arrow': False, 'show_output_arrow': False, 'show_output_node_label': True, 'output_target': 'shunt', 'swap_labels': False, 'note_text': None, 'panel_title': None, 'source_text': '$v_{in}(t)$', 'output_text': '$v_{out}(t)$', 'show_component_labels': True, 'figsize': [8.6, 4.6]}
