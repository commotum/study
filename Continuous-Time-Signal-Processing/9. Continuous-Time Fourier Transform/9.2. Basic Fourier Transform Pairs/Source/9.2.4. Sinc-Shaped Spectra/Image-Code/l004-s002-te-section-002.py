...
CONFIG = {'scene': 'region_spectrum',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/9.2--basic-fourier-transform-pairs-Images/images/l004-s002-te-section-002.png',
 ...
 'yticks': [0, 1, 2, 3],
 'highlight_regions': ('B', 'C', 'D'),
 'annotations': [{'text': 'central lobe', 'x': 0.0, 'y_frac': 1.15},
                 {'text': 'first sidelobe', 'x': -3.0, 'y_frac': 1.08},
                 {'text': 'first sidelobe', 'x': 3.0, 'y_frac': 1.08}],
 'zero_guides': 3,
 'center_fill_alpha': 0.1,
 'bottom_caption': 'The central lobe sits around zero frequency; the first sidelobes are the adjacent lobes.'}
