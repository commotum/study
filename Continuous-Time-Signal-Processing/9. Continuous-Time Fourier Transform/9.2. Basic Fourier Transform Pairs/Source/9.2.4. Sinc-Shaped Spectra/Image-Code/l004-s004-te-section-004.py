...
CONFIG = {'scene': 'pair_grid',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/9.2--basic-fourier-transform-pairs-Images/images/l004-s004-te-section-004.png',
 'left_header': 'Tall pulse',
 'right_header': 'Short pulse',
 'bottom_caption': 'Amplitude rescales the spectrum vertically while leaving width unchanged.',
 'left': {'panel_label': 'A',
          ...
          'spectrum_ylim': [0.0, 11.498229112138642],
          'spectrum_xticks': [-8, -4, 0, 4, 8],
          'spectrum_yticks': [0, 4.71238898038469, 9.42477796076938]},
 'right': {'panel_label': 'B',
           'duration': 3.141592653589793,
           'amplitude': 1.0,
           'duration_label': '$T$',
