...
CONFIG = {'scene': 'intro_pair',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/9.2--basic-fourier-transform-pairs-Images/images/l004-s001-te-section-001.png',
 'bottom_caption': 'Shorter T gives a wider central lobe; larger A gives a taller spectrum.',
 'left': {'duration': 3.141592653589793,
          'amplitude': 1.0,
          'formula': '$x(t)=A\\,\\mathrm{rect}(t/T)$',
          'duration_label': '$T$',
          'amplitude_label': '$A$',
          'note': None,
          'xlim': [-4.5, 4.5],
          ...
          'xticks': [-4, -2, 0, 2, 4],
          'yticks': [0, 1.0]},
 'right': {'duration': 3.141592653589793,
           'amplitude': 1.0,
           'formula': '$X(\\omega)=AT\\,\\mathrm{sinc}(\\omega T/2)$',
           'note': None,
           'highlight_regions': ('C',),
           'annotations': [{'text': 'central lobe', 'x': 0.0, 'y_frac': 1.12, 'ha': 'center'}],
           'zero_guides': 3,
           'fill_central': True,
           'center_fill_alpha': 0.11,
           'xlim': [-8.5, 8.5],
           'ylim': [0.0, 3.7699111843077517],
           'xticks': [-8, -4, 0, 4, 8],
           'yticks': [0, 1.5, 3.0]}}
