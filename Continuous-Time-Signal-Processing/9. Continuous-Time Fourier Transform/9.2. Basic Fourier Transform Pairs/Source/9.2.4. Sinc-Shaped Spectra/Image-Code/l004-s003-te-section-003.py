...
CONFIG = {'scene': 'pair_grid',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/9.2--basic-fourier-transform-pairs-Images/images/l004-s003-te-section-003.png',
 'left_header': 'Short pulse',
 'right_header': 'Long pulse',
 'bottom_caption': 'Shorter T spreads the spectrum; longer T compresses the zero spacing.',
 'left': {'panel_label': 'A',
          ...
          'spectrum_note': 'wider central lobe',
          'highlight_regions': ('C',),
          'annotations': [{'text': 'wider central lobe', 'x': 0.0, 'y_frac': 1.13}],
          'zero_guides': 2,
          'fill_central': True,
 ...
 'right': {'panel_label': 'B',
           ...
           'spectrum_note': 'tighter sidelobe spacing',
           'highlight_regions': ('C',),
           'annotations': [{'text': 'tighter sidelobe spacing', 'x': 0.0, 'y_frac': 1.13}],
           'zero_guides': 2,
           'fill_central': True,
           'center_fill_alpha': 0.1,
           'spectrum_xlim': [-8.5, 8.5],
