...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l002-s005-qg-q001-choice-e-q001-choice-e.png',
 'xlim': [-4.8, 4.8],
 'ylim': [-2.8, 3.8],
 'xticks': [-4, -3, -2, 0, 2, 3, 4],
 'yticks': [-2, -1, 1, 2, 3],
 'components': [{'kind': 'pulse', 'start': 3, 'end': 4, 'height': 1, 'base': 0.0},
                {'kind': 'pulse', 'start': -3, 'end': -2, 'height': -2, 'base': 0.0}],
 'texts': [],
 'template': 'fixed-point-pulse-reflection-plot',
 'notes': ['reflected pulses shown without the spike at t=0'],
 'y_label': '$x(t)$',
 'y_tick_label_side': 'left',
 'show_grid': True,
 'show_origin': True,
