...
SPEC = {'layout': 'two-panel',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l002-s003-te-section-003.png',
 'xlim': [-4.5, 4.5],
 'ylim': [-0.8, 2.8],
 'xticks': [-4, -2, 2, 4],
 'yticks': [1, 2],
 'left': {'components': [{'kind': 'segment', 'points': [[0, 0], [2, 2], [4, 0]]}],
          'texts': [],
          'y_label': '$x(t)$',
          'x_label': '$t$',
          'y_tick_label_side': 'left'},
 'right': {'components': [{'kind': 'segment', 'points': [[-4, 0], [-2, 2], [0, 0]]}],
           'texts': [],
           'y_label': '$x(-t)$',
           'x_label': '$t$',
           'y_tick_label_side': 'left'},
 'template': 'two-panel-triangle-reflection',
 'notes': ['triangular segment mirrored across t=0'],
 'show_grid': True,
 'show_origin': True,
 'equal_aspect': True,
 'gap_px': 46}
