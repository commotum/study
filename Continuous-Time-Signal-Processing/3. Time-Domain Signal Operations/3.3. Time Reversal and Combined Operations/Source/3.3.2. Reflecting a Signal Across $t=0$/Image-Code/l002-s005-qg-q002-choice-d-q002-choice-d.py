...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l002-s005-qg-q002-choice-d-q002-choice-d.png',
 'xlim': [-3.8, 3.8],
 'ylim': [-2.8, 3.0],
 'xticks': [-3, -2, -1, 0, 1, 2, 3],
 'yticks': [-2, -1, 1, 2],
 'components': [{'kind': 'spike', 't': 0, 'height': -2, 'base': 0.0},
                {'kind': 'pulse', 'start': 2, 'end': 3, 'height': 2, 'base': 0.0},
                {'kind': 'pulse', 'start': 1, 'end': 3, 'height': -1, 'base': 0.0}],
 'texts': [],
