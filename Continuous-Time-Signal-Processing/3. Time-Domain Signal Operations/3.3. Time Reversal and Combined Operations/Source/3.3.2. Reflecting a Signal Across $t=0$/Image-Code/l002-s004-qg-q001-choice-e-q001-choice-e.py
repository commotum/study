...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l002-s004-qg-q001-choice-e-q001-choice-e.png',
 'xlim': [-5.5, 5.5],
 'ylim': [-3.5, 3.8],
 'xticks': [-4, -2, -1, 0, 1, 2, 3, 4],
 'yticks': [-3, -1, 1, 2, 3],
 'components': [{'kind': 'spike', 't': 3, 'height': 3, 'base': 0.0},
                {'kind': 'spike', 't': -2, 'height': -1, 'base': 0.0},
                {'kind': 'pulse', 'start': -4, 'end': -2, 'height': 2, 'base': 0.0}],
 'texts': [],
