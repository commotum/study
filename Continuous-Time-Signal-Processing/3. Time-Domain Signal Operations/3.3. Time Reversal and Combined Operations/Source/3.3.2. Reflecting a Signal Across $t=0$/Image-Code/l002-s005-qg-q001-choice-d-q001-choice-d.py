...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l002-s005-qg-q001-choice-d-q001-choice-d.png',
 'xlim': [-4.8, 4.8],
 'ylim': [-2.8, 3.8],
 'xticks': [-4, -3, -2, 0, 2, 3, 4],
 'yticks': [-2, -1, 1, 2, 3],
 'components': [{'kind': 'spike', 't': 0, 'height': 3, 'base': 0.0},
 ...
 'notes': ['one off-axis pulse left unreflected on the right side'],
 'y_label': '$x(t)$',
 'y_tick_label_side': 'left',
 'show_grid': True,
 'show_origin': True,
