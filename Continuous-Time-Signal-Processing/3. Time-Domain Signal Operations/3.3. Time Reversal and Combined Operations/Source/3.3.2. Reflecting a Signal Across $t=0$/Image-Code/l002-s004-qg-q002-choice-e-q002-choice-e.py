...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l002-s004-qg-q002-choice-e-q002-choice-e.png',
 'xlim': [-5.5, 5.5],
 'ylim': [-3.5, 3.8],
 'xticks': [-5, -4, -3, -1, 0, 1, 2, 3, 4, 5],
 'yticks': [-3, -2, -1, 1, 2, 3],
 'components': [{'kind': 'spike', 't': 2, 'height': 1, 'base': 0.0},
                {'kind': 'spike', 't': -3, 'height': -2, 'base': 0.0},
                {'kind': 'pulse', 'start': 3, 'end': 4, 'height': 3, 'base': 0.0}],
 'texts': [],
 'template': 'multi-feature-reflection-plot',
 'notes': ['pulse moved to the wrong positive time'],
 'y_label': '$x(t)$',
 'y_tick_label_side': 'left',
 'show_grid': True,
 'show_origin': True,
