...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l002-s004-qg-q001-choice-a-q001-choice-a.png',
 'xlim': [-5.5, 5.5],
 'ylim': [-3.5, 3.8],
 ...
 'components': [{'kind': 'spike', 't': 4, 'height': 3, 'base': 0.0},
                ...
                {'kind': 'pulse', 'start': -3, 'end': -1, 'height': 2, 'base': 0.0}],
 'texts': [],
