...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l002-s001-te-section-001.png',
 'xlim': [-5.0, 5.0],
 'ylim': [-0.8, 2.8],
 'xticks': [-4, -2, 2, 4],
 'yticks': [1, 2],
 'components': [{'kind': 'spike', 't': -3, 'height': 2, 'base': 0.0},
 ...
 'texts': [{'x': -3,
           ...
           {'x': 3,
            ...
            'zorder': 7,
            'fontsize': 13.871999999999998}],
 'template': 'single-peak-reflection-intro',
 'notes': ['paired peaks mirrored across t=0'],
 'y_label': '$x(t)$',
 'y_tick_label_side': 'left',
 'show_grid': True,
 'show_origin': True,
