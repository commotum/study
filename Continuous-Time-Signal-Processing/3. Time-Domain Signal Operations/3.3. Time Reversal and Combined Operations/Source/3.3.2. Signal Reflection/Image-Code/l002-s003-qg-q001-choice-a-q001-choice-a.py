...
SPEC = {'layout': 'single',
 'output_path': '/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.3--time-reversal-and-combined-operations-Images/images/l002-s003-qg-q001-choice-a-q001-choice-a.png',
 'xlim': [-6.5, 6.5],
 'ylim': [-2.6, 2.6],
 'xticks': [-6, -3, -1, 0, 1, 3, 6],
 'yticks': [-2, -1, 1, 2],
 'components': [{'kind': 'segment', 'points': [[-6, 0], [-3, 2], [-1, 2], [0, 0]]}],
 'texts': [],
 'template': 'piecewise-segment-reflection-plot',
 'notes': ['correct reflected segment on the negative-time side'],
 'y_label': '$x(t)$',
 'y_tick_label_side': 'left',
 'show_grid': True,
 'show_origin': True,
