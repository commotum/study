...
OUTPUT_PATH = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.1--time-shifting-Images/images/l001-s003-qg-q001-prompt-q001.png")
...
def main():
    ...
    draw_keypoint_polyline(ax, [(-1.0, 4.0), (0.0, -2.0), (2.0, 1.0)])
    label_point(ax, -1.0, 4.0, '$(-1,4)$', dx=-0.12, dy=0.28, ha='right', va='bottom')
    label_point(ax, 0.0, -2.0, '$(0,-2)$', dx=0.1, dy=-0.36, ha='left', va='top')
    label_point(ax, 2.0, 1.0, '$(2,1)$', dx=0.1, dy=0.28, ha='left', va='bottom')
    draw_shift_arrow(ax, -0.2, 3.8, 4.7, label='$T=4$')
