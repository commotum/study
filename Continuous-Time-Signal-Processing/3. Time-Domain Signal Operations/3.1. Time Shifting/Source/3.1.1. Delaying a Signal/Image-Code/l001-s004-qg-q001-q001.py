...
OUTPUT_PATH = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.1--time-shifting-Images/images/l001-s004-qg-q001-q001.png")
...
def main():
    ...
    draw_triangle_signal(ax_l, *(-2.0, 0.5, 3.0, 2.0))
    draw_triangle_signal(ax_r, *(2.0, 4.5, 7.0, 2.0))

    fig.canvas.draw()

    draw_cross_panel_arrow(fig, ax_l, ax_r, -2.0, 0.0, 2.0, label='$4$', label_offset=(0.0, 0.014))
    draw_cross_panel_arrow(fig, ax_l, ax_r, 3.0, 0.0, 7.0, label='$4$', label_offset=(0.0, 0.014))
