...
OUTPUT_PATH = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.1--time-shifting-Images/images/l001-s003-qg-q002-prompt-q002.png")
...
def main():
    ...
    draw_keypoint_polyline(ax, [(-2.0, 5.0), (1.0, 0.0), (4.0, -3.0)])
    label_point(ax, -2.0, 5.0, '$(-2,5)$', dx=-0.14, dy=0.28, ha='right', va='bottom')
    label_point(ax, 1.0, 0.0, '$(1,0)$', dx=0.1, dy=0.32, ha='left', va='bottom')
    label_point(ax, 4.0, -3.0, '$(4,-3)$', dx=0.1, dy=-0.38, ha='left', va='top')
    draw_shift_arrow(ax, -1.2, 2.8, 5.6, label='$T=3$')
