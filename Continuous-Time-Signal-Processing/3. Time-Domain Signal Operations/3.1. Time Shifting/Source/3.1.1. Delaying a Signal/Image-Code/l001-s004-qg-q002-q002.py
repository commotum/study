...
OUTPUT_PATH = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.1--time-shifting-Images/images/l001-s004-qg-q002-q002.png")
...
def main():
    ...
    draw_triangle_signal(ax_l, *(-1.0, 3.0, 7.0, 2.0))
    draw_triangle_signal(ax_r, *(1.0, 5.0, 9.0, 2.0))

    fig.canvas.draw()

    draw_cross_panel_arrow(fig, ax_l, ax_r, -1.0, 0.0, 1.0, label='$2$', label_offset=(0.0, 0.014))
    draw_cross_panel_arrow(fig, ax_l, ax_r, 7.0, 0.0, 9.0, label='$2$', label_offset=(0.0, 0.014))
