...
OUTPUT_PATH = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.1--time-shifting-Images/images/l001-s003-te-section-003.png")
...
def main():
    ...
    draw_keypoint_polyline(ax_l, [(-2.0, 3.0), (0.0, -1.0), (3.0, 2.0)])
    draw_keypoint_polyline(ax_r, [(0.0, 3.0), (2.0, -1.0), (5.0, 2.0)])
    label_point(ax_l, -2.0, 3.0, '$(-2,3)$', dx=-0.1, dy=0.26, ha='right', va='bottom')
    label_point(ax_l, 0.0, -1.0, '$(0,-1)$', dx=0.1, dy=-0.34, ha='left', va='top')
    label_point(ax_l, 3.0, 2.0, '$(3,2)$', dx=0.1, dy=0.26, ha='left', va='bottom')
    label_point(ax_r, 0.0, 3.0, '$(0,3)$', dx=0.1, dy=0.26, ha='left', va='bottom')
    label_point(ax_r, 2.0, -1.0, '$(2,-1)$', dx=0.1, dy=-0.34, ha='left', va='top')
    label_point(ax_r, 5.0, 2.0, '$(5,2)$', dx=0.1, dy=0.26, ha='left', va='bottom')

    fig.canvas.draw()

    draw_cross_panel_arrow(fig, ax_l, ax_r, -2.0, 3.0, 0.0, label='$2$', label_offset=(0.0, 0.014))
    draw_cross_panel_arrow(fig, ax_l, ax_r, 0.0, -1.0, 2.0, label='$2$', label_offset=(0.0, 0.014))
    draw_cross_panel_arrow(fig, ax_l, ax_r, 3.0, 2.0, 5.0, label='$2$', label_offset=(0.0, 0.014))
