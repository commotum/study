...
OUTPUT_PATH = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.1--time-shifting-Images/images/l001-s002-qg-q001-q001.png")
...
def main():
    ...
    draw_triangle_signal(ax_l, *(0.0, 1.0, 2.0, 2.0))
    draw_triangle_signal(ax_r, *(4.0, 5.0, 6.0, 2.0))
    label_point(ax_l, 1.0, 2.0, '$1$', dx=0.0, dy=0.26, ha='center', va='bottom')
    label_point(ax_r, 5.0, 2.0, '$5$', dx=0.0, dy=0.26, ha='center', va='bottom')

    fig.canvas.draw()

    draw_cross_panel_arrow(fig, ax_l, ax_r, 1.0, 2.0, 5.0, label='$4$', label_offset=(0.0, 0.014))
