...
OUTPUT_PATH = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.1--time-shifting-Images/images/l001-s004-te-section-004.png")
...
def main():
    ...
    draw_triangle_signal(ax_l, *(2.0, 4.0, 6.0, 2.0))
    draw_triangle_signal(ax_r, *(3.5, 5.5, 7.5, 2.0))

    fig.canvas.draw()

    draw_cross_panel_arrow(fig, ax_l, ax_r, 2.0, 0.0, 3.5, label='$1.5$', label_offset=(0.0, 0.014))
    draw_cross_panel_arrow(fig, ax_l, ax_r, 6.0, 0.0, 7.5, label='$1.5$', label_offset=(0.0, 0.014))
