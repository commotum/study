...
OUTPUT_PATH = Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.1--time-shifting-Images/images/l002-s005-te-section-005.png')
...
def build_figure():
    ...
    original_t = [0, 1, 5, 7, 7, 8]
    original_x = [0, 0, 3.0, 0, 0, 0]
    advanced_t = [-2, -1, 3, 5, 5, 6]
    advanced_x = [0, 0, 3.0, 0, 0, 0]
    ...
    mark(ax, 5, 3.0, '$5$', dx=0.0, dy=0.18, guide=True)

    mark(ax, 3, 3.0, '$3$', dx=0.0, dy=0.18, guide=True)

    mark(ax, 1, 0, '$1$', dx=0.0, dy=0.14, guide=False)

    mark(ax, -1, 0, '$-1$', dx=0.0, dy=0.14, guide=False)

    draw_shift_arrow(ax, 5.1, 2.9, 3.35, label='$2$')

    return fig

def main():
    fig = build_figure()
    save_figure(fig, Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.1--time-shifting-Images/images/l002-s005-te-section-005.png'))
