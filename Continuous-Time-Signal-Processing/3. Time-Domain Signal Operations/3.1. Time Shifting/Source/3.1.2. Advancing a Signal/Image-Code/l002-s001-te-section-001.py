...
OUTPUT_PATH = Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.1--time-shifting-Images/images/l002-s001-te-section-001.png')
...
def build_figure():
    ...
    original_t = [-1, 0, 2, 4, 4, 5]
    original_x = [0, 0, 2.4, 0, 0, 0]
    advanced_t = [-3, -2, 0, 2, 2, 3]
    advanced_x = [0, 0, 2.4, 0, 0, 0]
    ...
    mark(ax, 2, 2.4, '$t_0$', dx=0.0, dy=0.22, guide=True)

    mark(ax, 0, 2.4, '$t_0-T$', dx=0.0, dy=0.22, guide=True)

    draw_shift_arrow(ax, 2.1, -0.1, 2.85, label='$T$')

    return fig

def main():
    fig = build_figure()
    save_figure(fig, Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/3.1--time-shifting-Images/images/l002-s001-te-section-001.png'))
