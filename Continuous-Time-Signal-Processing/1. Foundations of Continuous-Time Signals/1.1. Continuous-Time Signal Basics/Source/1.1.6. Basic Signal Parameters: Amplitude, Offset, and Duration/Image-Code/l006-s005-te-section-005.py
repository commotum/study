...
OUTPUT_PATH = Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l006-s005-te-section-005.png')
...
def main():
    ...
    t = np.array([-3, -2, -2, -1, 0, 1, 2, 3, 3, 4], dtype=float)
    x = np.array([0, 0, 2, 6, 2, 6, 2, 2, 0, 0], dtype=float)
    plot_signal(ax, t, x)
    draw_dotted_guide(ax, [-2, 3], [4, 4])
