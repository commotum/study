...
OUTPUT_PATH = Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l006-s003-qg-q002-q002.png')
...
def main():
    ...
    x = np.array([0, -5, 1, -5, 1, 0], dtype=float)
    plot_signal(ax, t, x)
    draw_dotted_guide(ax, [0, 4], [-2, -2])
