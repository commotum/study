...
OUTPUT_PATH = Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l006-s002-qg-q001-q001.png')
...
def main():
    ...
    x = np.array([0, 5, -1, 3, 5, 0], dtype=float)
    plot_signal(ax, t, x)
