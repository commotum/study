...
OUTPUT_PATH = Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l006-s004-te-section-004.png')
...
def main():
    ...
    t = np.array([-2, -1, -1, 4, 4, 5], dtype=float)
    x = np.array([0, 0, 2, 2, 0, 0], dtype=float)
    plot_signal(ax, t, x)
