...
OUTPUT_PATH = Path('/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l006-s005-qg-q001-q001.png')
...
def main():
    ...
    t = np.array([0, 1, 1, 2, 3, 4, 5, 6, 6, 7], dtype=float)
    x = np.array([0, 0, 1, 5, 1, 5, 1, 1, 0, 0], dtype=float)
    plot_signal(ax, t, x)
    draw_dotted_guide(ax, [1, 6], [3, 3])
