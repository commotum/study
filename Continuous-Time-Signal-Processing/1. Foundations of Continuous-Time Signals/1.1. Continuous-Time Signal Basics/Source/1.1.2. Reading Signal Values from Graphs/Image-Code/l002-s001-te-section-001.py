...
output_path = Path(r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l002-s001-te-section-001.png")
...
plot_signal(ax, [0, 2, 4], [1, 3, 1])

draw_dotted_guide(ax, [2, 2], [0, 3])

draw_dotted_guide(ax, [0, 2], [3, 3])

ax.plot(2, 3, marker="o", markersize=px_to_pt(13.3), markerfacecolor=SIGNAL_COLOR, markeredgecolor=SIGNAL_COLOR, linestyle="None", zorder=6)

ax.text(2, -0.34, r"$t_0$", fontsize=ANNOTATION_SIZE, ha="center", va="top", color=ANNOTATION_COLOR)

ax.text(0.26, 3.12, r"$x(t_0)$", fontsize=ANNOTATION_SIZE, ha="left", va="bottom", color=ANNOTATION_COLOR)
