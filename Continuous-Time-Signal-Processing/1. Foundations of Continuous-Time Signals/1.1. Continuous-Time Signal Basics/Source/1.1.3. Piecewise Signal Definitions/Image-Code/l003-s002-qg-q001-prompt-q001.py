...
OUTPUT_PATH = r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l003-s002-qg-q001-prompt-q001.png"
...
def main():
    ...
    plot_signal(ax, [-2, 1], [3, 3])
    plot_signal(ax, [1, 4], [-2, -2])
    draw_closed_endpoint(ax, -2, 3)
    draw_open_endpoint(ax, 1, 3)
    draw_closed_endpoint(ax, 1, -2)
    draw_closed_endpoint(ax, 4, -2)
