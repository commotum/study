...
OUTPUT_PATH = r"/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l003-s004-te-section-004.png"
...
def main():
    ...
    plot_signal(ax, [0, 1], [2, 2])
    plot_signal(ax, [1, 3], [-1, -1])
    draw_closed_endpoint(ax, 0, 2)
    draw_open_endpoint(ax, 1, 2)
    draw_closed_endpoint(ax, 1, -1)
