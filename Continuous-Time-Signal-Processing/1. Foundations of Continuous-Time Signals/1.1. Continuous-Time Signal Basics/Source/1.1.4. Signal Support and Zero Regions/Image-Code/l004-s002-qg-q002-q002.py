...
OUTPUT_PATH = Path(
    "/home/jake/Developer/MA/PIPELINE/Electrical-and-Computer-Engineering/2-Build-Lessons/4-Image-Generation/1-Outputs/Continuous-Time-Signal-Processing/1.1--continuous-time-signal-basics-Images/images/l004-s002-qg-q002-q002.png"
)
...
def build_figure():
    ...
    t = np.array([xlim[0], -4.0, -4.0, -2.0, -2.0, 1.0, 1.0, 3.0, 3.0, xlim[1]], dtype=float)
    x = np.array([0.0, 0.0, 2.0, 2.0, 0.0, 0.0, 2.0, 2.0, 0.0, 0.0], dtype=float)
    plot_signal(ax, t, x)
