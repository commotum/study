...
$$
\begin{aligned}
\int x^{3}\,\textrm{d}x &= \frac{x^{3 + 1}}{3 + 1} + C \\
&= \frac{x^{4}}{4} + C
\end{aligned}
$$
...
$$
\begin{aligned}
\int \sqrt{x}\,\textrm{d}x &= \int x^{1/2}\,\textrm{d}x \\
&= \frac{x^{1/2 + 1}}{(\frac{1}{2} + 1)} + C \\
&= \frac{x^{3/2}}{(\frac{3}{2})} + C \\
&= \frac{2x^{3/2}}{3} + C
\end{aligned}
$$
...
\begin{aligned}
F'(x) &= f(x) \\
\int F'(x)\,\textrm{d}x &= \int f(x)\,\textrm{d}x \\
