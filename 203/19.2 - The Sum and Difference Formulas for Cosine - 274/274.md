...
&= \cos 45^\circ \cdot \cos 60^\circ - \sin 45^\circ \cdot \sin 60^\circ \\
...
id: ma-65555
content: |-
  Find the exact value of $\cos 285^\circ$.
  
  *Hint: Use the fact that $285^\circ = 240^\circ + 45^\circ$.*
options:
- id: a
  content: |-
    $\frac{\sqrt{2} - \sqrt{6}}{4}$
...
![](Source/Images/020b73eb96f441feb93b59ee8b7b1b00.png)
