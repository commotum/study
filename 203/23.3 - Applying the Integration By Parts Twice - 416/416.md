...
- [Using Integration by Parts to Calculate Integrals With Logarithms](../1140/1140.md)
...
$$
\begin{bmatrix}u = x^{2} & ⟹\frac{du}{dx} = 2x, \\ \frac{dv}{dx} = e^{4x} & ⟹v = \int e^{4x}\,\textrm{d}x = \frac{1}{4}e^{4x}\end{bmatrix}
$$
...
$$
\begin{aligned}
\int x^{2}e^{4x}\,\textrm{d}x &= \int u\frac{dv}{dx}\,\textrm{d}x \\
&= uv - \int v\frac{du}{dx}\,\textrm{d}x \\
&= x^{2}(\frac{1}{4}e^{4x}) - \int(\frac{1}{4}e^{4x})2x\,\textrm{d}x \\
&= \frac{1}{4}x^{2}e^{4x} - \frac{1}{2}\int xe^{4x}\,\textrm{d}x
\end{aligned}
$$
...
$$
\begin{bmatrix}u = x & ⟹\frac{du}{dx} = 1, \\ \frac{dv}{dx} = e^{4x} & ⟹v = \int e^{4x}\,\textrm{d}x = \frac{1}{4}e^{4x}\end{bmatrix}
$$
...
$$
\begin{aligned}
\int xe^{4x}\,\textrm{d}x &= \int u\frac{dv}{dx}\,\textrm{d}x \\
&= uv - \int v\frac{du}{dx}\,\textrm{d}x \\
&= x(\frac{1}{4}e^{4x}) - \int(\frac{1}{4}e^{4x}) \cdot 1\,\textrm{d}x \\
...
$$
\begin{aligned}
\int x^{2}e^{4x}\,\textrm{d}x &= \frac{1}{4}x^{2}e^{4x} - \frac{1}{2}\int xe^{4x}\,\textrm{d}x \\
...
$$
\begin{bmatrix}u = x^{2} & ⟹\frac{du}{dx} = 2x \\ \frac{dv}{dx} = e^{2x} & ⟹v = \int\frac{dv}{dx}\,\textrm{d}x = \int e^{2x}\,\textrm{d}x = \frac{e^{2x}}{2}\end{bmatrix}
$$
...
$$
\begin{aligned}
\int x^{2}e^{2x}\,\textrm{d}x &= \int u\frac{dv}{dx}\,\textrm{d}x \\
&= uv - \int v\frac{du}{dx}\,\textrm{d}x \\
&= (x^{2})(\frac{e^{2x}}{2}) - \int(\frac{e^{2x}}{2})(2x)\,\textrm{d}x \\
&= \frac{x^{2}e^{2x}}{2} - \int xe^{2x}\,\textrm{d}x
\end{aligned}
$$
...
$$
\begin{bmatrix}u = x & ⟹\frac{du}{dx} = 1 \\ \frac{dv}{dx} = e^{2x} & ⟹v = \int\frac{dv}{dx}\,\textrm{d}x = \int e^{2x}\,\textrm{d}x = \frac{e^{2x}}{2}\end{bmatrix}
$$
...
$$
\begin{aligned}
\int xe^{2x}\,\textrm{d}x &= \int u\frac{dv}{dx}\,\textrm{d}x \\
&= uv - \int v\frac{du}{dx}\,\textrm{d}x \\
&= x(\frac{e^{2x}}{2}) - \int(\frac{e^{2x}}{2})(1)\,\textrm{d}x \\
&= \frac{xe^{2x}}{2} - \frac{1}{2}\int e^{2x}\,\textrm{d}x \\
...
$$
\begin{aligned}
\int x^{2}e^{2x}\,\textrm{d}x &= \frac{x^{2}e^{2x}}{2} - (\frac{xe^{2x}}{2} - \frac{e^{2x}}{4} + D) \\
...
id: ma-12707
content: |-
  Calculate $\displaystyle \int 3t^{2}e^{t}\,\textrm{d}t$.
options:
- id: a
  content: |-
    $3te^{t}(t - 2) + C$
...
$$
\begin{aligned}
\int x^{2}\cos(3x)\,\textrm{d}x &= \int u\frac{dv}{dx}\,\textrm{d}x \\
&= uv - \int v\frac{du}{dx}\,\textrm{d}x \\
&= (x^{2})(\frac{1}{3}\sin (3x)) - \int(\frac{1}{3}\sin (3x))2x\,\textrm{d}x \\
&= \frac{1}{3}x^{2}\sin (3x) - \frac{2}{3}\int x\sin(3x)\,\textrm{d}x
\end{aligned}
$$
...
$$
\begin{aligned}
\int x\sin(3x)\,\textrm{d}x &= \int u\frac{dv}{dx}\,\textrm{d}x \\
&= uv - \int v\frac{du}{dx}\,\textrm{d}x \\
&= x(-\frac{1}{3}\cos (3x)) - \int(-\frac{1}{3}\cos (3x)) \cdot 1\,\textrm{d}x \\
&=-\frac{1}{3}x\cos (3x) + \frac{1}{3}\int\cos(3x)\,\textrm{d}x \\
...
$$
\begin{aligned}
\int x^{2}\cos(3x)\,\textrm{d}x &= \frac{1}{3}x^{2}\sin (3x) - \frac{2}{3}\int x\sin(3x)\,\textrm{d}x \\
...
id: ma-49931
content: |-
  What is $\displaystyle \int 2x^{2}\sin (2x)\,\textrm{d}x$?
options:
- id: a
  content: |-
    $-x^{2}\cos (2x) - 2\int x\cos(2x)\,\textrm{d}x$
- id: b
  content: |-
    $x^{2}\cos (2x) + \int x\cos(2x)\,\textrm{d}x$
- id: c
  content: |-
    $-x^{2}\cos (2x) + \int x\sin(2x)\,\textrm{d}x$
- id: d
  content: |-
    $x^{2}\cos (2x) - 2\int x\sin(2x)\,\textrm{d}x$
- id: e
  correct: true
  content: |-
    $-x^{2}\cos (2x) + 2\int x\cos(2x)\,\textrm{d}x$
...
$$
\begin{bmatrix}u = (\ln x)^{2} & ⟹\frac{du}{dx} = \frac{2\ln x}{x}, \\ \frac{dv}{dx} = 32x^{3} & ⟹v = \int 32x^{3}\,\textrm{d}x = 8x^{4}\end{bmatrix}
$$
...
$$
\begin{aligned}
\int 32x^{3}(\ln x)^{2}\,\textrm{d}x &= \int u\frac{dv}{dx}\,\textrm{d}x \\
&= uv - \int v\frac{du}{dx}\,\textrm{d}x \\
&= (\ln x)^{2}(8x^{4}) - \int(8x^{4})(\frac{2\ln x}{x})\,\textrm{d}x \\
&= 8x^{4}(\ln x)^{2} - 16\int x^{3}\ln(x)\,\textrm{d}x
\end{aligned}
$$
...
$$
\begin{bmatrix}u = \ln (x) & ⟹\frac{du}{dx} = \frac{1}{x}, \\ \frac{dv}{dx} = x^{3} & ⟹v = \int x^{3}\,\textrm{d}x = \frac{x^{4}}{4}\end{bmatrix}
$$
...
$$
\begin{aligned}
\int x^{3}\ln(x)\,\textrm{d}x &= \int u\frac{dv}{dx}\,\textrm{d}x \\
&= uv - \int v\frac{du}{dx}\,\textrm{d}x \\
&= \ln (x)(\frac{x^{4}}{4}) - \int(\frac{x^{4}}{4})(\frac{1}{x})\,\textrm{d}x \\
&= \frac{x^{4}\ln (x)}{4} - \frac{1}{4}\int x^{3}\,\textrm{d}x \\
&= \frac{x^{4}\ln (x)}{4} - \frac{x^{4}}{16} + C_{1}
\end{aligned}
$$
...
$$
\begin{aligned}
\int 32x^{3}(\ln x)^{2}\,\textrm{d}x &= 8x^{4}(\ln x)^{2} - 16\int x^{3}\ln(x)\,\textrm{d}x \\
&= 8x^{4}(\ln x)^{2} - 16(\frac{x^{4}\ln (x)}{4} - \frac{x^{4}}{16} + C_{1}) \\
...
id: ma-12706
content: |-
  What is $\int x^{2}(\ln x)^{2}\,\textrm{d}x$?
options:
- id: a
  content: |-
