...
- [Determining Continuity from Graphs](../462/462.md)
- [Limits of Piecewise Functions](../1262/1262.md)
...
![](Source/Images/b5698f3a7fca75dd6653326e3f9ea4d8.png)
...
![](Source/Images/225c7965ee8651897f2919c78dcc3e1d.png)
...
![](Source/Images/dfa809445d41802185fca6d9c871b1a0.png)
...
$$
\begin{aligned}
\lim_{x\to 2^-} f(x) &= \lim_{x\to 2^-}(3x+2) = 8, \\
\lim_{x\to 2^+} f(x) &= \lim_{x\to 2^+}(x^3) = 8
\end{aligned}
$$
Therefore, the overall limit exists and $\lim_{x\to 2} f(x)=8$. ${\color{green}\checkmark}$
- The limit of the function is not equal to the function value: $\lim_{x\to 2} f(x)= 8$, while $f(2) = 6$. ${\color{red}\times}$
...
id: ma-38451
content: |-
  If $f(x)$ is continuous at $x = 3$ and $f(3) = 1$, then what is $\lim_{x\to 3^+}\sqrt{x^{2} - f(x)}$?
options:
- id: a
  content: |-
    $4$
