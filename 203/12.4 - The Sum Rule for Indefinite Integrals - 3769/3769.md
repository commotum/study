...
- [The Constant Multiple Rule for Indefinite Integrals](../43/43.md)
...
$$
\begin{aligned}
\int (x + x^{3})\,\textrm{d}x &= \int x\,\textrm{d}x + \int x^{3}\,\textrm{d}x \\
...
$$
\begin{aligned}
\int (x^{2} + 1)\,\textrm{d}x &= \int x^{2}\,\textrm{d}x + \int 1\,\textrm{d}x \\
&= \int x^{2}\,\textrm{d}x + \int x^{0}\,\textrm{d}x \\
&= (\frac{x^{2 + 1}}{2 + 1}) + x + C \\
&= \frac{1}{3}x^{3} + x + C
\end{aligned}
$$
...
$$
\begin{aligned}
\int (2x^{3} - x)\,\textrm{d}x &= 2\int x^{3}\,\textrm{d}x - \int x\,\textrm{d}x \\
...
id: ma-211
content: |-
  What is $\displaystyle \int (12x^{3} + 5x)\,\textrm{d}x$?
options:
- id: a
  content: |-
    $12x^{2} + \frac{5x^{2}}{2} + C$
...
&= 5\int x^{3/2}\,\textrm{d}x - 4\int x^{2}\,\textrm{d}x + 5\int 1\,\textrm{d}x \\
