...
![](Source/Images/a1c90a62e6526833f8f7fd917de52ce0.png)
...
$\lim_{x\to 0^{-}}f(x) = \lim_{x\to 0^{-}}2^{x} = 2^{0} = 1 = f(0)$.
- Approaching from the right, we have $x>0$, so we use the expression $f(x)=\sqrt {x+1}$. We get
$\lim_{x\to 0^{+}}f(x) = \lim_{x\to 0^{+}}\sqrt{x + 1} = \sqrt{0 + 1} = 1 = f(0)$.
...
$\lim_{x\to 1^{-}}h(x) = e^{1 - 1} = e^{0} = 1 = h(1)$
...
$\lim_{x\to 0^{+}}f(x) = \frac{4}{0 + 2} = \frac{4}{2} = 2 = f(0)$
